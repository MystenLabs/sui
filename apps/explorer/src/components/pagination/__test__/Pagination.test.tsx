...
describe('Pagination unit test', () => {
    it('check pagination buttons and value', () => {
        ...
        const firstBtn = container.querySelector('button[data-testid="firstBtn"]:not([style*="display:none"])');
        const lastBtn = container.querySelector('button[data-testid="lastBtn"]:not([style*="display:none"])');
