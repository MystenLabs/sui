        ...
        <>
            ...
            <FloatingPortal>
                <AnimatePresence>
                    {open ? (
                        <motion.div
                            className="text-subtitleSmall pointer-events-none left-0 top-0 z-50 font-semibold text-white"
                            initial={{
                                opacity: 0,
                                scale: 0,
                        ...
                        >
                            <div className="leading-1 bg-gray-90 leading-130 flex flex-col flex-nowrap gap-px rounded-md p-2">
                                {tip}
                            </div>
                            <div
                                ref={arrowRef}
