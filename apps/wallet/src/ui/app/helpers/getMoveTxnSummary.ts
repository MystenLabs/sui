...
// For Move calls, get transaction data is from events
...
// Get relevant txn objectIds where the reciever is wallet address
export function getObjectIdsForAddress(
    suiEvents: SuiEvent[] | undefined,
    address: string
): string[] {
    const events = suiEvents || [];
