...
import { useGetObject, inValidateObjectQueryCache } from './useGetObject';
...
export function invalidateValidatorsCache() {
    inValidateObjectQueryCache(VALIDATORS_OBJECT_ID);
}
