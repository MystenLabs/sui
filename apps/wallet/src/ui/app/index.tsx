...
const App = () => {
	...
	const isEnokiSocialSignInEnabled = useFeatureIsOn('enoki-social-sign-in');
	...
	return (
		<Routes>
			...
			<Route
				path="welcome"
				element={isEnokiSocialSignInEnabled ? <WelcomePageV2 /> : <WelcomePage />}
			/>
			{isEnokiSocialSignInEnabled && (
