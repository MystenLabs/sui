...
contract BridgeUtilsTest is BridgeBaseTest {
    ...
    function testDecodeUpdateTokenPricesPayload() public {
        bytes memory payload = hex"010101000000003b9aca00";
        (uint8[] memory _tokenIDs, uint64[] memory _newPrices) =
    ...
    function testdecodeAddTokensPayload() public {
        ///     byte 0           : is native
        ...
        bytes memory payload =
            hex"010101010606060606060606060606060606060606060606010101000000003b9aca00";
        (
            bool native,
        ...
        assertEq(tokenAddresses[0], address(0x0606060606060606060606060606060606060606));
        assertEq(suiDecimals[0], 1);
        assertEq(tokenPrices[0], 100_000_0000);
    }
