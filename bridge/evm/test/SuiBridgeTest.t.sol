...
contract SuiBridgeTest is BridgeBaseTest, ISuiBridge {
    ...
    function testTransferSuiToEthRegressionTest() public {
        ...
        uint256[] memory _tokenPrices = new uint256[](5);
        _tokenPrices[0] = 10000; // SUI PRICE
        _tokenPrices[1] = 10000; // BTC PRICE
        _tokenPrices[2] = 10000; // ETH PRICE
        _tokenPrices[3] = 10000; // USDC PRICE
        _tokenPrices[4] = 10000; // USDT PRICE
        ...
        _config.initialize(
            address(committee), 11, _supportedTokens, _tokenPrices, _supportedDestinationChains
        );
    ...
    function testEmergencyOpRegressionTest() public {
        ...
        _tokenPrices[2] = 10000; // ETH PRICE
        _tokenPrices[3] = 10000; // USDC PRICE
        _tokenPrices[4] = 10000; // USDC PRICE
        uint8 _chainID = 3;
        uint8[] memory _supportedDestinationChains = new uint8[](1);
