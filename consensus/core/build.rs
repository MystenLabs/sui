    ...
    let observer_service = tonic_build::manual::Service::builder()
        ...
        .method(
            tonic_build::manual::Method::builder()
                ...
                .input_type("crate::network::observer_network::BlockStreamRequest")
                .output_type("crate::network::observer_network::BlockStreamResponse")
                .codec_path(codec_path)
                .server_streaming()
                .client_streaming()
                .build(),
        ...
        .method(
            tonic_build::manual::Method::builder()
                ...
                .input_type("crate::network::observer_network::CommitStreamRequest")
                .output_type("crate::network::observer_network::CommitStreamResponse")
                .codec_path(codec_path)
                .server_streaming()
                .client_streaming()
                .build(),
        ...
        .method(
            tonic_build::manual::Method::builder()
                .name("fetch_blocks")
                .route_name("FetchBlocks")
                .input_type("crate::network::observer_network::FetchBlocksRequest")
                .output_type("crate::network::observer_network::FetchBlocksResponse")
                .codec_path(codec_path)
                .server_streaming()
                .build(),
        )
        .method(
            tonic_build::manual::Method::builder()
                .name("fetch_commits")
                .route_name("FetchCommits")
                .input_type("crate::network::observer_network::FetchCommitsRequest")
                .output_type("crate::network::observer_network::FetchCommitsResponse")
                .codec_path(codec_path)
                .build(),
        )
        .build();
