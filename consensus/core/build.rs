    ...
    let observer_service = tonic_build::manual::Service::builder()
        ...
        .method(
            tonic_build::manual::Method::builder()
                ...
                .input_type("crate::network::tonic_network::BlockStreamRequest")
                .output_type("crate::network::tonic_network::BlockStreamResponse")
                .codec_path(codec_path)
                .server_streaming()
                .client_streaming()
                .build(),
        ...
        .method(
            tonic_build::manual::Method::builder()
                ...
                .input_type("crate::network::tonic_network::CommitStreamRequest")
                .output_type("crate::network::tonic_network::CommitStreamResponse")
                .codec_path(codec_path)
                .server_streaming()
                .client_streaming()
                .build(),
