...
use crate::{
    BlockVerifier, TransactionCertifier,
...
mod tests {
    ...
    use super::*;
    use crate::{
        block::{CertifiedBlocksOutput, TestBlock, VerifiedBlock},
    ...
    async fn test_observer_stream_receives_broadcast_blocks() {
        ...
        let (certified_blocks_tx, _certified_blocks_rx) =
            monitored_mpsc::unbounded_channel::<CertifiedBlocksOutput>("test");
