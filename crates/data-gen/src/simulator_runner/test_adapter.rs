...
impl<'a> MoveTestAdapter<'a> for SuiTestAdapter<'a> {
    ...
    async fn handle_subcommand(
        ...
        match command {
            SuiSubcommand::AdvanceCheckpoint => unimplemented!(),
            SuiSubcommand::AdvanceEpoch => unimplemented!(),
            ...
            SuiSubcommand::Serve(ServeCommand { url, port }) => {
                ...
                sui_rest_api::start_service(addr, self.validator.clone(), Some("/rest".to_owned()))
                    .await;
