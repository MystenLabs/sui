...
impl GrootModuleResolver {
    fn new(blocking_cp: PgConnectionPool) -> Self {
        ...
        match decode(clob) {
            Ok(module) => module_map.insert("clob".to_string(), module),
            Err(_) => println!("Invalid base64 encoding for clob"),
        }
        ...
        match decode(clob_v2) {
            Ok(module) => module_map.insert("clob_v2".to_string(), module),
            Err(_) => println!("Invalid base64 encoding for clob_v2"),
        }
        ...
        match decode(critbit) {
            Ok(module) => module_map.insert("critbit".to_string(), module),
            Err(_) => println!("Invalid base64 encoding for critbit"),
        }
        ...
        match decode(custodian) {
            Ok(module) => module_map.insert("custodian".to_string(), module),
            Err(_) => println!("Invalid base64 encoding for custodian"),
        }
        ...
        match decode(custodian_v2) {
            Ok(module) => module_map.insert("custodian_v2".to_string(), module),
            Err(_) => println!("Invalid base64 encoding for custodian_v2"),
        }
        ...
        match decode(math) {
            Ok(module) => module_map.insert("math".to_string(), module),
            Err(_) => println!("Invalid base64 encoding for math"),
        }
