...
impl NodeStreamInnerData {
    pub fn topic(&self) -> NodeStreamTopic {
        match self {
            NodeStreamInnerData::PackagePublish(_) => NodeStreamTopic::PackagePublish,
            NodeStreamInnerData::ObjectChangeLight(_) => NodeStreamTopic::ObjectChangeLight,
            NodeStreamInnerData::TransactionDigest => NodeStreamTopic::TransactionDigest,
            NodeStreamInnerData::String(_) => NodeStreamTopic::String,
            NodeStreamInnerData::ObjectChangeRaw(_, _) => NodeStreamTopic::ObjectChangeRaw,
            NodeStreamInnerData::MoveCall(_, _, _) => NodeStreamTopic::MoveCall,
            NodeStreamInnerData::GasCostSummary(_) => NodeStreamTopic::GasCostSummary,
        }
    }
...
impl Display for NodeStreamTopic {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            NodeStreamTopic::String => write!(f, "string"),
            NodeStreamTopic::PackagePublish => write!(f, "package_publish"),
            NodeStreamTopic::ObjectChangeLight => write!(f, "object_change_light"),
            NodeStreamTopic::ObjectChangeRaw => write!(f, "object_change_raw"),
            NodeStreamTopic::MoveCall => write!(f, "move_call"),
            NodeStreamTopic::TransactionDigest => write!(f, "transaction_digest"),
            NodeStreamTopic::GasCostSummary => write!(f, "gas_cost_summary"),
        }
    }
}
