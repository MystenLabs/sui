...
//# init --addresses test=0x0 --accounts A B C D --enable-accumulators --enable-address-balance-gas-payments
...
//# programmable --sender B --inputs @C --address-balance-gas
...
//# programmable --sender C --inputs @D 10
