...
use sui_analytics_indexer::{
    analytics_metrics::AnalyticsMetrics, package_store::package_cache_worker::PackageCacheWorker,
    JobConfig,
};
...
async fn main() -> Result<()> {
    ...
    watermarks.insert("package_cache_manager".to_string(), min_watermark);
