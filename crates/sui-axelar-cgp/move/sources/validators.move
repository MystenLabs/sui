...
module axelar::validators {
    ...
    ///
    /// TODO: consider just having an empty base object for extendability.
    /// TODO: like BASE ---- DF(V1) ---- AxelarValidators
    ///       ....      ---- DF(V2) ---- AxelarValidatorsV2
    ...
    /// TODO: not guarded - vulnerability.
    public(friend) fun add_call_approval(axelar: &mut AxelarValidators, msg: CallApproval) {
    ...
    #[test_only] use axelar::utils::to_sui_signed;
    #[test_only] use sui::object;
    #[test_only] use sui::tx_context::TxContext;
