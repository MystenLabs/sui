...
pub struct WorkloadConfig {
    ...
    pub slow_vectors: u64,
    pub slow_size: u64,
    pub slow_padding_bytes: u64,
    pub slow_commands: u64,
    pub slow_shared_object: bool,
            ...
            RunSpec::Bench {
                ...
                for workload_group in 0..num_of_benchmark_groups {
                    ...
                    let config = WorkloadConfig {
                        ...
                        slow_vectors: slow_vectors[i],
                        slow_size: slow_size[i],
                        slow_padding_bytes: slow_padding_bytes[i],
                        slow_commands: slow_commands[i],
                        slow_shared_object: slow_shared_object[i],
