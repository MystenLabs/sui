...
pub struct ForkRecoveryConfig {
    ...
    /// If true, the checkpoint fork marker will be cleared on startup
    #[serde(default)]
    pub clear_checkpoint_fork: bool,

    /// If true, the transaction fork marker will be cleared on startup
    #[serde(default)]
    pub clear_transaction_fork: bool,
}
