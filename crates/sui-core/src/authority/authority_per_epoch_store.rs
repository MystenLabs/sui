...
impl AuthorityPerEpochStore {
    ...
    pub fn registry_root_exists(&self) -> bool {
        self.epoch_start_configuration
            .registry_root_obj_initial_shared_version()
            .is_some()
    }

    pub fn registry_root_enabled(&self) -> bool {
        self.protocol_config().enable_registry_root() && self.registry_root_exists()
    }

    // TODO(manos): uncomment when introducing coin registry
    // pub fn coin_registry_exists(&self) -> bool {
    //     // TODO(manos): Finish when adding coin registry in next PR.
    //     false
    // }
