...
use sui_types::coin_metadata_registry::get_coin_metadata_registry_obj_initial_shared_version;
...
pub trait EpochStartConfigTrait {
    ...
    fn coin_metadata_registry_obj_initial_shared_version(&self) -> Option<SequenceNumber>;
...
impl EpochStartConfiguration {
    pub fn new(
        ...
        let coin_metadata_registry_obj_initial_shared_version =
            get_coin_metadata_registry_obj_initial_shared_version(object_store)?;
        ...
        Ok(Self::V7(EpochStartConfigurationV7 {
            ...
            coin_metadata_registry_obj_initial_shared_version,
        }))
    }
        ...
        match self {
            Self::V7(config) => {
                Self::V7(EpochStartConfigurationV7 {
                    ...
                    coin_metadata_registry_obj_initial_shared_version: config.coin_metadata_registry_obj_initial_shared_version,
                })
            }
...
pub struct EpochStartConfigurationV7 {
    ...
    coin_metadata_registry_obj_initial_shared_version: Option<SequenceNumber>,
}
