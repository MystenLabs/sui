...
impl Validator for ValidatorService {
    async fn submit_transaction(
        ...
        spawn_monitored_task!(async move {
            ...
            handle_with_decoration!(validator_service, handle_submit_transaction_impl, request, "submit_transaction")
        })
        .await
        .unwrap()
    }
    ...
    async fn submit_certificate(
        ...
        spawn_monitored_task!(async move {
            // NB: traffic tally wrapping handled within the task rather than on task exit
            // to prevent an attacker from subverting traffic control by severing the connection.
            handle_with_decoration!(validator_service, submit_certificate_impl, request, "submit_certificate")
        })
        .await
        .unwrap()
    }
    ...
    async fn handle_certificate_v2(
        ...
        handle_with_decoration!(self, handle_certificate_v2_impl, request, "handle_certificate_v2")
    }
    ...
    async fn handle_certificate_v3(
        ...
        handle_with_decoration!(self, handle_certificate_v3_impl, request, "handle_certificate_v3")
    }
    ...
    async fn handle_soft_bundle_certificates_v3(
        ...
        handle_with_decoration!(self, handle_soft_bundle_certificates_v3_impl, request, "handle_soft_bundle_certificates_v3")
    }
    ...
    async fn get_system_state_object(
        ...
        handle_with_decoration!(self, get_system_state_object_impl, request, "get_system_state_object")
    }
