...
impl CheckpointExecutor {
    ...
    async fn execute_checkpoint(
        ...
        let (mut pipeline_handle, ckpt_state) = if self.state.is_fullnode(&self.epoch_store)
            || checkpoint.is_last_checkpoint_of_epoch()
        {
            self.clone()
                .execute_checkpoint_fullnode(checkpoint, pipeline_handle)
                .await
        } else {
            self.clone()
                .execute_checkpoint_validator(checkpoint, pipeline_handle)
                .await
        };
        ...
        pipeline_handle
            .finish_stage(PipelineStage::BuildDbBatch)
            .await;
        ...
        pipeline_handle
            .finish_stage(PipelineStage::CommitTransactionOutputs)
            .await;
        ...
        pipeline_handle
            .finish_stage(PipelineStage::FinalizeCheckpoint)
            .await;
        ...
        pipeline_handle
            .finish_stage(PipelineStage::UpdateRpcIndex)
            .await;
        ...
        pipeline_handle
            .finish_stage(PipelineStage::BumpHighestExecutedCheckpoint)
            .await;
    ...
    async fn execute_checkpoint_validator(
    ...
    ) -> (PipelineHandle, CheckpointExecutionState) {
        assert!(
            !checkpoint.is_last_checkpoint_of_epoch(),
        ...
        pipeline_handle
            .finish_stage(PipelineStage::FinalizeTransactions)
            .await;
        pipeline_handle
            .finish_stage(PipelineStage::ProcessCheckpointData)
            .await;
    ...
    async fn execute_checkpoint_fullnode(
        ...
        pipeline_handle
            .finish_stage(PipelineStage::ExecuteTransactions)
            .await;
