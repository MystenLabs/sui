...
impl CheckpointBuilder {
    ...
    async fn construct_and_execute_settlement_transactions(
        ...
        let accumulator_root_obj_initial_shared_version = self.epoch_store
            .epoch_start_config()
        ...
        let settlement_txns = builder.build_tx(epoch, accumulator_root_obj_initial_shared_version, checkpoint_height);
