...
impl ConsensusTransactionHandler {
    ...
    pub async fn handle_consensus_transactions(
        &self,
        blocks_and_rejected_transactions: Vec<(VerifiedBlock, Vec<u16>)>,
    ) {
...
mod tests {
    ...
    pub async fn test_consensus_commit_handler() {
        ...
        let owned_objects: Vec<Object> = (0..4)
            ...
            .collect();
        // 5 shared objects.
        let shared_objects: Vec<Object> = (0..5)
        ...
        // AND create test certified transactions with remaining gas objects and shared object.
        let certified_transactions = test_certificates_with_gas_objects(
            &state,
            &gas_objects[8..12],
