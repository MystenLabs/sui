...
pub struct EpochMetrics {
    ...
    pub epoch_reconfig_time_since_epoch_close_ms: Histogram,
    ...
    // epoch_store is created), to when the first checkpoint of the epoch is created locally.
    ...
    pub epoch_first_checkpoint_created_time_since_epoch_begin_ms: Histogram,
}
...
impl EpochMetrics {
    pub fn new(registry: &Registry) -> Arc<Self> {
        let this = Self {
            ...
            epoch_reconfig_time_since_epoch_close_ms: Histogram::new_in_registry(
                "epoch_reconfig_time_since_epoch_close_ms",
                "Total time duration from when epoch was closed to when the state is reconfigured",
                registry,
            ),
            ...
            epoch_first_checkpoint_created_time_since_epoch_begin_ms: Histogram::new_in_registry(
