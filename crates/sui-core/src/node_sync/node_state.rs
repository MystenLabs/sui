...
pub enum SyncArg {
    ...
    /// Sync a cert that is finalized, including its parents. It may
    /// appear as a parent in the verified effects of some other cert,
    /// or come from the Transaction Orchestrator.
