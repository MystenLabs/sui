...
use crate::{
    ...
    transaction_driver::{
        ...
        message_types::{
            ExecutedData, SubmitTxResponse, SubmitTxResult, WaitForEffectsRequest,
...
async fn test_successful_certified_effects() {
    ...
    let submit_tx_resp = SubmitTxResponse {
        results: vec![SubmitTxResult::Submitted { consensus_position }],
    };
