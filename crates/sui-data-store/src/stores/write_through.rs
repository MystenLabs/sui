...
//! Write-through store skeleton with live object caching.
...
/// Write-through cache over a primary hot cache and secondary durable store.
#[derive(Debug)]
    ...
    S: TransactionStore,
{
    fn transaction_data_and_effects(
        ...
        todo!("write-through transaction reads are not implemented in the PR2 slice")
    }
}
    ...
    S: TransactionStoreWriter,
{
    fn write_transaction(
        ...
        todo!("write-through transaction writes are not implemented in the PR2 slice")
    }
}
    ...
    S: EpochStore,
{
    fn epoch_info(&self, _epoch: u64) -> Result<Option<EpochData>, Error> {
        todo!("write-through epoch reads are not implemented in the PR2 slice")
    }

    fn protocol_config(&self, _epoch: u64) -> Result<Option<ProtocolConfig>, Error> {
        todo!("write-through protocol-config reads are not implemented in the PR2 slice")
    }
}
    ...
    S: EpochStoreWriter,
{
    fn write_epoch_info(&self, _epoch: u64, _epoch_data: EpochData) -> Result<(), Error> {
        todo!("write-through epoch writes are not implemented in the PR2 slice")
    }
}
    ...
    S: CheckpointStore,
{
    fn get_checkpoint_by_sequence_number(
        ...
        todo!("write-through checkpoint reads are not implemented in the PR2 slice")
    }

    fn get_latest_checkpoint(&self) -> Result<Option<FullCheckpointData>, Error> {
        todo!("write-through latest-checkpoint lookups are not implemented in the PR2 slice")
    }
    ...
    fn get_sequence_by_checkpoint_digest(
        ...
        todo!("write-through checkpoint-digest lookups are not implemented in the PR2 slice")
    }
    ...
    fn get_sequence_by_contents_digest(
        ...
        todo!("write-through contents-digest lookups are not implemented in the PR2 slice")
    }
}
    ...
    S: CheckpointStoreWriter,
{
    fn write_checkpoint(&self, _checkpoint: &FullCheckpointData) -> Result<(), Error> {
        todo!("write-through checkpoint writes are not implemented in the PR2 slice")
    }
}
