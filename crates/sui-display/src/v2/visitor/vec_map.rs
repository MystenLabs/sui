...
impl<'v, 'l: 'v> AV::Visitor<'v, 'l> for VecMapVisitor<'v, '_> {
    type Value = Option<Value<'v>>;
    type Error = FormatError;

    visitor_default! { <'v, 'l> u8, u16, u32, u64, u128, u256 = Ok(None) }
    visitor_default! { <'v, 'l> bool, address, signer, variant = Ok(None) }
