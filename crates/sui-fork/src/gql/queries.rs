...
//! GraphQL queries against the schema defined in `crates/sui-indexer-alt-graphql/schema.graphql`,
...
pub(crate) mod address_balances_query {
    ...
    /// Coin types (the inner `T`, e.g. `0x2::sui::SUI`) for which `address` has a non-zero
