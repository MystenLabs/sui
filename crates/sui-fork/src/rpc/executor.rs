...
/// sealed into a fresh Simulacrum checkpoint and published to checkpoint subscribers while
/// simulations (dry-run / dev-inspect) run read-only and are never checkpointed.
