...
pub(crate) const ADVANCE_CHECKPOINT: Endpoint =
    Endpoint::new("/advance-checkpoint", EndpointMethod::Post);
pub(crate) const ADVANCE_CLOCK: Endpoint = Endpoint::new("/advance-clock", EndpointMethod::Post);
pub(crate) const ADVANCE_EPOCH: Endpoint = Endpoint::new("/advance-epoch", EndpointMethod::Post);
pub(crate) const FAUCET: Endpoint = Endpoint::new("/faucet", EndpointMethod::Post);
