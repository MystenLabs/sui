...
//
// /// A store implementation for forking that can fetch objects from the network
// #[derive(Debug)]
...
//
//     // Forking-specific fields
//     graphql_client: GraphQLClient,
//     forked_at_checkpoint: u64,
// }
//
// impl ForkingStore {
//     pub fn new(genesis: &genesis::Genesis, graphql_client: GraphQLClient, forked_at_checkpoint: u64) -> Self {
//         let mut store = Self {
...
//         let child_object = match ForkingStore::get_object(self, child) {
//             None => return Ok(None),
//             Some(obj) => obj,
//         };
//
...
//                 error: "ForkingStore::read_child_object does not yet support bounded reads"
//                     .to_owned(),
//             }
//             .into());
//         }
...
//         _epoch_id: EpochId,
//     ) -> sui_types::error::SuiResult<Option<Object>> {
//         let recv_object = match ForkingStore::get_object(self, receiving_object_id) {
//             None => return Ok(None),
//             Some(obj) => obj,
//         };
...
//         ForkingStore::get_object(self, object_id).cloned()
//     }
//
