...
// use sui_indexer_alt_jsonrpc::api::dynamic_fields::DynamicFields;
// use sui_indexer_alt_jsonrpc::api::move_utils::MoveUtils;
// use sui_indexer_alt_jsonrpc::api::name_service::NameService;
// use sui_indexer_alt_jsonrpc::api::objects::Objects;
// use sui_indexer_alt_jsonrpc::api::objects::QueryObjects;
...
//     rpc.add_module(DynamicFields(context.pg_context.clone()))?;
//     rpc.add_module(Governance(context.pg_context.clone()))?;
//     rpc.add_module(MoveUtils(context.pg_context.clone()))?;
//     rpc.add_module(NameService(context.pg_context.clone()))?;
//     rpc.add_module(Transactions(context.pg_context.clone()))?;
//     rpc.add_module(QueryTransactions(context.pg_context.clone()))?;
//     rpc.add_module(Objects(context.pg_context.clone()))?;
//     rpc.add_module(QueryObjects(context.pg_context.clone()))?;
//
