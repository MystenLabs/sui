...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_extract_update_sui_token">extract_update_sui_token</a>(<a href="message.md#0xb_message">message</a>: &<a href="message.md#0xb_message_BridgeMessage">BridgeMessage</a>): <a href="message.md#0xb_message_UpdateSuiToken">UpdateSuiToken</a> {
    <b>let</b> <b>mut</b> <a href="../move-stdlib/bcs.md#0x1_bcs">bcs</a> = bcs::new(<a href="message.md#0xb_message">message</a>.payload);
    <b>let</b> native_token = bcs::peel_bool(&<b>mut</b> <a href="../move-stdlib/bcs.md#0x1_bcs">bcs</a>);
    <b>let</b> token_ids = bcs::peel_vec_u8(&<b>mut</b> <a href="../move-stdlib/bcs.md#0x1_bcs">bcs</a>);
    <b>let</b> token_type_names_bytes = bcs::peel_vec_vec_u8(&<b>mut</b> <a href="../move-stdlib/bcs.md#0x1_bcs">bcs</a>);
    <b>let</b> token_prices = bcs::peel_vec_u64(&<b>mut</b> <a href="../move-stdlib/bcs.md#0x1_bcs">bcs</a>);

    <b>let</b> <b>mut</b> n = 0;
    <b>let</b> <b>mut</b> token_type_names = <a href="../move-stdlib/vector.md#0x1_vector">vector</a>[];
    <b>while</b> (n &lt; <a href="../move-stdlib/vector.md#0x1_vector_length">vector::length</a>(&token_type_names_bytes)){
        <a href="../move-stdlib/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> token_type_names, <a href="../move-stdlib/ascii.md#0x1_ascii_string">ascii::string</a>(*<a href="../move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(&token_type_names_bytes, n)));
        n = n + 1;
    };
    <b>assert</b>!(<a href="../move-stdlib/vector.md#0x1_vector_is_empty">vector::is_empty</a>(&bcs::into_remainder_bytes(<a href="../move-stdlib/bcs.md#0x1_bcs">bcs</a>)), <a href="message.md#0xb_message_ETrailingBytes">ETrailingBytes</a>);
