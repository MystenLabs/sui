...
<b>use</b> <a href="custodian.md#deepbook_custodian">deepbook::custodian</a>;
...
<pre><code><b>public</b> <b>struct</b> <a href="clob.md#deepbook_clob_PoolCreated">PoolCreated</a> <b>has</b> <b>copy</b>, drop, store
</code></pre>
...
<pre><code><b>public</b> <b>struct</b> <a href="clob.md#deepbook_clob_Order">Order</a> <b>has</b> drop, store
</code></pre>
...
<pre><code><b>public</b> <b>struct</b> <a href="clob.md#deepbook_clob_TickLevel">TickLevel</a> <b>has</b> store
</code></pre>
...
<dt>
<code>open_orders: <a href="../sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;u64, <a href="clob.md#deepbook_clob_Order">deepbook::clob::Order</a>&gt;</code>
</dt>
<dd>
</dd>
</dl>
...
<dt>
<code>bids: <a href="critbit.md#deepbook_critbit_CritbitTree">deepbook::critbit::CritbitTree</a>&lt;<a href="clob.md#deepbook_clob_TickLevel">deepbook::clob::TickLevel</a>&gt;</code>
</dt>
<dd>
</dd>
<dt>
<code>asks: <a href="critbit.md#deepbook_critbit_CritbitTree">deepbook::critbit::CritbitTree</a>&lt;<a href="clob.md#deepbook_clob_TickLevel">deepbook::clob::TickLevel</a>&gt;</code>
</dt>
<dd>
</dd>
<dt>
...
<dt>
<code>base_custodian: <a href="custodian.md#deepbook_custodian_Custodian">deepbook::custodian::Custodian</a>&lt;BaseAsset&gt;</code>
</dt>
<dd>
</dd>
<dt>
<code>quote_custodian: <a href="custodian.md#deepbook_custodian_Custodian">deepbook::custodian::Custodian</a>&lt;QuoteAsset&gt;</code>
</dt>
<dd>
</dd>
<dt>
...
Deprecated since v1.0.0, use <code><a href="clob.md#deepbook_clob_OrderPlacedV2">OrderPlacedV2</a></code> instead.
...
Deprecated since v1.0.0, use <code><a href="clob.md#deepbook_clob_OrderFilledV2">OrderFilledV2</a></code> instead.
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_DEPRECATED">DEPRECATED</a>: u64 = 0;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_EInsufficientBaseCoin">EInsufficientBaseCoin</a>: u64 = 7;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_EInsufficientQuoteCoin">EInsufficientQuoteCoin</a>: u64 = 8;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_EInvalidExpireTimestamp">EInvalidExpireTimestamp</a>: u64 = 19;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_EInvalidOrderId">EInvalidOrderId</a>: u64 = 3;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_EInvalidPrice">EInvalidPrice</a>: u64 = 5;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_EInvalidQuantity">EInvalidQuantity</a>: u64 = 6;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_EInvalidRestriction">EInvalidRestriction</a>: u64 = 14;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_EInvalidTickPrice">EInvalidTickPrice</a>: u64 = 11;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_EInvalidUser">EInvalidUser</a>: u64 = 12;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_EOrderCannotBeFullyFilled">EOrderCannotBeFullyFilled</a>: u64 = 9;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_EOrderCannotBeFullyPassive">EOrderCannotBeFullyPassive</a>: u64 = 10;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_EUnauthorizedCancel">EUnauthorizedCancel</a>: u64 = 4;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_FILL_OR_KILL">FILL_OR_KILL</a>: u8 = 2;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_FLOAT_SCALING">FLOAT_SCALING</a>: u64 = 1000000000;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_IMMEDIATE_OR_CANCEL">IMMEDIATE_OR_CANCEL</a>: u8 = 1;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_MAX_PRICE">MAX_PRICE</a>: u64 = 9223372036854775808;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_MIN_ASK_ORDER_ID">MIN_ASK_ORDER_ID</a>: u64 = 9223372036854775808;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_MIN_PRICE">MIN_PRICE</a>: u64 = 0;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_NO_RESTRICTION">NO_RESTRICTION</a>: u8 = 0;
</code></pre>
...
<pre><code><b>const</b> <a href="clob.md#deepbook_clob_POST_OR_ABORT">POST_OR_ABORT</a>: u8 = 3;
</code></pre>
...
<pre><code><b>fun</b> <a href="clob.md#deepbook_clob_destroy_empty_level">destroy_empty_level</a>(level: <a href="clob.md#deepbook_clob_TickLevel">deepbook::clob::TickLevel</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="clob.md#deepbook_clob_destroy_empty_level">destroy_empty_level</a>(level: <a href="clob.md#deepbook_clob_TickLevel">TickLevel</a>) {
    <b>let</b> <a href="clob.md#deepbook_clob_TickLevel">TickLevel</a> {
        price: _,
        open_orders: orders,
    } = level;
...
<pre><code>publicfun <a href="clob.md#deepbook_clob_create_account">create_account</a>(_ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_create_account">create_account</a>(_ctx: &<b>mut</b> TxContext): AccountCap {
    <b>abort</b> <a href="clob.md#deepbook_clob_DEPRECATED">DEPRECATED</a>
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_create_pool">create_pool</a>&lt;BaseAsset, QuoteAsset&gt;(
    _tick_size: u64,
    _lot_size: u64,
...
<pre><code>publicfun deposit_baseBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, coin: <a href="../sui/coin.md#sui_coin_Coin">sui::coin::Coin</a>&lt;BaseAsset&gt;, account_cap: &<a href="custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_deposit_base">deposit_base</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    coin: Coin&lt;BaseAsset&gt;,
    account_cap: &AccountCap
) {
    <b>assert</b>!(coin::value(&coin) != 0, <a href="clob.md#deepbook_clob_EInsufficientBaseCoin">EInsufficientBaseCoin</a>);
...
<pre><code>publicfun deposit_quoteBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, coin: <a href="../sui/coin.md#sui_coin_Coin">sui::coin::Coin</a>&lt;QuoteAsset&gt;, account_cap: &<a href="custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_deposit_quote">deposit_quote</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    coin: Coin&lt;QuoteAsset&gt;,
    account_cap: &AccountCap
) {
    <b>assert</b>!(coin::value(&coin) != 0, <a href="clob.md#deepbook_clob_EInsufficientQuoteCoin">EInsufficientQuoteCoin</a>);
    <a href="custodian.md#deepbook_custodian_increase_user_available_balance">custodian::increase_user_available_balance</a>(
...
<pre><code>publicfun withdraw_baseBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, quantity: u64, account_cap: &<a href="custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>, ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="../sui/coin.md#sui_coin_Coin">sui::coin::Coin</a>&lt;BaseAsset&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_withdraw_base">withdraw_base</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    quantity: u64,
    account_cap: &AccountCap,
    ctx: &<b>mut</b> TxContext
): Coin&lt;BaseAsset&gt; {
    <b>assert</b>!(quantity &gt; 0, <a href="clob.md#deepbook_clob_EInvalidQuantity">EInvalidQuantity</a>);
    <a href="custodian.md#deepbook_custodian_withdraw_asset">custodian::withdraw_asset</a>(&<b>mut</b> pool.base_custodian, quantity, account_cap, ctx)
}
</code></pre>
...
<pre><code>publicfun withdraw_quoteBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, quantity: u64, account_cap: &<a href="custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>, ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="../sui/coin.md#sui_coin_Coin">sui::coin::Coin</a>&lt;QuoteAsset&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_withdraw_quote">withdraw_quote</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    quantity: u64,
    account_cap: &AccountCap,
    ctx: &<b>mut</b> TxContext
    ...
    <b>assert</b>!(quantity &gt; 0, <a href="clob.md#deepbook_clob_EInvalidQuantity">EInvalidQuantity</a>);
    <a href="custodian.md#deepbook_custodian_withdraw_asset">custodian::withdraw_asset</a>(&<b>mut</b> pool.quote_custodian, quantity, account_cap, ctx)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_swap_exact_base_for_quote">swap_exact_base_for_quote</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    quantity: u64,
    ...
    <b>assert</b>!(quantity &gt; 0, <a href="clob.md#deepbook_clob_EInvalidQuantity">EInvalidQuantity</a>);
    <b>assert</b>!(coin::value(&base_coin) &gt;= quantity, <a href="clob.md#deepbook_clob_EInsufficientBaseCoin">EInsufficientBaseCoin</a>);
    <b>let</b> original_val = coin::value(&quote_coin);
    <b>let</b> (ret_base_coin, ret_quote_coin) = <a href="clob.md#deepbook_clob_place_market_order">place_market_order</a>(
        pool,
        quantity,
        <b>false</b>,
        base_coin,
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_swap_exact_quote_for_base">swap_exact_quote_for_base</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    quantity: u64,
    clock: &Clock,
    quote_coin: Coin&lt;QuoteAsset&gt;,
    ...
    <b>assert</b>!(quantity &gt; 0, <a href="clob.md#deepbook_clob_EInvalidQuantity">EInvalidQuantity</a>);
    <b>assert</b>!(coin::value(&quote_coin) &gt;= quantity, <a href="clob.md#deepbook_clob_EInsufficientQuoteCoin">EInsufficientQuoteCoin</a>);
    <b>let</b> (base_asset_balance, quote_asset_balance) = <a href="clob.md#deepbook_clob_match_bid_with_quote_quantity">match_bid_with_quote_quantity</a>(
        pool,
        quantity,
        <a href="clob.md#deepbook_clob_MAX_PRICE">MAX_PRICE</a>,
...
<pre><code><b>fun</b> <a href="clob.md#deepbook_clob_match_bid_with_quote_quantity">match_bid_with_quote_quantity</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    quantity: u64,
    price_limit: u64,
    ...
    <b>while</b> (!is_empty&lt;<a href="clob.md#deepbook_clob_TickLevel">TickLevel</a>&gt;(all_open_orders) && tick_price &lt;= price_limit) {
        ...
        <b>while</b> (!linked_table::is_empty(&tick_level.open_orders)) {
            ...
            <b>if</b> (maker_order.expire_timestamp &lt;= current_timestamp) {
                skip_order = <b>true</b>;
                <a href="custodian.md#deepbook_custodian_unlock_balance">custodian::unlock_balance</a>(&<b>mut</b> pool.base_custodian, maker_order.owner, maker_order.quantity);
                <a href="clob.md#deepbook_clob_emit_order_canceled">emit_order_canceled</a>&lt;BaseAsset, QuoteAsset&gt;(pool_id, maker_order);
            } <b>else</b> {
                ...
                // filled_quote_quantity_without_commission * (<a href="clob.md#deepbook_clob_FLOAT_SCALING">FLOAT_SCALING</a> + taker_fee_rate) = filled_quote_quantity
                ...
                <b>if</b> (taker_quote_quantity_remaining &gt; maker_quote_quantity) {
                    ...
                    filled_quote_quantity_without_commission = clob_math::unsafe_div(
                        ...
                        <a href="clob.md#deepbook_clob_FLOAT_SCALING">FLOAT_SCALING</a> + pool.taker_fee_rate
                    );
                ...
                <a href="clob.md#deepbook_clob_emit_order_filled">emit_order_filled</a>&lt;BaseAsset, QuoteAsset&gt;(
        ...
        <b>if</b> (linked_table::is_empty(&tick_level.open_orders)) {
            ...
            <a href="clob.md#deepbook_clob_destroy_empty_level">destroy_empty_level</a>(remove_leaf_by_index(all_open_orders, tick_index));
...
<pre><code><b>fun</b> match_bidBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, quantity: u64, price_limit: u64, current_timestamp: u64, quote_balance: <a href="../sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;QuoteAsset&gt;): (<a href="../sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;BaseAsset&gt;, <a href="../sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;QuoteAsset&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="clob.md#deepbook_clob_match_bid">match_bid</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    quantity: u64,
    price_limit: u64,
    current_timestamp: u64,
...
<pre><code><b>fun</b> <a href="clob.md#deepbook_clob_match_ask">match_ask</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    price_limit: u64,
    current_timestamp: u64,
    ...
    <b>while</b> (!is_empty&lt;<a href="clob.md#deepbook_clob_TickLevel">TickLevel</a>&gt;(all_open_orders) && tick_price &gt;= price_limit) {
        ...
        <b>while</b> (!linked_table::is_empty(&tick_level.open_orders)) {
            ...
            <b>if</b> (maker_order.expire_timestamp &lt;= current_timestamp) {
                ...
                <a href="custodian.md#deepbook_custodian_unlock_balance">custodian::unlock_balance</a>(&<b>mut</b> pool.quote_custodian, maker_order.owner, maker_quote_quantity);
                <a href="clob.md#deepbook_clob_emit_order_canceled">emit_order_canceled</a>&lt;BaseAsset, QuoteAsset&gt;(pool_id, maker_order);
            } <b>else</b> {
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_place_market_order">place_market_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    quantity: u64,
    is_bid: bool,
    ...
    <b>assert</b>!(quantity % pool.lot_size == 0, <a href="clob.md#deepbook_clob_EInvalidQuantity">EInvalidQuantity</a>);
    <b>assert</b>!(quantity != 0, <a href="clob.md#deepbook_clob_EInvalidQuantity">EInvalidQuantity</a>);
    <b>if</b> (is_bid) {
        <b>let</b> (base_balance_filled, quote_balance_left) = <a href="clob.md#deepbook_clob_match_bid">match_bid</a>(
            pool,
            quantity,
            <a href="clob.md#deepbook_clob_MAX_PRICE">MAX_PRICE</a>,
            clock::timestamp_ms(clock),
        ...
        <b>assert</b>!(quantity &lt;= coin::value(&base_coin), <a href="clob.md#deepbook_clob_EInsufficientBaseCoin">EInsufficientBaseCoin</a>);
        <b>let</b> (base_balance_left, quote_balance_filled) = <a href="clob.md#deepbook_clob_match_ask">match_ask</a>(
            pool,
            <a href="clob.md#deepbook_clob_MIN_PRICE">MIN_PRICE</a>,
            clock::timestamp_ms(clock),
...
<pre><code><b>fun</b> inject_limit_orderBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, price: u64, quantity: u64, is_bid: bool, expire_timestamp: u64, account_cap: &<a href="custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>, ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="clob.md#deepbook_clob_inject_limit_order">inject_limit_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    price: u64,
    quantity: u64,
    is_bid: bool,
    ...
    <b>let</b> open_orders: &<b>mut</b> CritbitTree&lt;<a href="clob.md#deepbook_clob_TickLevel">TickLevel</a>&gt;;
    <b>if</b> (is_bid) {
        ...
        <a href="custodian.md#deepbook_custodian_lock_balance">custodian::lock_balance</a>&lt;BaseAsset&gt;(&<b>mut</b> pool.base_custodian, account_cap, quantity);
        order_id = pool.next_ask_order_id;
        pool.next_ask_order_id = pool.next_ask_order_id + 1;
        open_orders = &<b>mut</b> pool.asks;
    };
    <b>let</b> order = <a href="clob.md#deepbook_clob_Order">Order</a> {
        order_id,
        price,
        quantity,
        is_bid,
    ...
    <b>if</b> (!tick_exists) {
        tick_index = insert_leaf(
            open_orders,
            price,
            <a href="clob.md#deepbook_clob_TickLevel">TickLevel</a> {
                price,
    ...
    event::emit(<a href="clob.md#deepbook_clob_OrderPlacedV2">OrderPlacedV2</a>&lt;BaseAsset, QuoteAsset&gt; {
...
<pre><code>publicfun place_limit_orderBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, price: u64, quantity: u64, is_bid: bool, expire_timestamp: u64, restriction: u8, clock: &<a href="../sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>, account_cap: &<a href="custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>, ctx: &<b>mut</b> <a href="../sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): (u64, u64, bool, u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_place_limit_order">place_limit_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    price: u64,
    quantity: u64,
    is_bid: bool,
    ...
    <b>assert</b>!(quantity &gt; 0, <a href="clob.md#deepbook_clob_EInvalidQuantity">EInvalidQuantity</a>);
    <b>assert</b>!(price &gt; 0, <a href="clob.md#deepbook_clob_EInvalidPrice">EInvalidPrice</a>);
    <b>assert</b>!(price % pool.tick_size == 0, <a href="clob.md#deepbook_clob_EInvalidPrice">EInvalidPrice</a>);
    <b>assert</b>!(quantity % pool.lot_size == 0, <a href="clob.md#deepbook_clob_EInvalidQuantity">EInvalidQuantity</a>);
    <b>assert</b>!(expire_timestamp &gt; clock::timestamp_ms(clock), <a href="clob.md#deepbook_clob_EInvalidExpireTimestamp">EInvalidExpireTimestamp</a>);
    <b>let</b> user = object::id(account_cap);
    ...
    <b>let</b> order_id;
    <b>if</b> (restriction == <a href="clob.md#deepbook_clob_IMMEDIATE_OR_CANCEL">IMMEDIATE_OR_CANCEL</a>) {
        <b>return</b> (base_quantity_filled, quote_quantity_filled, <b>false</b>, 0)
    };
    <b>if</b> (restriction == <a href="clob.md#deepbook_clob_FILL_OR_KILL">FILL_OR_KILL</a>) {
        <b>assert</b>!(base_quantity_filled == quantity, <a href="clob.md#deepbook_clob_EOrderCannotBeFullyFilled">EOrderCannotBeFullyFilled</a>);
        <b>return</b> (base_quantity_filled, quote_quantity_filled, <b>false</b>, 0)
    };
    <b>if</b> (restriction == <a href="clob.md#deepbook_clob_POST_OR_ABORT">POST_OR_ABORT</a>) {
        <b>assert</b>!(base_quantity_filled == 0, <a href="clob.md#deepbook_clob_EOrderCannotBeFullyPassive">EOrderCannotBeFullyPassive</a>);
        order_id = <a href="clob.md#deepbook_clob_inject_limit_order">inject_limit_order</a>(pool, price, quantity, is_bid, expire_timestamp, account_cap, ctx);
        <b>return</b> (base_quantity_filled, quote_quantity_filled, <b>true</b>, order_id)
    } <b>else</b> {
        <b>assert</b>!(restriction == <a href="clob.md#deepbook_clob_NO_RESTRICTION">NO_RESTRICTION</a>, <a href="clob.md#deepbook_clob_EInvalidRestriction">EInvalidRestriction</a>);
        <b>if</b> (quantity &gt; base_quantity_filled) {
            order_id = <a href="clob.md#deepbook_clob_inject_limit_order">inject_limit_order</a>(
                pool,
                price,
...
<pre><code><b>fun</b> <a href="clob.md#deepbook_clob_order_is_bid">order_is_bid</a>(order_id: u64): bool
</code></pre>
...
<pre><code><b>fun</b> <a href="clob.md#deepbook_clob_order_is_bid">order_is_bid</a>(order_id: u64): bool {
    <b>return</b> order_id &lt; <a href="clob.md#deepbook_clob_MIN_ASK_ORDER_ID">MIN_ASK_ORDER_ID</a>
}
</code></pre>
...
<pre><code><b>fun</b> emit_order_canceledBaseAsset, QuoteAsset(pool_id: <a href="../sui/object.md#sui_object_ID">sui::object::ID</a>, order: &<a href="clob.md#deepbook_clob_Order">deepbook::clob::Order</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="clob.md#deepbook_clob_emit_order_canceled">emit_order_canceled</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool_id: ID,
    order: &<a href="clob.md#deepbook_clob_Order">Order</a>
) {
    event::emit(<a href="clob.md#deepbook_clob_OrderCanceled">OrderCanceled</a>&lt;BaseAsset, QuoteAsset&gt; {
        pool_id,
...
<pre><code><b>fun</b> emit_order_filledBaseAsset, QuoteAsset(pool_id: <a href="../sui/object.md#sui_object_ID">sui::object::ID</a>, order: &<a href="clob.md#deepbook_clob_Order">deepbook::clob::Order</a>, base_asset_quantity_filled: u64, taker_commission: u64, maker_rebates: u64)
</code></pre>
...
<pre><code><b>fun</b> <a href="clob.md#deepbook_clob_emit_order_filled">emit_order_filled</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool_id: ID,
    order: &<a href="clob.md#deepbook_clob_Order">Order</a>,
    ...
    event::emit(<a href="clob.md#deepbook_clob_OrderFilledV2">OrderFilledV2</a>&lt;BaseAsset, QuoteAsset&gt; {
        pool_id,
        order_id: order.order_id,
        is_bid: order.is_bid,
        owner: order.owner,
...
<pre><code>publicfun cancel_orderBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, order_id: u64, account_cap: &<a href="custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_cancel_order">cancel_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    order_id: u64,
    account_cap: &AccountCap
) {
    ...
    <b>let</b> user = object::id(account_cap);
    <b>assert</b>!(contains(&pool.usr_open_orders, user), <a href="clob.md#deepbook_clob_EInvalidUser">EInvalidUser</a>);
    <b>let</b> usr_open_orders = borrow_mut(&<b>mut</b> pool.usr_open_orders, user);
    <b>assert</b>!(linked_table::contains(usr_open_orders, order_id), <a href="clob.md#deepbook_clob_EInvalidOrderId">EInvalidOrderId</a>);
    <b>let</b> tick_price = *linked_table::borrow(usr_open_orders, order_id);
    <b>let</b> is_bid = <a href="clob.md#deepbook_clob_order_is_bid">order_is_bid</a>(order_id);
    <b>let</b> (tick_exists, tick_index) = find_leaf(
        <b>if</b> (is_bid) { &pool.bids } <b>else</b> { &pool.asks },
        tick_price);
    <b>assert</b>!(tick_exists, <a href="clob.md#deepbook_clob_EInvalidOrderId">EInvalidOrderId</a>);
    <b>let</b> order = <a href="clob.md#deepbook_clob_remove_order">remove_order</a>(
    ...
    <b>if</b> (is_bid) {
        ...
        <a href="custodian.md#deepbook_custodian_unlock_balance">custodian::unlock_balance</a>(&<b>mut</b> pool.quote_custodian, user, balance_locked);
    } <b>else</b> {
        <a href="custodian.md#deepbook_custodian_unlock_balance">custodian::unlock_balance</a>(&<b>mut</b> pool.base_custodian, user, order.quantity);
    };
    <a href="clob.md#deepbook_clob_emit_order_canceled">emit_order_canceled</a>&lt;BaseAsset, QuoteAsset&gt;(*object::uid_as_inner(&pool.id), &order);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="clob.md#deepbook_clob_remove_order">remove_order</a>(open_orders: &<b>mut</b> <a href="critbit.md#deepbook_critbit_CritbitTree">deepbook::critbit::CritbitTree</a>&lt;<a href="clob.md#deepbook_clob_TickLevel">deepbook::clob::TickLevel</a>&gt;, usr_open_orders: &<b>mut</b> <a href="../sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;u64, u64&gt;, tick_index: u64, order_id: u64, user: <a href="../sui/object.md#sui_object_ID">sui::object::ID</a>): <a href="clob.md#deepbook_clob_Order">deepbook::clob::Order</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="clob.md#deepbook_clob_remove_order">remove_order</a>(
    open_orders: &<b>mut</b> CritbitTree&lt;<a href="clob.md#deepbook_clob_TickLevel">TickLevel</a>&gt;,
    usr_open_orders: &<b>mut</b> LinkedTable&lt;u64, u64&gt;,
    tick_index: u64,
    order_id: u64,
    user: ID,
): <a href="clob.md#deepbook_clob_Order">Order</a> {
    linked_table::remove(usr_open_orders, order_id);
    <b>let</b> tick_level = borrow_leaf_by_index(open_orders, tick_index);
    <b>assert</b>!(linked_table::contains(&tick_level.open_orders, order_id), <a href="clob.md#deepbook_clob_EInvalidOrderId">EInvalidOrderId</a>);
    ...
    <b>assert</b>!(order.owner == user, <a href="clob.md#deepbook_clob_EUnauthorizedCancel">EUnauthorizedCancel</a>);
    <b>if</b> (linked_table::is_empty(&mut_tick_level.open_orders)) {
        <a href="clob.md#deepbook_clob_destroy_empty_level">destroy_empty_level</a>(remove_leaf_by_index(open_orders, tick_index));
    };
    order
}
</code></pre>
...
<pre><code>publicfun cancel_all_ordersBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, account_cap: &<a href="custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_cancel_all_orders">cancel_all_orders</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    account_cap: &AccountCap
) {
    <b>let</b> pool_id = *object::uid_as_inner(&pool.id);
    ...
    <b>while</b> (!linked_table::is_empty(usr_open_order_ids)) {
        ...
        <b>let</b> (_, tick_index) = <a href="critbit.md#deepbook_critbit_find_leaf">critbit::find_leaf</a>(open_orders, order_price);
        <b>let</b> order = <a href="clob.md#deepbook_clob_remove_order">remove_order</a>(
            open_orders,
            usr_open_order_ids,
            tick_index,
        ...
        <a href="clob.md#deepbook_clob_emit_order_canceled">emit_order_canceled</a>&lt;BaseAsset, QuoteAsset&gt;(pool_id, &order);
    };
}
</code></pre>
...
<pre><code>publicfun batch_cancel_orderBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, order_ids: vector&lt;u64&gt;, account_cap: &<a href="custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_batch_cancel_order">batch_cancel_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    ...
    <b>while</b> (i_order &lt; n_order) {
        ...
        <b>if</b> (new_tick_price != tick_price) {
            ...
            <b>assert</b>!(tick_exists, <a href="clob.md#deepbook_clob_EInvalidTickPrice">EInvalidTickPrice</a>);
...
<pre><code>publicfun list_open_ordersBaseAsset, QuoteAsset(pool: &<a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, account_cap: &<a href="custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>): vector&lt;<a href="clob.md#deepbook_clob_Order">deepbook::clob::Order</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_list_open_orders">list_open_orders</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    account_cap: &AccountCap
): vector&lt;<a href="clob.md#deepbook_clob_Order">Order</a>&gt; {
    <b>let</b> user = object::id(account_cap);
    <b>let</b> usr_open_order_ids = table::borrow(&pool.usr_open_orders, user);
    <b>let</b> <b>mut</b> open_orders = vector::empty&lt;<a href="clob.md#deepbook_clob_Order">Order</a>&gt;();
    ...
    <b>while</b> (!option::is_none(order_id)) {
        ...
        <b>let</b> tick_level =
            <b>if</b> (<a href="clob.md#deepbook_clob_order_is_bid">order_is_bid</a>(*option::borrow(order_id))) borrow_leaf_by_key(&pool.bids, order_price)
        ...
        vector::push_back(&<b>mut</b> open_orders, <a href="clob.md#deepbook_clob_Order">Order</a> {
            order_id: order.order_id,
            price: order.price,
...
<pre><code>publicfun account_balanceBaseAsset, QuoteAsset(pool: &<a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, account_cap: &<a href="custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>): (u64, u64, u64, u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_account_balance">account_balance</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    account_cap: &AccountCap
): (u64, u64, u64, u64) {
    <b>let</b> user = object::id(account_cap);
    <b>let</b> (base_avail, base_locked) = <a href="custodian.md#deepbook_custodian_account_balance">custodian::account_balance</a>(&pool.base_custodian, user);
    <b>let</b> (quote_avail, quote_locked) = <a href="custodian.md#deepbook_custodian_account_balance">custodian::account_balance</a>(&pool.quote_custodian, user);
...
<pre><code>publicfun get_market_priceBaseAsset, QuoteAsset(pool: &<a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;): (u64, u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_get_market_price">get_market_price</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;
): (u64, u64){
    <b>let</b> (bid_price, _) = <a href="critbit.md#deepbook_critbit_max_leaf">critbit::max_leaf</a>(&pool.bids);
    <b>let</b> (ask_price, _) = <a href="critbit.md#deepbook_critbit_min_leaf">critbit::min_leaf</a>(&pool.asks);
...
<pre><code>publicfun get_level2_book_status_bid_sideBaseAsset, QuoteAsset(pool: &<a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, price_low: u64, price_high: u64, clock: &<a href="../sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>): (vector&lt;u64&gt;, vector&lt;u64&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_get_level2_book_status_bid_side">get_level2_book_status_bid_side</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    <b>mut</b> price_low: u64,
    <b>mut</b> price_high: u64,
    clock: &Clock
): (vector&lt;u64&gt;, vector&lt;u64&gt;) {
    <b>let</b> (price_low_, _) = <a href="critbit.md#deepbook_critbit_min_leaf">critbit::min_leaf</a>(&pool.bids);
    <b>if</b> (price_low &lt; price_low_) price_low = price_low_;
    <b>let</b> (price_high_, _) = <a href="critbit.md#deepbook_critbit_max_leaf">critbit::max_leaf</a>(&pool.bids);
    <b>if</b> (price_high &gt; price_high_) price_high = price_high_;
    price_low = <a href="critbit.md#deepbook_critbit_find_closest_key">critbit::find_closest_key</a>(&pool.bids, price_low);
    price_high = <a href="critbit.md#deepbook_critbit_find_closest_key">critbit::find_closest_key</a>(&pool.bids, price_high);
    ...
    <b>while</b> (price_low &lt;= price_high) {
        <b>let</b> depth = <a href="clob.md#deepbook_clob_get_level2_book_status">get_level2_book_status</a>(
            &pool.bids,
            price_low,
            clock::timestamp_ms(clock)
        );
        ...
        <b>let</b> (next_price, _) = <a href="critbit.md#deepbook_critbit_next_leaf">critbit::next_leaf</a>(&pool.bids, price_low);
...
<pre><code>publicfun get_level2_book_status_ask_sideBaseAsset, QuoteAsset(pool: &<a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, price_low: u64, price_high: u64, clock: &<a href="../sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>): (vector&lt;u64&gt;, vector&lt;u64&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_get_level2_book_status_ask_side">get_level2_book_status_ask_side</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    <b>mut</b> price_low: u64,
    <b>mut</b> price_high: u64,
    clock: &Clock
): (vector&lt;u64&gt;, vector&lt;u64&gt;) {
    <b>let</b> (price_low_, _) = <a href="critbit.md#deepbook_critbit_min_leaf">critbit::min_leaf</a>(&pool.asks);
    <b>if</b> (price_low &lt; price_low_) price_low = price_low_;
    <b>let</b> (price_high_, _) = <a href="critbit.md#deepbook_critbit_max_leaf">critbit::max_leaf</a>(&pool.asks);
    <b>if</b> (price_high &gt; price_high_) price_high = price_high_;
    price_low = <a href="critbit.md#deepbook_critbit_find_closest_key">critbit::find_closest_key</a>(&pool.asks, price_low);
    price_high = <a href="critbit.md#deepbook_critbit_find_closest_key">critbit::find_closest_key</a>(&pool.asks, price_high);
    <b>let</b> <b>mut</b> price_vec = vector::empty&lt;u64&gt;();
    <b>let</b> <b>mut</b> depth_vec = vector::empty&lt;u64&gt;();
    <b>if</b> (price_low == 0) { <b>return</b> (price_vec, depth_vec) };
    <b>while</b> (price_low &lt;= price_high) {
        ...
        vector::push_back(&<b>mut</b> price_vec, price_low);
        vector::push_back(&<b>mut</b> depth_vec, depth);
        <b>let</b> (next_price, _) = <a href="critbit.md#deepbook_critbit_next_leaf">critbit::next_leaf</a>(&pool.asks, price_low);
        <b>if</b> (next_price == 0) { <b>break</b> }
        <b>else</b> { price_low = next_price };
    };
    (price_vec, depth_vec)
...
<pre><code><b>fun</b> <a href="clob.md#deepbook_clob_get_level2_book_status">get_level2_book_status</a>(open_orders: &<a href="critbit.md#deepbook_critbit_CritbitTree">deepbook::critbit::CritbitTree</a>&lt;<a href="clob.md#deepbook_clob_TickLevel">deepbook::clob::TickLevel</a>&gt;, price: u64, time_stamp: u64): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="clob.md#deepbook_clob_get_level2_book_status">get_level2_book_status</a>(
    open_orders: &CritbitTree&lt;<a href="clob.md#deepbook_clob_TickLevel">TickLevel</a>&gt;,
    price: u64,
    time_stamp: u64
): u64 {
    <b>let</b> tick_level = <a href="critbit.md#deepbook_critbit_borrow_leaf_by_key">critbit::borrow_leaf_by_key</a>(open_orders, price);
    ...
    <b>let</b> <b>mut</b> order: &<a href="clob.md#deepbook_clob_Order">Order</a>;
    <b>while</b> (!option::is_none(order_id)) {
...
<pre><code>publicfun get_order_statusBaseAsset, QuoteAsset(pool: &<a href="clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, order_id: u64, account_cap: &<a href="custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>): &<a href="clob.md#deepbook_clob_Order">deepbook::clob::Order</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#deepbook_clob_get_order_status">get_order_status</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<a href="clob.md#deepbook_clob_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    order_id: u64,
    account_cap: &AccountCap
): &<a href="clob.md#deepbook_clob_Order">Order</a> {
    <b>let</b> user = object::id(account_cap);
    <b>assert</b>!(table::contains(&pool.usr_open_orders, user), <a href="clob.md#deepbook_clob_EInvalidUser">EInvalidUser</a>);
    <b>let</b> usr_open_order_ids = table::borrow(&pool.usr_open_orders, user);
    <b>assert</b>!(linked_table::contains(usr_open_order_ids, order_id), <a href="clob.md#deepbook_clob_EInvalidOrderId">EInvalidOrderId</a>);
    <b>let</b> order_price = *linked_table::borrow(usr_open_order_ids, order_id);
    <b>let</b> open_orders =
        <b>if</b> (order_id &lt; <a href="clob.md#deepbook_clob_MIN_ASK_ORDER_ID">MIN_ASK_ORDER_ID</a>) { &pool.bids }
        <b>else</b> { &pool.asks };
    <b>let</b> tick_level = <a href="critbit.md#deepbook_critbit_borrow_leaf_by_key">critbit::borrow_leaf_by_key</a>(open_orders, order_price);
    <b>let</b> tick_open_orders = &tick_level.open_orders;
