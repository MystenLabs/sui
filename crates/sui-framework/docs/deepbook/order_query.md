...
<pre><code><b>fun</b> <a href="order_query.md#0xdee9_order_query_iter_ticks_internal">iter_ticks_internal</a>(
    ...
    <b>let</b> <b>mut</b> tick_level_key = <b>if</b> (<a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&start_tick_level)) {
    ...
    <b>let</b> <b>mut</b> orders = <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>[];
    ...
    <b>while</b> (tick_level_key != 0 && <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(&orders) &lt; <a href="order_query.md#0xdee9_order_query_PAGE_LIMIT">PAGE_LIMIT</a> + 1) {
        ...
        <b>let</b> <b>mut</b> next_order_key = <b>if</b> (<a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&start_order_id)) {
