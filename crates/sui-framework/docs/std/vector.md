...
-  [Function `keep_range`](#std_vector_keep_range)
-  [Function `truncate`](#std_vector_truncate)
-  [Function `remove_range`](#std_vector_remove_range)
-  [Function `copy_range`](#std_vector_copy_range)
-  [Function `replace_range`](#std_vector_replace_range)
...
<pre><code><b>public</b> <b>fun</b> <a href="../std/vector.md#std_vector_append">append</a>&lt;Element&gt;(lhs: &<b>mut</b> <a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt;, other: <a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt;) {
    ...
    lhs.<a href="../std/vector.md#std_vector_replace_range">replace_range</a>(len, len, other).<a href="../std/vector.md#std_vector_destroy_empty">destroy_empty</a>();
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../std/vector.md#std_vector_remove">remove</a>&lt;Element&gt;(v: &<b>mut</b> <a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt;, i: <a href="../std/u64.md#std_u64">u64</a>): Element {
    ...
    <b>let</b> <b>mut</b> removed = v.<a href="../std/vector.md#std_vector_remove_range">remove_range</a>(i, i + 1);
...
<pre><code><b>public</b> <b>fun</b> <a href="../std/vector.md#std_vector_insert">insert</a>&lt;Element&gt;(v: &<b>mut</b> <a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt;, e: Element, i: <a href="../std/u64.md#std_u64">u64</a>) {
    // i too big <b>abort</b>
    <b>if</b> (i &gt; v.<a href="../std/vector.md#std_vector_length">length</a>()) <b>abort</b> <a href="../std/vector.md#std_vector_EINDEX_OUT_OF_BOUNDS">EINDEX_OUT_OF_BOUNDS</a>;
    v.<a href="../std/vector.md#std_vector_replace_range">replace_range</a>(i, i, <a href="../std/vector.md#std_vector">vector</a>[e]).<a href="../std/vector.md#std_vector_destroy_empty">destroy_empty</a>();
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../std/vector.md#std_vector_skip">skip</a>&lt;T: drop&gt;(<b>mut</b> v: <a href="../std/vector.md#std_vector">vector</a>&lt;T&gt;, n: <a href="../std/u64.md#std_u64">u64</a>): <a href="../std/vector.md#std_vector">vector</a>&lt;T&gt; {
    ...
    v.<a href="../std/vector.md#std_vector_keep_range">keep_range</a>(n, len);
    v
}
</code></pre>
...
<a name="std_vector_keep_range"></a>

## Function `keep_range`

Retains only <code>v[start..end)</code>, moving the retained elements to the beginning of <code>v</code> and
dropping all others.
Aborts if <code>start &gt; end</code> or <code>end &gt; v.<a href="../std/vector.md#std_vector_length">length</a>()</code>.


<pre><code><b>public</b> <b>fun</b> <a href="../std/vector.md#std_vector_keep_range">keep_range</a>&lt;T: drop&gt;(v: &<b>mut</b> <a href="../std/vector.md#std_vector">vector</a>&lt;T&gt;, start: <a href="../std/u64.md#std_u64">u64</a>, end: <a href="../std/u64.md#std_u64">u64</a>)
</code></pre>
...
<pre><code><b>public</b> <b>native</b> <b>fun</b> <a href="../std/vector.md#std_vector_keep_range">keep_range</a>&lt;T: drop&gt;(v: &<b>mut</b> <a href="../std/vector.md#std_vector">vector</a>&lt;T&gt;, start: <a href="../std/u64.md#std_u64">u64</a>, end: <a href="../std/u64.md#std_u64">u64</a>);
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../std/vector.md#std_vector_truncate">truncate</a>&lt;T: drop&gt;(v: &<b>mut</b> <a href="../std/vector.md#std_vector">vector</a>&lt;T&gt;, n: <a href="../std/u64.md#std_u64">u64</a>) {
    <b>if</b> (n &lt; v.<a href="../std/vector.md#std_vector_length">length</a>()) v.<a href="../std/vector.md#std_vector_keep_range">keep_range</a>(0, n)
}
</code></pre>
...
<a name="std_vector_remove_range"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../std/vector.md#std_vector_remove_range">remove_range</a>&lt;Element&gt;(v: &<b>mut</b> <a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt;, i: <a href="../std/u64.md#std_u64">u64</a>, j: <a href="../std/u64.md#std_u64">u64</a>): <a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../std/vector.md#std_vector_remove_range">remove_range</a>&lt;Element&gt;(v: &<b>mut</b> <a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt;, i: <a href="../std/u64.md#std_u64">u64</a>, j: <a href="../std/u64.md#std_u64">u64</a>): <a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt; {
    v.<a href="../std/vector.md#std_vector_replace_range">replace_range</a>(i, j, <a href="../std/vector.md#std_vector">vector</a>[])
}
</code></pre>
...
<a name="std_vector_copy_range"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../std/vector.md#std_vector_copy_range">copy_range</a>&lt;Element: <b>copy</b>&gt;(v: &<a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt;, i: <a href="../std/u64.md#std_u64">u64</a>, j: <a href="../std/u64.md#std_u64">u64</a>): <a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt;
</code></pre>
...
<pre><code><b>public</b> <b>native</b> <b>fun</b> <a href="../std/vector.md#std_vector_copy_range">copy_range</a>&lt;Element: <b>copy</b>&gt;(v: &<a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt;, i: <a href="../std/u64.md#std_u64">u64</a>, j: <a href="../std/u64.md#std_u64">u64</a>): <a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt;;
</code></pre>
...
<a name="std_vector_replace_range"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../std/vector.md#std_vector_replace_range">replace_range</a>&lt;Element&gt;(v: &<b>mut</b> <a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt;, i: <a href="../std/u64.md#std_u64">u64</a>, j: <a href="../std/u64.md#std_u64">u64</a>, other: <a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt;): <a href="../std/vector.md#std_vector">vector</a>&lt;Element&gt;
</code></pre>
...
<pre><code><b>public</b> <b>native</b> <b>fun</b> <a href="../std/vector.md#std_vector_replace_range">replace_range</a>&lt;Element&gt;(
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../std/vector.md#std_vector_skip_while">skip_while</a>&lt;$T: drop&gt;($v: <a href="../std/vector.md#std_vector">vector</a>&lt;$T&gt;, $p: |&$T| -&gt; <a href="../std/bool.md#std_bool">bool</a>): <a href="../std/vector.md#std_vector">vector</a>&lt;$T&gt; {
    ...
    <b>let</b> len = v.<a href="../std/vector.md#std_vector_length">length</a>();
    <b>while</b> (i &lt; len && $p(&v[i])) i = i + 1;
    v.<a href="../std/vector.md#std_vector_keep_range">keep_range</a>(i, len);
    v
}
</code></pre>
