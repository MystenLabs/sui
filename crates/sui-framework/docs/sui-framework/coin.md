...
<pre><code><b>public</b> <b>fun</b> <a href="../sui-framework/coin.md#0x2_coin_create_regulated_currency_v2">create_regulated_currency_v2</a>&lt;T: drop&gt;(
    ...
    <a href="../sui-framework/dynamic_field.md#0x2_dynamic_field_add">dynamic_field::add</a>(&<b>mut</b> metadata.id, <a href="../sui-framework/coin.md#0x2_coin_RegulatedMarker">RegulatedMarker</a> {}, RegulatedInfo::Regulated { allow_global_pause });
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui-framework/coin.md#0x2_coin_is_regulated_currency">is_regulated_currency</a>&lt;T&gt;(metadata: &<a href="../sui-framework/coin.md#0x2_coin_CoinMetadata">CoinMetadata</a>&lt;T&gt;): Option&lt;bool&gt; {
    ...
    match (<a href="../sui-framework/dynamic_field.md#0x2_dynamic_field_borrow">dynamic_field::borrow</a>(&metadata.id, <a href="../sui-framework/coin.md#0x2_coin_RegulatedMarker">RegulatedMarker</a> {})) {
        ...
        RegulatedInfo::Regulated { allow_global_pause: _ } =&gt; <a href="../move-stdlib/option.md#0x1_option_some">option::some</a>(<b>true</b>),
    }
}
</code></pre>
...
Return None if T was created at an epoch before <code>REGULATED_MARKER_START_EPOCH</code>. Before
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui-framework/coin.md#0x2_coin_allows_global_pause">allows_global_pause</a>&lt;T&gt;(metadata: &<a href="../sui-framework/coin.md#0x2_coin_CoinMetadata">CoinMetadata</a>&lt;T&gt;): Option&lt;bool&gt; {
    ...
    match (<a href="../sui-framework/dynamic_field.md#0x2_dynamic_field_borrow">dynamic_field::borrow</a>(&metadata.id, <a href="../sui-framework/coin.md#0x2_coin_RegulatedMarker">RegulatedMarker</a> {})) {
        RegulatedInfo::Ordinary =&gt; <a href="../move-stdlib/option.md#0x1_option_some">option::some</a>(<b>false</b>),
        RegulatedInfo::Regulated { allow_global_pause } =&gt; <a href="../move-stdlib/option.md#0x1_option_some">option::some</a>(*allow_global_pause),
    }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui-framework/coin.md#0x2_coin_create_regulated_currency">create_regulated_currency</a>&lt;T: drop&gt;(
    ...
    <a href="../sui-framework/dynamic_field.md#0x2_dynamic_field_add">dynamic_field::add</a>(&<b>mut</b> metadata.id, <a href="../sui-framework/coin.md#0x2_coin_RegulatedMarker">RegulatedMarker</a> {}, RegulatedInfo::Regulated { allow_global_pause: <b>false</b> });
    (treasury_cap, deny_cap, metadata)
}
</code></pre>
