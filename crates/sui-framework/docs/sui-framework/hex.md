...
<pre><code><b>const</b> <a href="hex.md#sui_hex_EInvalidHexLength">EInvalidHexLength</a>: u64 = 0;
</code></pre>
...
<pre><code><b>const</b> <a href="hex.md#sui_hex_ENotValidHexCharacter">ENotValidHexCharacter</a>: u64 = 1;
</code></pre>
...
<pre><code>publicfun <a href="hex.md#sui_hex_encode">encode</a>(bytes: vector&lt;u8&gt;): vector&lt;u8&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="hex.md#sui_hex_encode">encode</a>(bytes: vector&lt;u8&gt;): vector&lt;u8&gt; {
    <b>let</b> (<b>mut</b> i, <b>mut</b> r, l) = (0, vector[], bytes.length());
    <b>let</b> hex_vector = <a href="hex.md#sui_hex_HEX">HEX</a>;
    <b>while</b> (i &lt; l) {
...
<pre><code>publicfun <a href="hex.md#sui_hex_decode">decode</a>(<a href="hex.md#sui_hex">hex</a>: vector&lt;u8&gt;): vector&lt;u8&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="hex.md#sui_hex_decode">decode</a>(<a href="hex.md#sui_hex">hex</a>: vector&lt;u8&gt;): vector&lt;u8&gt; {
    <b>let</b> (<b>mut</b> i, <b>mut</b> r, l) = (0, vector[], <a href="hex.md#sui_hex">hex</a>.length());
    <b>assert</b>!(l % 2 == 0, <a href="hex.md#sui_hex_EInvalidHexLength">EInvalidHexLength</a>);
    <b>while</b> (i &lt; l) {
        <b>let</b> decimal = <a href="hex.md#sui_hex_decode_byte">decode_byte</a>(<a href="hex.md#sui_hex">hex</a>[i]) * 16 + <a href="hex.md#sui_hex_decode_byte">decode_byte</a>(<a href="hex.md#sui_hex">hex</a>[i + 1]);
        r.push_back(decimal);
        i = i + 2;
    };
    r
...
<pre><code><b>fun</b> <a href="hex.md#sui_hex_decode_byte">decode_byte</a>(<a href="hex.md#sui_hex">hex</a>: u8): u8
</code></pre>
...
<pre><code><b>fun</b> <a href="hex.md#sui_hex_decode_byte">decode_byte</a>(<a href="hex.md#sui_hex">hex</a>: u8): u8 {
    <b>if</b> (48 &lt;= <a href="hex.md#sui_hex">hex</a> && <a href="hex.md#sui_hex">hex</a> &lt; 58) {
        <a href="hex.md#sui_hex">hex</a> - 48
    } <b>else</b> <b>if</b> (65 &lt;= <a href="hex.md#sui_hex">hex</a> && <a href="hex.md#sui_hex">hex</a> &lt; 71) {
        10 + <a href="hex.md#sui_hex">hex</a> - 65
    } <b>else</b> <b>if</b> (97 &lt;= <a href="hex.md#sui_hex">hex</a> && <a href="hex.md#sui_hex">hex</a> &lt; 103) {
        10 + <a href="hex.md#sui_hex">hex</a> - 97
    } <b>else</b> {
        <b>abort</b> <a href="hex.md#sui_hex_ENotValidHexCharacter">ENotValidHexCharacter</a>
    }
}
</code></pre>
