...
<pre><code><b>public</b> <b>fun</b> <a href="../sui-framework/package.md#0x2_package_claim">claim</a>&lt;OTW: drop&gt;(otw: OTW, ctx: &<b>mut</b> TxContext): <a href="../sui-framework/package.md#0x2_package_Publisher">Publisher</a> {
    ...
    <a href="../sui-framework/package.md#0x2_package_Publisher">Publisher</a> {
        ...
        <a href="../sui-framework/package.md#0x2_package">package</a>: <a href="../move-stdlib/type_name.md#0x1_type_name_get_address">type_name::get_address</a>(&`type`),
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui-framework/package.md#0x2_package_claim_and_keep">claim_and_keep</a>&lt;OTW: drop&gt;(otw: OTW, ctx: &<b>mut</b> TxContext) {
    sui::transfer::public_transfer(<a href="../sui-framework/package.md#0x2_package_claim">claim</a>(otw, ctx), sender(ctx))
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui-framework/package.md#0x2_package_from_package">from_package</a>&lt;T&gt;(self: &<a href="../sui-framework/package.md#0x2_package_Publisher">Publisher</a>): bool {
    ...
    (<a href="../move-stdlib/type_name.md#0x1_type_name_get_address">type_name::get_address</a>(&`type`) == self.<a href="../sui-framework/package.md#0x2_package">package</a>)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui-framework/package.md#0x2_package_version">version</a>(cap: &<a href="../sui-framework/package.md#0x2_package_UpgradeCap">UpgradeCap</a>): u64 {
    cap.version
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="../sui-framework/package.md#0x2_package_only_additive_upgrades">only_additive_upgrades</a>(cap: &<b>mut</b> <a href="../sui-framework/package.md#0x2_package_UpgradeCap">UpgradeCap</a>) {
    <a href="../sui-framework/package.md#0x2_package_restrict">restrict</a>(cap, <a href="../sui-framework/package.md#0x2_package_ADDITIVE">ADDITIVE</a>)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="../sui-framework/package.md#0x2_package_only_dep_upgrades">only_dep_upgrades</a>(cap: &<b>mut</b> <a href="../sui-framework/package.md#0x2_package_UpgradeCap">UpgradeCap</a>) {
    <a href="../sui-framework/package.md#0x2_package_restrict">restrict</a>(cap, <a href="../sui-framework/package.md#0x2_package_DEP_ONLY">DEP_ONLY</a>)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui-framework/package.md#0x2_package_authorize_upgrade">authorize_upgrade</a>(
    cap: &<b>mut</b> <a href="../sui-framework/package.md#0x2_package_UpgradeCap">UpgradeCap</a>,
    policy: u8,
    ...
    <b>let</b> id_zero = <a href="../sui-framework/object.md#0x2_object_id_from_address">object::id_from_address</a>(@0x0);
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui-framework/package.md#0x2_package_commit_upgrade">commit_upgrade</a>(
    cap: &<b>mut</b> <a href="../sui-framework/package.md#0x2_package_UpgradeCap">UpgradeCap</a>,
    receipt: <a href="../sui-framework/package.md#0x2_package_UpgradeReceipt">UpgradeReceipt</a>,
) {
    ...
    <b>assert</b>!(<a href="../sui-framework/object.md#0x2_object_id_to_address">object::id_to_address</a>(&cap.<a href="../sui-framework/package.md#0x2_package">package</a>) == @0x0, <a href="../sui-framework/package.md#0x2_package_ENotAuthorized">ENotAuthorized</a>);
