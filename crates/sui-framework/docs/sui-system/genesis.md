...
<pre><code><b>fun</b> <a href="../sui-system/genesis.md#0x3_genesis_create">create</a>(
    ...
    <b>assert</b>!(<a href="../sui-framework/tx_context.md#0x2_tx_context_epoch">tx_context::epoch</a>(ctx) == 0, <a href="../sui-system/genesis.md#0x3_genesis_ENotCalledAtGenesis">ENotCalledAtGenesis</a>);
    ...
    <b>while</b> (i &lt; count) {
        ...
        <a href="../move-stdlib/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> validators, <a href="../sui-system/validator.md#0x3_validator">validator</a>);
...
<pre><code><b>fun</b> <a href="../sui-system/genesis.md#0x3_genesis_allocate_tokens">allocate_tokens</a>(
    ...
    <b>while</b> (!<a href="../move-stdlib/vector.md#0x1_vector_is_empty">vector::is_empty</a>(&allocations)) {
        ...
        <b>if</b> (<a href="../move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&staked_with_validator)) {
            ...
            <a href="../sui-system/validator.md#0x3_validator_request_add_stake_at_genesis">validator::request_add_stake_at_genesis</a>(
                <a href="../sui-system/validator.md#0x3_validator">validator</a>,
                allocation_balance,
                recipient_address,
                ctx
            );
...
<pre><code><b>fun</b> <a href="../sui-system/genesis.md#0x3_genesis_activate_validators">activate_validators</a>(validators: &<b>mut</b> <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;) {
    ...
    <b>while</b> (i &lt; count) {
        ...
        <a href="../sui-system/validator.md#0x3_validator_activate">validator::activate</a>(<a href="../sui-system/validator.md#0x3_validator">validator</a>, 0);
