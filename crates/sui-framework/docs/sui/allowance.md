...
The inner <code>Withdrawal</code> is fully contained within this module and cannot be
accessed directly: every spend path consumes limits and redeems in one
step, so an allowance's limits can never be charged without the funds
actually moving.
...
<dd>
 An optional recurring limit, applied on top of <code><a href="../sui/allowance.md#sui_allowance_lifetime_cap">lifetime_cap</a></code>. At least
...
<dd>
 ...
 bookkeeping. The <code><a href="../sui/allowance.md#sui_allowance_name">name</a></code> contents can be at most 128 bytes.
</dd>
</dl>
...
<dd>
 Windows of this many civil (UTC) months, renewing on the anchor's
