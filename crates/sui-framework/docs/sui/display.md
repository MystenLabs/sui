...
<pre><code>publicfun newT(pub: &<a href="sui/package.md#sui_package_Publisher">sui::package::Publisher</a>, ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="sui/display.md#sui_display_Display">sui::display::Display</a>&lt;T&gt;
</code></pre>
...
<pre><code>publicfun new_with_fieldsT(pub: &<a href="sui/package.md#sui_package_Publisher">sui::package::Publisher</a>, <a href="sui/display.md#sui_display_fields">fields</a>: vector&lt;<a href="../std/string.md#std_string_String">std::string::String</a>&gt;, values: vector&lt;<a href="../std/string.md#std_string_String">std::string::String</a>&gt;, ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="sui/display.md#sui_display_Display">sui::display::Display</a>&lt;T&gt;
</code></pre>
...
<pre><code>publicentry <b>fun</b> create_and_keepT(pub: &<a href="sui/package.md#sui_package_Publisher">sui::package::Publisher</a>, ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>)
</code></pre>
...
<pre><code>publicentry <b>fun</b> update_versionT(<a href="sui/display.md#sui_display">display</a>: &<b>mut</b> <a href="sui/display.md#sui_display_Display">sui::display::Display</a>&lt;T&gt;)
</code></pre>
...
<pre><code>publicentry <b>fun</b> addT(self: &<b>mut</b> <a href="sui/display.md#sui_display_Display">sui::display::Display</a>&lt;T&gt;, name: <a href="../std/string.md#std_string_String">std::string::String</a>, value: <a href="../std/string.md#std_string_String">std::string::String</a>)
</code></pre>
...
<pre><code>publicentry <b>fun</b> add_multipleT(self: &<b>mut</b> <a href="sui/display.md#sui_display_Display">sui::display::Display</a>&lt;T&gt;, <a href="sui/display.md#sui_display_fields">fields</a>: vector&lt;<a href="../std/string.md#std_string_String">std::string::String</a>&gt;, values: vector&lt;<a href="../std/string.md#std_string_String">std::string::String</a>&gt;)
</code></pre>
...
<pre><code>publicentry <b>fun</b> editT(self: &<b>mut</b> <a href="sui/display.md#sui_display_Display">sui::display::Display</a>&lt;T&gt;, name: <a href="../std/string.md#std_string_String">std::string::String</a>, value: <a href="../std/string.md#std_string_String">std::string::String</a>)
</code></pre>
...
<pre><code>publicentry <b>fun</b> removeT(self: &<b>mut</b> <a href="sui/display.md#sui_display_Display">sui::display::Display</a>&lt;T&gt;, name: <a href="../std/string.md#std_string_String">std::string::String</a>)
</code></pre>
...
<pre><code>publicfun is_authorizedT(pub: &<a href="sui/package.md#sui_package_Publisher">sui::package::Publisher</a>): bool
</code></pre>
...
<pre><code>publicfun versionT(d: &<a href="sui/display.md#sui_display_Display">sui::display::Display</a>&lt;T&gt;): u16
</code></pre>
...
<pre><code>publicfun fieldsT(d: &<a href="sui/display.md#sui_display_Display">sui::display::Display</a>&lt;T&gt;): &<a href="sui/vec_map.md#sui_vec_map_VecMap">sui::vec_map::VecMap</a>&lt;<a href="../std/string.md#std_string_String">std::string::String</a>, <a href="../std/string.md#std_string_String">std::string::String</a>&gt;
</code></pre>
...
<pre><code><b>fun</b> add_internalT(<a href="sui/display.md#sui_display">display</a>: &<b>mut</b> <a href="sui/display.md#sui_display_Display">sui::display::Display</a>&lt;T&gt;, name: <a href="../std/string.md#std_string_String">std::string::String</a>, value: <a href="../std/string.md#std_string_String">std::string::String</a>)
</code></pre>
