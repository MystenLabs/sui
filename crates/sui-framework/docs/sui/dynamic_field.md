...
<pre><code>publicfun remove_if_existsName, Value(<a href="sui/object.md#sui_object">object</a>: &<b>mut</b> <a href="sui/object.md#sui_object_UID">sui::object::UID</a>, name: Name): <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;Value&gt;
</code></pre>
