...
-  [Function `exists`](#sui_dynamic_field_exists)
-  [Function `remove_opt`](#sui_dynamic_field_remove_opt)
-  [Function `replace`](#sui_dynamic_field_replace)
-  [Function `exists_with_type`](#sui_dynamic_field_exists_with_type)
-  [Macro function `borrow_or_add`](#sui_dynamic_field_borrow_or_add)
-  [Macro function `borrow_mut_or_add`](#sui_dynamic_field_borrow_mut_or_add)
-  [Macro function `get_do`](#sui_dynamic_field_get_do)
-  [Macro function `get_mut_do`](#sui_dynamic_field_get_mut_do)
-  [Macro function `get_fold`](#sui_dynamic_field_get_fold)
-  [Macro function `get_mut_fold`](#sui_dynamic_field_get_mut_fold)
...
<a name="sui_dynamic_field_exists"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/dynamic_field.md#sui_dynamic_field_exists">exists</a>&lt;Name: <b>copy</b> + drop + store&gt;(<a href="../sui/object.md#sui_object">object</a>: &UID, name: Name): bool {
    <b>let</b> object_addr = <a href="../sui/object.md#sui_object">object</a>.to_address();
    <b>let</b> <a href="../sui/hash.md#sui_hash">hash</a> = <a href="../sui/dynamic_field.md#sui_dynamic_field_hash_type_and_key">hash_type_and_key</a>(object_addr, name);
...
<a name="sui_dynamic_field_remove_opt"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/dynamic_field.md#sui_dynamic_field_remove_opt">remove_opt</a>&lt;Name: <b>copy</b> + drop + store, Value: store&gt;(
    <a href="../sui/object.md#sui_object">object</a>: &<b>mut</b> UID,
    name: Name,
): Option&lt;Value&gt; {
...
<a name="sui_dynamic_field_replace"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/dynamic_field.md#sui_dynamic_field_replace">replace</a>&lt;Name: <b>copy</b> + drop + store, ValueNew: store, ValueOld: store&gt;(
    <a href="../sui/object.md#sui_object">object</a>: &<b>mut</b> UID,
    name: Name,
    value: ValueNew,
): Option&lt;ValueOld&gt; {
    <b>let</b> old = <a href="../sui/dynamic_field.md#sui_dynamic_field_remove_opt">remove_opt</a>&lt;Name, ValueOld&gt;(<a href="../sui/object.md#sui_object">object</a>, name);
    <a href="../sui/dynamic_field.md#sui_dynamic_field_add">add</a>(<a href="../sui/object.md#sui_object">object</a>, name, value);
    old
}
</code></pre>
...
<a name="sui_dynamic_field_borrow_or_add"></a>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../sui/dynamic_field.md#sui_dynamic_field_borrow_or_add">borrow_or_add</a>&lt;$Name: <b>copy</b> + drop + store, $Value: store&gt;(
    $<a href="../sui/object.md#sui_object">object</a>: &<b>mut</b> UID,
    $name: $Name,
    $default: $Value,
): &$Value {
    ...
    <b>let</b> name = $name;
    <b>if</b> (!<a href="../sui/dynamic_field.md#sui_dynamic_field_exists">exists</a>&lt;$Name&gt;(o, name)) <a href="../sui/dynamic_field.md#sui_dynamic_field_add">add</a>(o, name, $default);
...
<a name="sui_dynamic_field_borrow_mut_or_add"></a>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../sui/dynamic_field.md#sui_dynamic_field_borrow_mut_or_add">borrow_mut_or_add</a>&lt;$Name: <b>copy</b> + drop + store, $Value: store&gt;(
    $<a href="../sui/object.md#sui_object">object</a>: &<b>mut</b> UID,
    $name: $Name,
    $default: $Value,
): &<b>mut</b> $Value {
    ...
    <b>let</b> name = $name;
    <b>if</b> (!<a href="../sui/dynamic_field.md#sui_dynamic_field_exists">exists</a>&lt;$Name&gt;(o, name)) <a href="../sui/dynamic_field.md#sui_dynamic_field_add">add</a>(o, name, $default);
    <a href="../sui/dynamic_field.md#sui_dynamic_field_borrow_mut">borrow_mut</a>(o, name)
}
</code></pre>
...
<a name="sui_dynamic_field_get_do"></a>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../sui/dynamic_field.md#sui_dynamic_field_get_do">get_do</a>&lt;$Name: <b>copy</b> + drop + store, $Value: store, $R: drop&gt;(
    $<a href="../sui/object.md#sui_object">object</a>: &UID,
    $name: $Name,
    $f: |&$Value| -&gt; $R,
) {
...
<a name="sui_dynamic_field_get_mut_do"></a>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../sui/dynamic_field.md#sui_dynamic_field_get_mut_do">get_mut_do</a>&lt;$Name: <b>copy</b> + drop + store, $Value: store, $R: drop&gt;(
    $<a href="../sui/object.md#sui_object">object</a>: &<b>mut</b> UID,
    $name: $Name,
    $f: |&<b>mut</b> $Value| -&gt; $R,
) {
...
<a name="sui_dynamic_field_get_fold"></a>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../sui/dynamic_field.md#sui_dynamic_field_get_fold">get_fold</a>&lt;$Name: <b>copy</b> + drop + store, $Value: store, $R&gt;(
    $<a href="../sui/object.md#sui_object">object</a>: &UID,
    $name: $Name,
    $none: $R,
    $some: |&$Value| -&gt; $R,
...
<a name="sui_dynamic_field_get_mut_fold"></a>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../sui/dynamic_field.md#sui_dynamic_field_get_mut_fold">get_mut_fold</a>&lt;$Name: <b>copy</b> + drop + store, $Value: store, $R&gt;(
    $<a href="../sui/object.md#sui_object">object</a>: &<b>mut</b> UID,
    $name: $Name,
    $none: $R,
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/dynamic_field.md#sui_dynamic_field_exists_">exists_</a>&lt;Name: <b>copy</b> + drop + store&gt;(<a href="../sui/object.md#sui_object">object</a>: &UID, name: Name): bool {
    <a href="../sui/dynamic_field.md#sui_dynamic_field_exists">exists</a>(<a href="../sui/object.md#sui_object">object</a>, name)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/dynamic_field.md#sui_dynamic_field_remove_if_exists">remove_if_exists</a>&lt;Name: <b>copy</b> + drop + store, Value: store&gt;(
    ...
    <a href="../sui/dynamic_field.md#sui_dynamic_field_remove_opt">remove_opt</a>(<a href="../sui/object.md#sui_object">object</a>, name)
}
</code></pre>
...
<pre><code><b>public</b>(<a href="../sui/package.md#sui_package">package</a>) <b>native</b> <b>fun</b> <a href="../sui/dynamic_field.md#sui_dynamic_field_hash_type_and_key">hash_type_and_key</a>&lt;K: <b>copy</b> + drop&gt;(
    parent: <b>address</b>,
    k: K,
): <b>address</b>;
</code></pre>
