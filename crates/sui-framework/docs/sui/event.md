...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/event.md#sui_event_emit_authenticated">emit_authenticated</a>&lt;T: <b>copy</b> + drop&gt;(cap: &<a href="../sui/event.md#sui_event_EventStreamCap">EventStreamCap</a>, <a href="../sui/event.md#sui_event">event</a>: T) {
    <a href="../sui/event.md#sui_event_emit_authenticated_impl">emit_authenticated_impl</a>(cap.stream_id, <a href="../sui/event.md#sui_event">event</a>);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="../sui/event.md#sui_event_emit_authenticated_impl">emit_authenticated_impl</a>&lt;T: <b>copy</b>, drop&gt;(stream: <b>address</b>, <a href="../sui/event.md#sui_event">event</a>: T)
</code></pre>
...
<pre><code><b>native</b> <b>fun</b> <a href="../sui/event.md#sui_event_emit_authenticated_impl">emit_authenticated_impl</a>&lt;T: <b>copy</b> + drop&gt;(stream: <b>address</b>, <a href="../sui/event.md#sui_event">event</a>: T);
</code></pre>
