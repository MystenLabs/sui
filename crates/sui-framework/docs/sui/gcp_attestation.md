...
<a name="sui_gcp_attestation_EKidNotFoundError"></a>

Error that the kid is not found in the trusted JWK set.


<pre><code><b>const</b> <a href="../sui/gcp_attestation.md#sui_gcp_attestation_EKidNotFoundError">EKidNotFoundError</a>: u64 = 3;
</code></pre>
