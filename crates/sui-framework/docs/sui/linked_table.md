...
<pre><code>publicfun newK, V(ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;
</code></pre>
...
<pre><code>publicfun frontK, V(<a href="sui/table.md#sui_table">table</a>: &<a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;): &<a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;K&gt;
</code></pre>
...
<pre><code>publicfun backK, V(<a href="sui/table.md#sui_table">table</a>: &<a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;): &<a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;K&gt;
</code></pre>
...
<pre><code>publicfun push_frontK, V(<a href="sui/table.md#sui_table">table</a>: &<b>mut</b> <a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;, k: K, value: V)
</code></pre>
...
<pre><code>publicfun push_backK, V(<a href="sui/table.md#sui_table">table</a>: &<b>mut</b> <a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;, k: K, value: V)
</code></pre>
...
<pre><code>publicfun borrowK, V(<a href="sui/table.md#sui_table">table</a>: &<a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;, k: K): &V
</code></pre>
...
<pre><code>publicfun borrow_mutK, V(<a href="sui/table.md#sui_table">table</a>: &<b>mut</b> <a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;, k: K): &<b>mut</b> V
</code></pre>
...
<pre><code>publicfun prevK, V(<a href="sui/table.md#sui_table">table</a>: &<a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;, k: K): &<a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;K&gt;
</code></pre>
...
<pre><code>publicfun nextK, V(<a href="sui/table.md#sui_table">table</a>: &<a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;, k: K): &<a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;K&gt;
</code></pre>
...
<pre><code>publicfun removeK, V(<a href="sui/table.md#sui_table">table</a>: &<b>mut</b> <a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;, k: K): V
</code></pre>
...
<pre><code>publicfun pop_frontK, V(<a href="sui/table.md#sui_table">table</a>: &<b>mut</b> <a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;): (K, V)
</code></pre>
...
<pre><code>publicfun pop_backK, V(<a href="sui/table.md#sui_table">table</a>: &<b>mut</b> <a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;): (K, V)
</code></pre>
...
<pre><code>publicfun containsK, V(<a href="sui/table.md#sui_table">table</a>: &<a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;, k: K): bool
</code></pre>
...
<pre><code>publicfun lengthK, V(<a href="sui/table.md#sui_table">table</a>: &<a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;): u64
</code></pre>
...
<pre><code>publicfun is_emptyK, V(<a href="sui/table.md#sui_table">table</a>: &<a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;): bool
</code></pre>
...
<pre><code>publicfun destroy_emptyK, V(<a href="sui/table.md#sui_table">table</a>: <a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;)
</code></pre>
...
<pre><code>publicfun dropK, V(<a href="sui/table.md#sui_table">table</a>: <a href="sui/linked_table.md#sui_linked_table_LinkedTable">sui::linked_table::LinkedTable</a>&lt;K, V&gt;)
</code></pre>
