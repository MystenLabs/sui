...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/linked_table.md#sui_linked_table_insert_before">insert_before</a>&lt;K: <b>copy</b> + <a href="../sui/linked_table.md#sui_linked_table_drop">drop</a> + store, V: store&gt;(
    ...
    old_prev.fold!(
        ...
        |old_prev| df::borrow_mut&lt;K, <a href="../sui/linked_table.md#sui_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="../sui/table.md#sui_table">table</a>.id, old_prev).<a href="../sui/linked_table.md#sui_linked_table_next">next</a> = option::some(k),
    );
    df::add(&<b>mut</b> <a href="../sui/table.md#sui_table">table</a>.id, k, <a href="../sui/linked_table.md#sui_linked_table_Node">Node</a> { <a href="../sui/linked_table.md#sui_linked_table_prev">prev</a>: old_prev, <a href="../sui/linked_table.md#sui_linked_table_next">next</a>: option::some(anchor), value });
    <a href="../sui/table.md#sui_table">table</a>.size = <a href="../sui/table.md#sui_table">table</a>.size + 1;
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../sui/linked_table.md#sui_linked_table_insert_after">insert_after</a>&lt;K: <b>copy</b> + <a href="../sui/linked_table.md#sui_linked_table_drop">drop</a> + store, V: store&gt;(
    ...
    old_next.fold!(
        ...
        |old_next| df::borrow_mut&lt;K, <a href="../sui/linked_table.md#sui_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="../sui/table.md#sui_table">table</a>.id, old_next).<a href="../sui/linked_table.md#sui_linked_table_prev">prev</a> = option::some(k),
    );
    df::add(&<b>mut</b> <a href="../sui/table.md#sui_table">table</a>.id, k, <a href="../sui/linked_table.md#sui_linked_table_Node">Node</a> { <a href="../sui/linked_table.md#sui_linked_table_prev">prev</a>: option::some(anchor), <a href="../sui/linked_table.md#sui_linked_table_next">next</a>: old_next, value });
    <a href="../sui/table.md#sui_table">table</a>.size = <a href="../sui/table.md#sui_table">table</a>.size + 1;
}
</code></pre>
