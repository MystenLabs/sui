...
<pre><code>publicfun <a href="sui/random.md#sui_random_new_generator">new_generator</a>(r: &<a href="sui/random.md#sui_random_Random">sui::random::Random</a>, ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>
</code></pre>
...
<pre><code>publicfun <a href="sui/random.md#sui_random_generate_bytes">generate_bytes</a>(g: &<b>mut</b> <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>, num_of_bytes: u16): vector&lt;u8&gt;
</code></pre>
...
<pre><code>publicfun <a href="sui/random.md#sui_random_generate_u256">generate_u256</a>(g: &<b>mut</b> <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>): u256
</code></pre>
...
<pre><code>publicfun <a href="sui/random.md#sui_random_generate_u128">generate_u128</a>(g: &<b>mut</b> <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>): u128
</code></pre>
...
<pre><code>publicfun <a href="sui/random.md#sui_random_generate_u64">generate_u64</a>(g: &<b>mut</b> <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>): u64
</code></pre>
...
<pre><code>publicfun <a href="sui/random.md#sui_random_generate_u32">generate_u32</a>(g: &<b>mut</b> <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>): u32
</code></pre>
...
<pre><code>publicfun <a href="sui/random.md#sui_random_generate_u16">generate_u16</a>(g: &<b>mut</b> <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>): u16
</code></pre>
...
<pre><code>publicfun <a href="sui/random.md#sui_random_generate_u8">generate_u8</a>(g: &<b>mut</b> <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>): u8
</code></pre>
...
<pre><code>publicfun <a href="sui/random.md#sui_random_generate_bool">generate_bool</a>(g: &<b>mut</b> <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>): bool
</code></pre>
...
<pre><code>publicfun <a href="sui/random.md#sui_random_generate_u128_in_range">generate_u128_in_range</a>(g: &<b>mut</b> <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>, min: u128, max: u128): u128
</code></pre>
...
<pre><code>publicfun <a href="sui/random.md#sui_random_generate_u64_in_range">generate_u64_in_range</a>(g: &<b>mut</b> <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>, min: u64, max: u64): u64
</code></pre>
...
<pre><code>publicfun <a href="sui/random.md#sui_random_generate_u32_in_range">generate_u32_in_range</a>(g: &<b>mut</b> <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>, min: u32, max: u32): u32
</code></pre>
...
<pre><code>publicfun <a href="sui/random.md#sui_random_generate_u16_in_range">generate_u16_in_range</a>(g: &<b>mut</b> <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>, min: u16, max: u16): u16
</code></pre>
...
<pre><code>publicfun <a href="sui/random.md#sui_random_generate_u8_in_range">generate_u8_in_range</a>(g: &<b>mut</b> <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>, min: u8, max: u8): u8
</code></pre>
...
<pre><code>publicfun shuffleT(g: &<b>mut</b> <a href="sui/random.md#sui_random_RandomGenerator">sui::random::RandomGenerator</a>, v: &<b>mut</b> vector&lt;T&gt;)
</code></pre>
