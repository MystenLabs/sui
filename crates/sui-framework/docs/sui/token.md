...
<pre><code>publicfun new_policyT(_treasury_cap: &<a href="sui/coin.md#sui_coin_TreasuryCap">sui::coin::TreasuryCap</a>&lt;T&gt;, ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): (<a href="sui/token.md#sui_token_TokenPolicy">sui::token::TokenPolicy</a>&lt;T&gt;, <a href="sui/token.md#sui_token_TokenPolicyCap">sui::token::TokenPolicyCap</a>&lt;T&gt;)
</code></pre>
...
<pre><code>publicfun share_policyT(policy: <a href="sui/token.md#sui_token_TokenPolicy">sui::token::TokenPolicy</a>&lt;T&gt;)
</code></pre>
...
<pre><code>publicfun transferT(t: <a href="sui/token.md#sui_token_Token">sui::token::Token</a>&lt;T&gt;, <a href="sui/token.md#sui_token_recipient">recipient</a>: <b>address</b>, ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="sui/token.md#sui_token_ActionRequest">sui::token::ActionRequest</a>&lt;T&gt;
</code></pre>
...
<pre><code>publicfun spendT(t: <a href="sui/token.md#sui_token_Token">sui::token::Token</a>&lt;T&gt;, ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="sui/token.md#sui_token_ActionRequest">sui::token::ActionRequest</a>&lt;T&gt;
</code></pre>
...
<pre><code>publicfun to_coinT(t: <a href="sui/token.md#sui_token_Token">sui::token::Token</a>&lt;T&gt;, ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): (<a href="sui/coin.md#sui_coin_Coin">sui::coin::Coin</a>&lt;T&gt;, <a href="sui/token.md#sui_token_ActionRequest">sui::token::ActionRequest</a>&lt;T&gt;)
</code></pre>
...
<pre><code>publicfun from_coinT(<a href="sui/coin.md#sui_coin">coin</a>: <a href="sui/coin.md#sui_coin_Coin">sui::coin::Coin</a>&lt;T&gt;, ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): (<a href="sui/token.md#sui_token_Token">sui::token::Token</a>&lt;T&gt;, <a href="sui/token.md#sui_token_ActionRequest">sui::token::ActionRequest</a>&lt;T&gt;)
</code></pre>
...
<pre><code>publicfun joinT(<a href="sui/token.md#sui_token">token</a>: &<b>mut</b> <a href="sui/token.md#sui_token_Token">sui::token::Token</a>&lt;T&gt;, another: <a href="sui/token.md#sui_token_Token">sui::token::Token</a>&lt;T&gt;)
</code></pre>
...
<pre><code>publicfun splitT(<a href="sui/token.md#sui_token">token</a>: &<b>mut</b> <a href="sui/token.md#sui_token_Token">sui::token::Token</a>&lt;T&gt;, <a href="sui/token.md#sui_token_amount">amount</a>: u64, ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="sui/token.md#sui_token_Token">sui::token::Token</a>&lt;T&gt;
</code></pre>
...
<pre><code>publicfun zeroT(ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="sui/token.md#sui_token_Token">sui::token::Token</a>&lt;T&gt;
</code></pre>
...
<pre><code>publicfun destroy_zeroT(<a href="sui/token.md#sui_token">token</a>: <a href="sui/token.md#sui_token_Token">sui::token::Token</a>&lt;T&gt;)
</code></pre>
...
<pre><code>publicfun keepT(<a href="sui/token.md#sui_token">token</a>: <a href="sui/token.md#sui_token_Token">sui::token::Token</a>&lt;T&gt;, ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>)
</code></pre>
...
<pre><code>publicfun new_requestT(name: <a href="../std/string.md#std_string_String">std::string::String</a>, <a href="sui/token.md#sui_token_amount">amount</a>: u64, <a href="sui/token.md#sui_token_recipient">recipient</a>: <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;<b>address</b>&gt;, <a href="sui/token.md#sui_token_spent_balance">spent_balance</a>: <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;<a href="sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;T&gt;&gt;, ctx: &<a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="sui/token.md#sui_token_ActionRequest">sui::token::ActionRequest</a>&lt;T&gt;
</code></pre>
...
<pre><code>publicfun confirm_with_policy_capT(_policy_cap: &<a href="sui/token.md#sui_token_TokenPolicyCap">sui::token::TokenPolicyCap</a>&lt;T&gt;, request: <a href="sui/token.md#sui_token_ActionRequest">sui::token::ActionRequest</a>&lt;T&gt;, _ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): (<a href="../std/string.md#std_string_String">std::string::String</a>, u64, <b>address</b>, <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;<b>address</b>&gt;)
</code></pre>
...
<pre><code>publicfun add_approvalT, W(_t: W, request: &<b>mut</b> <a href="sui/token.md#sui_token_ActionRequest">sui::token::ActionRequest</a>&lt;T&gt;, _ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>)
</code></pre>
...
<pre><code>publicfun rule_configT, Rule, Config(_rule: Rule, self: &<a href="sui/token.md#sui_token_TokenPolicy">sui::token::TokenPolicy</a>&lt;T&gt;): &Config
</code></pre>
...
<pre><code>publicfun rule_config_mutT, Rule, Config(_rule: Rule, self: &<b>mut</b> <a href="sui/token.md#sui_token_TokenPolicy">sui::token::TokenPolicy</a>&lt;T&gt;, cap: &<a href="sui/token.md#sui_token_TokenPolicyCap">sui::token::TokenPolicyCap</a>&lt;T&gt;): &<b>mut</b> Config
</code></pre>
...
<pre><code>publicfun remove_rule_configT, Rule, Config(self: &<b>mut</b> <a href="sui/token.md#sui_token_TokenPolicy">sui::token::TokenPolicy</a>&lt;T&gt;, cap: &<a href="sui/token.md#sui_token_TokenPolicyCap">sui::token::TokenPolicyCap</a>&lt;T&gt;, _ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): Config
</code></pre>
...
<pre><code>publicfun has_rule_configT, Rule(self: &<a href="sui/token.md#sui_token_TokenPolicy">sui::token::TokenPolicy</a>&lt;T&gt;): bool
</code></pre>
...
<pre><code>publicfun has_rule_config_with_typeT, Rule, Config(self: &<a href="sui/token.md#sui_token_TokenPolicy">sui::token::TokenPolicy</a>&lt;T&gt;): bool
</code></pre>
...
<pre><code>publicfun disallowT(self: &<b>mut</b> <a href="sui/token.md#sui_token_TokenPolicy">sui::token::TokenPolicy</a>&lt;T&gt;, cap: &<a href="sui/token.md#sui_token_TokenPolicyCap">sui::token::TokenPolicyCap</a>&lt;T&gt;, <a href="sui/token.md#sui_token_action">action</a>: <a href="../std/string.md#std_string_String">std::string::String</a>, _ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>)
</code></pre>
...
<pre><code>publicfun remove_rule_for_actionT, Rule(self: &<b>mut</b> <a href="sui/token.md#sui_token_TokenPolicy">sui::token::TokenPolicy</a>&lt;T&gt;, cap: &<a href="sui/token.md#sui_token_TokenPolicyCap">sui::token::TokenPolicyCap</a>&lt;T&gt;, <a href="sui/token.md#sui_token_action">action</a>: <a href="../std/string.md#std_string_String">std::string::String</a>, _ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>)
</code></pre>
...
<pre><code>publicfun mintT(cap: &<b>mut</b> <a href="sui/coin.md#sui_coin_TreasuryCap">sui::coin::TreasuryCap</a>&lt;T&gt;, <a href="sui/token.md#sui_token_amount">amount</a>: u64, ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="sui/token.md#sui_token_Token">sui::token::Token</a>&lt;T&gt;
</code></pre>
...
<pre><code>publicfun burnT(cap: &<b>mut</b> <a href="sui/coin.md#sui_coin_TreasuryCap">sui::coin::TreasuryCap</a>&lt;T&gt;, <a href="sui/token.md#sui_token">token</a>: <a href="sui/token.md#sui_token_Token">sui::token::Token</a>&lt;T&gt;)
</code></pre>
...
<pre><code>publicfun flushT(self: &<b>mut</b> <a href="sui/token.md#sui_token_TokenPolicy">sui::token::TokenPolicy</a>&lt;T&gt;, cap: &<b>mut</b> <a href="sui/coin.md#sui_coin_TreasuryCap">sui::coin::TreasuryCap</a>&lt;T&gt;, _ctx: &<b>mut</b> <a href="sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code>publicfun is_allowedT(self: &<a href="sui/token.md#sui_token_TokenPolicy">sui::token::TokenPolicy</a>&lt;T&gt;, <a href="sui/token.md#sui_token_action">action</a>: &<a href="../std/string.md#std_string_String">std::string::String</a>): bool
</code></pre>
...
<pre><code>publicfun spent_balanceT(self: &<a href="sui/token.md#sui_token_TokenPolicy">sui::token::TokenPolicy</a>&lt;T&gt;): u64
</code></pre>
...
<pre><code>publicfun valueT(t: &<a href="sui/token.md#sui_token_Token">sui::token::Token</a>&lt;T&gt;): u64
</code></pre>
...
<pre><code>publicfun <a href="sui/token.md#sui_token_transfer_action">transfer_action</a>(): <a href="../std/string.md#std_string_String">std::string::String</a>
</code></pre>
...
<pre><code>publicfun <a href="sui/token.md#sui_token_spend_action">spend_action</a>(): <a href="../std/string.md#std_string_String">std::string::String</a>
</code></pre>
...
<pre><code>publicfun <a href="sui/token.md#sui_token_to_coin_action">to_coin_action</a>(): <a href="../std/string.md#std_string_String">std::string::String</a>
</code></pre>
...
<pre><code>publicfun <a href="sui/token.md#sui_token_from_coin_action">from_coin_action</a>(): <a href="../std/string.md#std_string_String">std::string::String</a>
</code></pre>
...
<pre><code>publicfun actionT(self: &<a href="sui/token.md#sui_token_ActionRequest">sui::token::ActionRequest</a>&lt;T&gt;): <a href="../std/string.md#std_string_String">std::string::String</a>
</code></pre>
...
<pre><code>publicfun amountT(self: &<a href="sui/token.md#sui_token_ActionRequest">sui::token::ActionRequest</a>&lt;T&gt;): u64
</code></pre>
...
<pre><code>publicfun senderT(self: &<a href="sui/token.md#sui_token_ActionRequest">sui::token::ActionRequest</a>&lt;T&gt;): <b>address</b>
</code></pre>
...
<pre><code>publicfun recipientT(self: &<a href="sui/token.md#sui_token_ActionRequest">sui::token::ActionRequest</a>&lt;T&gt;): <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;<b>address</b>&gt;
</code></pre>
...
<pre><code>publicfun approvalsT(self: &<a href="sui/token.md#sui_token_ActionRequest">sui::token::ActionRequest</a>&lt;T&gt;): <a href="sui/vec_set.md#sui_vec_set_VecSet">sui::vec_set::VecSet</a>&lt;<a href="../std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>&gt;
</code></pre>
...
<pre><code>publicfun spentT(self: &<a href="sui/token.md#sui_token_ActionRequest">sui::token::ActionRequest</a>&lt;T&gt;): <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;u64&gt;
</code></pre>
