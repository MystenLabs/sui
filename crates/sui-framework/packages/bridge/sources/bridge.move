...
module bridge::bridge {
    ...
    const EUnsupportedTokenType: u64 = 100;
    ...
    fun init(ctx: &mut TxContext) {
        ...
        treasury::add_treasury_cap(&mut treasury, treasury_cap);
    ...
    fun claim_token_internal<T>(
        ...
        // check token type
        assert!(token_id<T>() == message::token_type(&token_payload), EUnexpectedTokenType);
        // claim from treasury
