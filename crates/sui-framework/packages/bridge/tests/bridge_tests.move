...
module bridge::bridge_tests {
    ...
    fun test_bridge_create_non_system_addr() {
        let mut env = create_env(chain_ids::sui_mainnet(), @0x1);
    ...
    fun test_init_committee() {
        let mut env = create_env(chain_ids::sui_custom(), @0x0);
    ...
    fun test_init_committee_non_system_addr() {
        let mut env = create_env(chain_ids::sui_mainnet(), @0x0);
    ...
    fun test_system_msg_incorrect_chain_id() {
        let sender = @0x0;
        let mut env = create_env(chain_ids::sui_testnet(), sender);
        env.create_bridge_default();
        env.execute_blocklist(sender, chain_ids::sui_mainnet(), 0, vector[], vector[]);
