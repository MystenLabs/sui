...
module deepbook::clob {
    ...
    public fun withdraw_base<BaseAsset, QuoteAsset>(
        ...
        custodian::withdraw_asset<BaseAsset>(&mut pool.base_custodian, quantity, account_cap, ctx)
    }
    ...
    public fun withdraw_quote<BaseAsset, QuoteAsset>(
        ...
        custodian::withdraw_asset<QuoteAsset>(&mut pool.quote_custodian, quantity, account_cap, ctx)
    }
