...
/// Return a new vector containing the elements of `v` include the first `n` elements
/// that satisfy the predicate `p`. If all elements satisfy the predicate, returns a
