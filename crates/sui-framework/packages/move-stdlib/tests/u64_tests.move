...
module std::u64_tests {
    ...
    fun test_pow() {
        ...
        assert_eq!(0u64.pow(2), 0);
        assert_eq!(1u64.pow(255), 1);
        assert_eq!(2u64.pow(12), slow_pow!(2u64, 12));
    ...
    fun test_sqrt() {
        ...
        let mut cases: vector<u64> = vector[2, 3, 4, 5, 6];
        while (!cases.is_empty()) {
            let case = cases.pop_back();
            let prev = case - 1;
