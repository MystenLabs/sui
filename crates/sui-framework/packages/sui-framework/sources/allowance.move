...
///
/// The inner `Withdrawal` is fully contained within this module and cannot be
...
public struct Settings has drop, store {
    ...
    /// An optional recurring limit, applied on top of `lifetime_cap`. At least
    ...
    /// bookkeeping. The `name` contents can be at most 128 bytes.
    name: String,
}
