...
module sui::authenticator_state {
	...
	public fun create_active_jwk(iss: String, kid: String, kty: String, epoch: u64): ActiveJwk {
		ActiveJwk {
			...
			jwk: JWK {kty: kty, e: utf8(b"AQAB"), n: utf8(b"test"), alg: utf8(b"RS256")},
			epoch,
		}
	}
	...
	fun jwk_equal(a: &JWK, b: &JWK): bool {
		(&a.kty == &b.kty) && (&a.e == &b.e) && (&a.n == &b.n) && (&a.alg == &b.alg)
	}
	...
	fun create(ctx: &TxContext) {
		...
		let mut self = AuthenticatorState {id: object::authenticator_state(), version};
	...
	#[test_only]
	public fun get_active_jwks_for_testing(self: &AuthenticatorState, ctx: &TxContext): vector<
		ActiveJwk,
	> {
