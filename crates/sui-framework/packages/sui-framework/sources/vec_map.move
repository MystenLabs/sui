...
module sui::vec_map {
	...
	public struct VecMap<K: copy, V> has copy, drop, store { contents: vector<Entry<K, V>> }
	...
	/// and are *not* sorted.
	public fun from_keys_values<K: copy, V>(mut keys: vector<K>, mut values: vector<V>): VecMap<
		K,
		V,
	> {
