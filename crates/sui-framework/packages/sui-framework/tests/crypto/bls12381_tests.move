...
module sui::bls12381_tests {
    ...
    fun test_uncompressed_sum() {
        ...
        assert!(group_ops::equal(&bls12381::g1_to_uncompressed(&bls12381::g1_identity()), &sum));

        let a = bls12381::g1_generator();
        let sum = bls12381::g1_sum_of_uncompressed(&vector[bls12381::g1_to_uncompressed(&a)]);
        assert!(group_ops::equal(&bls12381::g1_to_uncompressed(&a), &sum));
        ...
        let expected = bls12381::g1_to_uncompressed(&bls12381::g1_mul(&bls12381::scalar_from_u64(6), &bls12381::g1_generator()));
