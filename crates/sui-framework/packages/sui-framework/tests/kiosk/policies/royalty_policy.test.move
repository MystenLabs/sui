...
module sui::royalty_rule_tests {
    ...
    #[test]
    #[expected_failure(abort_code = sui::royalty_rule::EIncorrectArgument)]
    ...
    #[test]
    #[expected_failure(abort_code = sui::royalty_rule::EInsufficientAmount)]
