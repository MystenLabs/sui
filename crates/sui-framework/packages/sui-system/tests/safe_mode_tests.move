...
module sui::safe_mode_tests {
    ...
    fun test_safe_mode_gas_accumulation() {
        ...
        };
        {
            ...
            test_utils::assert_eq(sui_system::validator_stake_amount(&system_state, @0x1), 1);
            test_utils::assert_eq(sui_system::get_storage_fund_balance(&system_state), 1000);
        ...
        test_utils::assert_eq(sui_system::validator_stake_amount(&system_state, @0x1), 15);
        test_utils::assert_eq(sui_system::validator_stake_amount(&system_state, @0x2), 15);
        test_utils::assert_eq(sui_system::validator_stake_amount(&system_state, @0x3), 15);
        test_utils::assert_eq(sui_system::validator_stake_amount(&system_state, @0x4), 15);

        // Storage fund is 1000 + 8 + 16 - 30 - 30 = 964. 4 leftover due to integer division.
        test_utils::assert_eq(sui_system::get_storage_fund_balance(&system_state), 968);
