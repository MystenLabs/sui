...
module sui::validator_set {
    ...
    public(friend) fun new(init_active_validators: vector<Validator>): ValidatorSet {
        ...
        voting_power::update(&mut init_active_validators);
        let validators = ValidatorSet {
            total_validator_stake,
            total_delegation_stake,
            // TODO: we may not need these because they are always the same
            total_voting_power: voting_power::total_voting_power(),
            quorum_threshold: voting_power::quorum_threshold(),
        ...
        voting_power::update(&mut validators.active_validators);
        validators
    }
    ...
    public(friend) fun advance_epoch(
        ...
        voting_power::update(&mut self.active_validators)
    }
