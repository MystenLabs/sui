...
module sui::test_scenario_wip {
    ...
    /// Transaction ended without all shared and immutable objects being returned
    const EObjectsNotReturned: u64 = 2;
    ...
    /// test_scenario::assert_success(test_scenario::next_tx(scenario, &addr2));
    /// {
    ...
    public fun next_epoch(scenario: &mut Scenario, sender: &address): TransactionResult {
