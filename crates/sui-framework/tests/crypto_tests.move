...
module sui::crypto_tests {
    ...
    fun test_bulletproof_standard_0_2pow64_proof() {
        ...
        let _commitment = vector[224, 131, 28, 42, 140, 170, 172, 201, 243, 54, 153, 119, 106, 97, 215, 123, 64, 125, 6, 93, 9, 1, 78, 186, 6, 18, 64, 219, 210, 225, 125, 113];


        let vec1 = crypto::big_scalar_to_vec(crypto::big_scalar_from_u64(1000));
        let vec2 = crypto::big_scalar_to_vec(crypto::big_scalar_from_u64(10));
