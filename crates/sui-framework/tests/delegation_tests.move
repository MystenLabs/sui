...
module sui::delegation_tests {
    ...
    fun test_switch_delegation() {
        ...
        // The delegator should get another 9 SUI of rewards.
        ...
        test_scenario::next_tx(scenario, DELEGATOR_ADDR_1);
        {
            ...
            assert!(staking_pool::staked_sui_amount(&staked_sui_2) == 6, 106); // 40% of the rewards (16 SUI) with the new validator
        ...
        test_scenario::next_tx(scenario, DELEGATOR_ADDR_1);
        {
            ...
            assert!(sui_system::validator_delegate_amount(&system_state, VALIDATOR_ADDR_1) == 40, 107);
