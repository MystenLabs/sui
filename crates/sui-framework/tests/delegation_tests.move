...
module sui::delegation_tests {
    ...
    fun test_switch_delegation() {
        ...
        test_scenario::next_tx(scenario, DELEGATOR_ADDR_1);
        {
            ...
            assert!(staking_pool::staked_sui_amount(&staked_sui_1) == 15, 106); // rewards (16 SUI) with the new validator
        ...
        test_scenario::next_tx(scenario, DELEGATOR_ADDR_1);
        {
            ...
            assert!(sui_system::validator_delegate_amount(&system_state, VALIDATOR_ADDR_2) == 65, 107);
            test_scenario::return_shared(system_state);
        };
        test_scenario::end(scenario_val);
    }
