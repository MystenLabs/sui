...
use super::{
    ...
    transaction_block_effects::{TransactionBlockEffects, TransactionBlockEffectsInner},
...
impl TryFrom<TransactionBlockEffects> for TransactionBlock {
    ...
    fn try_from(effects: TransactionBlockEffects) -> Result<Self, Error> {
        ...
        let inner = match effects.inner {
            ...
            TransactionBlockEffectsInner::DryRun {
                tx_data,
                native,
                events,
