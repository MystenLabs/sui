    ...
    S: StreamingService + Send + 'static,
{
    ...
    tokio::spawn(async move {
        ...
        // Start with None or Some if we received initial feedback.
        let mut ingest_hi = subscribers_hi
            .values()
            .copied()
            .min()
...
mod tests {
    ...
    async fn streaming_with_backpressure() {
        ...
        // Set initial watermark low to trigger backpressure
        hi_tx.send(("test", 10)).unwrap();
