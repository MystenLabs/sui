    ...
    tokio::spawn(async move {
        ...
        loop {
            ...
            tokio::select! {
                ...
                // docs::#regulator (see docs/content/references/contribute/mdx-components.mdx#code-inject)
                ...
                // docs::/#regulator
                // docs::#bound (see docs/content/references/contribute/mdx-components.mdx#code-inject)
