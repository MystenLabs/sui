...
pub mod tests {
    ...
    async fn test_add_new_pipeline() {
        ...
        assert_eq!(indexer.min_checkpoint_hi, 0);
        assert_eq!(indexer.sequential_min_checkpoint_hi, None);
    }
    ...
    async fn test_add_existing_pipeline() {
        ...
        indexer
            ...
            .unwrap();
        assert_eq!(indexer.latest_checkpoint, None);
        assert_eq!(indexer.min_checkpoint_hi, 11);
        assert_eq!(indexer.sequential_min_checkpoint_hi, None);
    }
    ...
    async fn test_add_multiple_pipelines() {
        ...
        indexer
            ...
            .unwrap();
        assert_eq!(indexer.latest_checkpoint, None);
        assert_eq!(indexer.min_checkpoint_hi, 21);
        assert_eq!(indexer.sequential_min_checkpoint_hi, None);
        indexer
            .concurrent_pipeline(ConcurrentPipeline1, ConcurrentConfig::default())
            .await
