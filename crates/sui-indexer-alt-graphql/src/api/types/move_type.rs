...
impl TryFrom<CA::MoveEnumLayout> for MoveEnumLayout {
    type Error = RpcError;

    fn try_from(layout: CA::MoveEnumLayout) -> Result<Self, RpcError> {
...
impl TryFrom<CA::MoveStructLayout> for MoveStructLayout {
    type Error = RpcError;

    fn try_from(layout: CA::MoveStructLayout) -> Result<Self, RpcError> {
