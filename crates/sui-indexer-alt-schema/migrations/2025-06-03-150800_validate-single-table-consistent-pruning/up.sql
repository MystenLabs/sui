...
ON obj_info_v2 (owner_kind, owner_id, cp_sequence_number DESC, object_id);

CREATE INDEX IF NOT EXISTS obj_info_pkg
ON obj_info_v2 (package, cp_sequence_number DESC, object_id);

CREATE INDEX IF NOT EXISTS obj_info_mod
ON obj_info_v2 (package, module, cp_sequence_number DESC, object_id);

CREATE INDEX IF NOT EXISTS obj_info_name
ON obj_info_v2 (package, module, name, cp_sequence_number DESC, object_id);

CREATE INDEX IF NOT EXISTS obj_info_inst
ON obj_info_v2 (package, module, name, instantiation, cp_sequence_number DESC, object_id);

CREATE INDEX IF NOT EXISTS obj_info_owner_pkg
ON obj_info_v2 (owner_kind, owner_id, package, cp_sequence_number DESC, object_id);

CREATE INDEX IF NOT EXISTS obj_info_owner_mod
ON obj_info_v2 (owner_kind, owner_id, package, module, cp_sequence_number DESC, object_id);

CREATE INDEX IF NOT EXISTS obj_info_owner_name
ON obj_info_v2 (owner_kind, owner_id, package, module, name, cp_sequence_number DESC, object_id);

CREATE INDEX IF NOT EXISTS obj_info_owner_inst
ON obj_info_v2 (owner_kind, owner_id, package, module, name, instantiation, cp_sequence_number DESC, object_id);
