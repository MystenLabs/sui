...
pub type CpBloomFilter =
    BloomFilter<{ CP_BLOOM_NUM_BYTES }, { CP_BLOOM_NUM_HASHES }, { BLOOM_FILTER_SEED }>;
...
/// Hashes a value using `CpBloomFilter` dimensions.
