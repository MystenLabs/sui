...
use sui_types::base_types::{MoveObjectType, TransactionDigest};
use sui_types::collection_types::VecMap;
use sui_types::dynamic_field::{derive_dynamic_field_id, serialize_dynamic_field};
...
use sui_types::sui_system_state::sui_system_state_inner_v2::{
    SuiSystemStateInnerV2, SystemParametersV2,
};
use sui_types::sui_system_state::{SuiSystemState, SuiSystemStateWrapper};
use sui_types::{MoveTypeTagTrait, SUI_SYSTEM_STATE_OBJECT_ID};
...
pub fn genesis_output_objects(sui_system_state: SuiSystemState) -> Vec<Object> {
