    ...
    T: R2D2Connection + 'static,
{
    ...
    pub(crate) async fn index_objects(
        ...
        // TODO(gegaowp): move_struct_layout_map is no longer needed when we only keep df_kind,
        // this has been discussed and will do it in a follow-up PR with other related schema changes.
