...
pub struct IndexerMetrics {
    ...
    pub checkpoint_db_commit_latency_objects_version_unpartitioned: Histogram,
    ...
    pub checkpoint_db_commit_latency_objects_version_unpartitioned_chunks: Histogram,
...
impl IndexerMetrics {
    pub fn new(registry: &Registry) -> Self {
        Self {
            ...
            checkpoint_db_commit_latency_objects_version_unpartitioned: register_histogram_with_registry!(
                "checkpoint_db_commit_latency_objects_version_unpartitioned",
                "Time spent committing objects version (unpartitioned)",
                DATA_INGESTION_LATENCY_SEC_BUCKETS.to_vec(),
                registry,
            ).unwrap(),
            ...
            checkpoint_db_commit_latency_objects_version_unpartitioned_chunks: register_histogram_with_registry!(
                "checkpoint_db_commit_latency_objects_version_unpartitioned_chunks",
                "Time spent committing objects version chunks (unpartitioned)",
                DATA_INGESTION_LATENCY_SEC_BUCKETS.to_vec(),
                registry,
            ).unwrap(),
