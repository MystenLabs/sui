...
use crate::schema::{chain_identifier, checkpoints, checkpoints_v1, pruner_cp_watermark};
...
#[derive(Queryable, Insertable, Selectable, Debug, Clone, Default)]
#[diesel(table_name = checkpoints_v1)]
pub struct StoredCheckpointV1 {
...
impl From<&IndexedCheckpoint> for StoredCheckpointV1 {
...
impl TryFrom<StoredCheckpointV1> for RpcCheckpoint {
    type Error = IndexerError;
    fn try_from(checkpoint: StoredCheckpointV1) -> Result<RpcCheckpoint, IndexerError> {
