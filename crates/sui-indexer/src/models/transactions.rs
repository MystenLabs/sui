...
impl TryFrom<TemporaryTransactionBlockResponseStore> for Transaction {
    ...
    fn try_from(tx_resp: TemporaryTransactionBlockResponseStore) -> Result<Self, Self::Error> {
        ...
        Ok(Transaction {
            ...
            recipients: serde_json::json!( vec_string_to_vec_opt(recipients)),
            ...
            created: serde_json::json!(vec_string_to_vec_opt(created)),
            mutated: serde_json::json!(vec_string_to_vec_opt(mutated)),
            unwrapped: serde_json::json!(vec_string_to_vec_opt(unwrapped)),
            deleted: serde_json::json!(vec_string_to_vec_opt(deleted)),
            wrapped: serde_json::json!(vec_string_to_vec_opt(wrapped)),
            move_calls: serde_json::json!(vec_string_to_vec_opt(move_call_strs)),
