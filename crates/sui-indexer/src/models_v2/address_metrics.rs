...
pub struct StoredAddress {
    pub address: Vec<u8>,
    pub first_appearance_tx: Vec<u8>,
    pub first_appearance_time: i64,
    pub last_appearance_tx: Vec<u8>,
...
pub fn dedup_addresses(addrs_to_commit: &[AddressInfoToCommit]) -> Vec<StoredAddress> {
