...
use crate::types_v2::TxCountMetrics;
...
impl TxCountMetricsDelta {
    pub fn get_tx_count_metrics_delta(
        ...
        let checkpoint_sequence_number = tx_batch
            .iter()
        ...
        let total_successful_transaction_blocks = tx_batch
            .iter()
            .filter(|tx| tx.successful_tx_num > 0)
            .count() as i64;
        let total_successful_transactions = tx_batch
            .iter()
            .fold(0, |acc, tx| acc + tx.successful_tx_num as i64);
