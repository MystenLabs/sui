...
use crate::schema::{
    ...
    objects_snapshot, objects_version, packages, pruner_cp_watermark, transactions, tx_calls_fun,
    tx_calls_mod, tx_calls_pkg, tx_changed_objects, tx_digests, tx_input_objects, tx_recipients,
    tx_senders,
};
