...
impl From<SuiTransactionBlockResponseWithOptions> for SuiTransactionBlockResponse {
    fn from(value: SuiTransactionBlockResponseWithOptions) -> Self {
        ...
        SuiTransactionBlockResponse {
            ...
            raw_transaction: if options
                .show_raw_input { response.raw_transaction } else { Default::default() },
            ...
            errors: vec![],
            raw_effects: if options
                .show_raw_effects { response.raw_effects } else { Default::default() },
        }
    }
}
