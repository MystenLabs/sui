...
mod tests {
    ...
    // The at_checkpoint path is exercised against the real BigTable emulator
    // in sui-kvstore (get_package_latest_bounds_by_publish_checkpoint); the
    // mock deliberately does not interpret the Condition filter it emits.
    #[tokio::test]
