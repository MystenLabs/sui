...
#[test]
fn event_bitmap_seal_tx_hi_exclusive_handles_exact_boundaries() {
    let txs_per_event_bucket =
        event_bitmap_index::BUCKET_SIZE / event_bitmap_index::MAX_EVENTS_PER_TX as u64;
    assert_eq!(
        EventSealProcessor::seal_tx_hi_exclusive(0),
        txs_per_event_bucket,
    );
    assert_eq!(
        EventSealProcessor::seal_tx_hi_exclusive(1),
        txs_per_event_bucket * 2,
    );
}
