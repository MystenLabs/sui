...
//              transfer per stable.
// Version 125: Revisited gas-charging pipeline (gas_model v15). Replaces the monolithic
//              charge_gas with discrete steps: round_computation / finalize_storage / charge
