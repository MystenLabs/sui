    ...
    fn get_for_version_impl(version: ProtocolVersion) -> Self {
        ...
        match version.0 {
            1 => Self {
                ...
                max_num_new_move_object_ids_system_tx: Some(2048 * 8),
                max_num_deleted_move_object_ids: Some(2048),
                max_num_deleted_move_object_ids_system_tx: Some(2048 * 8),
                max_num_transfered_move_object_ids: Some(2048),
                max_num_transfered_move_object_ids_system_tx: Some(2048 * 8),
                max_event_emit_size: Some(250 * 1024),
                max_move_vector_len: Some(256 * 1024),
                object_runtime_max_num_cached_objects: Some(1000),
                object_runtime_max_num_cached_objects_system_tx: Some(1000 * 8),
                object_runtime_max_num_store_entries: Some(1000),
                object_runtime_max_num_store_entries_system_tx: Some(1000 * 8),
