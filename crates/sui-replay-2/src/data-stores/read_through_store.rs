...
use crate::replay_interface::{
    ...
    StoreSummary, TransactionInfo, TransactionStore, TransactionStoreWriter,
};
...
where
    P: TransactionStore
        ...
        + ObjectStore
        + ObjectStoreWriter,
    S: TransactionStore + EpochStore + ObjectStore,
{
    ...
    S: TransactionStore + EpochStore + ObjectStore,
{
    fn transaction_data_and_effects(
        ...
        match self.primary.transaction_data_and_effects(tx_digest)? {
            ...
            None => match self.secondary.transaction_data_and_effects(tx_digest)? {
...
where
    P: TransactionStore
        ...
        + ObjectStoreWriter
        + StoreSummary,
    S: TransactionStore + EpochStore + ObjectStore + StoreSummary,
{
