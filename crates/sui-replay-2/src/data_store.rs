...
use crate::{errors::ReplayError, Node};
...
use sui_types::{
    base_types::ObjectID, digests::TransactionDigest, effects::TransactionEffects, event::SystemEpochInfoEvent, move_package::MovePackage, object::Object, supported_protocol_versions::Chain, transaction::TransactionData 
};
use tracing::debug;
...
impl DataStore {
    ...
    pub async fn transaction(&self, tx_digest: &str) -> Result<TransactionData, ReplayError> {
    ...
    // Epoch operations
    //
    pub async fn load_epochs(
        &self,
    ) -> Result<(Vec<(u64, u64, u64)>, Vec<(u64, u64, u64)>, BTreeMap<u64, (u64, TransactionDigest)>), ReplayError> {
