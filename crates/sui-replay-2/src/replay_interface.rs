...
pub trait TransactionStoreWriter {
...
pub trait ObjectStoreWriter {
    ...
    /// - `RootVersion(max_v)`: Stores a mapping from `max_v` to `actual_version` and the
    ///   object at `actual_version`
