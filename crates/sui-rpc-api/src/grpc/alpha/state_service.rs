...
use crate::grpc::alpha::state_service_proto::{
    state_service_server::StateService, GetObjectInclusionProofRequest,
    GetObjectInclusionProofResponse, ObjectRef as ProtoObjectRef, OcsInclusionProof,
};
use crate::RpcError;
...
fn build_ocs_inclusion_proof(
    ...
    let object_pos_map: HashMap<_, _> = leaves
        .iter()
        .enumerate()
        .map(|(i, (id, _, _))| (*id, i))
        .collect();
