...
pub mod state_service_client {
    ...
    /// StateService provides access to blockchain state data.
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/sui.rpc.alpha.StateService/GetObjectInclusionProof",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "sui.rpc.alpha.StateService",
...
pub mod state_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sui.rpc.alpha.StateService/GetObjectInclusionProof" => {
                    ...
                    struct GetObjectInclusionProofSvc<T: StateService>(pub Arc<T>);
                    impl<
                        T: StateService,
                    ...
                    for GetObjectInclusionProofSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as StateService>::get_object_inclusion_proof(
                                        &inner,
                                        request,
                                    )
                                    .await
    ...
    pub const SERVICE_NAME: &str = "sui.rpc.alpha.StateService";
