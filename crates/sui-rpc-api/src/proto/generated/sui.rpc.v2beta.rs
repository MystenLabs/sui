...
pub mod info_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// Query a sui service for general information about its current state and
        /// capabilities.
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/sui.rpc.v2beta.InfoService/GetServiceInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sui.rpc.v2beta.InfoService", "GetServiceInfo"));
...
pub mod info_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sui.rpc.v2beta.InfoService/GetServiceInfo" => {
                    ...
                    struct GetServiceInfoSvc<T: InfoService>(pub Arc<T>);
                    impl<
                        T: InfoService,
                    ...
                    for GetServiceInfoSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as InfoService>::get_service_info(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "sui.rpc.v2beta.InfoService";
...
pub mod ledger_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sui.rpc.v2beta.LedgerService/BatchGetCheckpoints",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub struct TransactionExpiration {
    #[prost(oneof = "transaction_expiration::Expiration", tags = "2, 3")]
