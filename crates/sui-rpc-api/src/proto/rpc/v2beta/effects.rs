...
impl TransactionEffects {
    ...
    const STATUS_FIELD: &'static MessageField = &MessageField::new("status");
    const EPOCH_FIELD: &'static MessageField = &MessageField::new("epoch");
    const GAS_USED_FIELD: &'static MessageField = &MessageField::new("gas_used");
    const TRANSACTION_DIGEST_FIELD: &'static MessageField =
        &MessageField::new("transaction_digest");
    const GAS_OBJECT_FIELD: &'static MessageField = &MessageField::new("gas_object");
    const EVENTS_DIGEST_FIELD: &'static MessageField = &MessageField::new("events_digest");
    const DEPENDENCIES_FIELD: &'static MessageField = &MessageField::new("dependencies");
    const LAMPORT_VERSION_FIELD: &'static MessageField = &MessageField::new("lamport_version");
    const CHANGED_OBJECTS_FIELD: &'static MessageField = &MessageField::new("changed_objects");
    const UNCHANGED_SHARED_OBJECTS_FIELD: &'static MessageField =
        &MessageField::new("unchanged_shared_objects");
    const AUXILIARY_DATA_DIGEST_FIELD: &'static MessageField =
