...
To try this locally, use `RUST_LOG=consensus=off cargo run --bin sui -- start --with-faucet --with-indexer --force-regenesis`. Recommend setting `database-url` to an env variable. 
