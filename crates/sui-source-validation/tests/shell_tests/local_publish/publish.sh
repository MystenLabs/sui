...
sui client --client.config $CONFIG publish "b" -e localnet > output.log 2>&1 || cat output.log
sui client --client.config $CONFIG verify-source "b" -e localnet


sui client --client.config $CONFIG publish "a" -e localnet > output.log 2>&1 || cat output.log
