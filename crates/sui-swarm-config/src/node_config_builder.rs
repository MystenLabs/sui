...
use sui_config::node::{
    ...
    default_local_execution_time_channel_capacity, default_local_execution_time_lru_cache_size,
...
impl ValidatorConfigBuilder {
    ...
    pub fn build(
        ...
        NodeConfig {
            ...
            local_execution_time_lru_cache_size: default_local_execution_time_lru_cache_size(),
        }
    }
