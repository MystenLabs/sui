...
pub fn type_<W: fmt::Write>(
    ...
    match ty {
        ...
        TypeInput::I8 => write!(buf, "i8"),
        TypeInput::I16 => write!(buf, "i16"),
        TypeInput::I32 => write!(buf, "i32"),
        TypeInput::I64 => write!(buf, "i64"),
        TypeInput::I128 => write!(buf, "i128"),
        TypeInput::I256 => write!(buf, "i256"),
