...
impl Event {
    ...
    /// Returns a digest of the (tx_digest, position, event) tuple, where position is the index of
    /// the event in the transaction events. This ensures that the resulting digest is unique even
