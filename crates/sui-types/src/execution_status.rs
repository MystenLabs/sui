...
pub enum ExecutionFailureStatus {
    ...
    #[error("Certificate is cancelled due to congestion on objects {congested_objects}")]
    ExecutionCancelledDueToCongestionOnObjects { congested_objects: CongestedObjects },
