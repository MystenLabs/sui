...
mod tests {
    ...
    // Signed integers and vectors of them are not pure-arg-eligible entry parameters.
    // TODO (signed-ints): replace with an e2e publish once signed modules are enabled.
    #[test]
