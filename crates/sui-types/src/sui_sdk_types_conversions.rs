...
impl TryFrom<crate::crypto::PublicKey> for MultisigMemberPublicKey {
    ...
    fn try_from(value: crate::crypto::PublicKey) -> Result<Self, Self::Error> {
        match value {
            ...
            //TODO implement passkeys in sdk multisig
            crate::crypto::PublicKey::Passkey(_) => {
                return Err(SdkTypeConversionError(
                    "Passkeys in multisig has not been implemented in the sdk".to_owned(),
                ))
            }
        }
        .pipe(Ok)
...
impl TryFrom<crate::crypto::CompressedSignature> for MultisigMemberSignature {
    ...
    fn try_from(value: crate::crypto::CompressedSignature) -> Result<Self, Self::Error> {
        match value {
            ...
            //TODO implement passkeys in sdk multisig
            crate::crypto::CompressedSignature::Passkey(_) => {
                return Err(SdkTypeConversionError(
                    "Passkeys in multisig has not been implemented in the sdk".to_owned(),
                ))
            }
...
// TODO remaining set of enums to add impls for to ensure new editions are caught during review
//
...
// src/transaction/mod.rs:pub enum EndOfEpochTransactionKind {
// src/transaction/mod.rs:pub enum ConsensusDeterminedVersionAssignments {
