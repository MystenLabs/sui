    ...
    fn get_consensus_committee(&self) -> ConsensusCommittee {
        ...
        for validator in self.active_validators.iter() {
            authorities.push(Authority {
                ...
                authority_identifier: consensus_config::AuthorityIdentifier::from_bytes(
        ...
        authorities.sort_by(|a1, a2| a1.authority_identifier.cmp(&a2.authority_identifier));
        ...
        {
            if sui_authority_name.0 != mysticeti_authority.authority_identifier.to_bytes() {
                error!(
...
mod test {
    ...
    fn test_sui_and_mysticeti_committee_are_same() {
        ...
        for (authority_index, consensus_authority) in consensus_committee.authorities() {
            ...
            assert_eq!(
                consensus_authority.authority_identifier.to_bytes(),
