...
use crate::{
    ...
    SUI_RANDOMNESS_STATE_OBJECT_ID, SUI_RANDOMNESS_STATE_OBJECT_SHARED_VERSION,
...
impl CallArg {
    ...
    pub const RANDOMNESS_MUT: Self = Self::Object(ObjectArg::SharedObject {
        id: SUI_RANDOMNESS_STATE_OBJECT_ID,
        initial_shared_version: SUI_RANDOMNESS_STATE_OBJECT_SHARED_VERSION,
        mutable: true,
    });
}
