...
pub enum WithdrawFrom {
    ...
    Sponsor,
    /// Withdraw from `funder`'s balance under the given `Allowance`.
    Allowance {
        funder: SuiAddress,
        allowance: ObjectID,
    },
...
pub trait TransactionDataAPI {
    ...
    /// `WithdrawFrom::Allowance` against its loaded input object. Execution trusts the declared
    /// funder, which is immutable on the allowance. Policy checks live in Move.
