...
impl Receiving {
    pub fn new(parent_id: ObjectID, receiving_id: ObjectID, version: SequenceNumber) -> Self {
        Self {
            parent_id: ID::new(parent_id),
            receiving_id: ID::new(receiving_id),
            version,
        }
    }
    ...
    pub fn is_valid(view: &BinaryIndexedView<'_>, s: &SignatureToken) -> bool {
        use SignatureToken as S;
        match s {
            S::MutableReference(inner) | S::Reference(inner) => Self::is_valid(view, inner),
