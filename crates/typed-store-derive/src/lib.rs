        ...
        TokenStream::from(quote! {
            ...
            impl <
                ...
                pub fn open_tables_impl(
                    ...
                    // Always create invariant store with RocksDB comparison when tidehunter is configured
                    ...
                    let cf_options: Vec<_> = cf_names.iter()
                        ...
                        .collect();
                    let db = typed_store::rocks::open_tidehunter_invariant(inner_db, &rocks_path, metric_conf, &cf_options, Some(registry_id))
