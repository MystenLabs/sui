...
To instead [contribute](../contribute/index.md) to Sui itself, you may experiment with the advanced [Sui CLI client](../build/client.md) at the command line.
...
* The [Sui Wallet command line interface (CLI)](../build/client.md)
...
The above command created an object with ID `ED883F6812AF447B9B0CE220DA5EA9E0F58012FE`. Note you may use `Sui CLI client` to [view objects owned by the address](../build/client.md#view-objects-owned-by-the-address).
