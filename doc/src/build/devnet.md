...
The above command created an object with ID `ED883F6812AF447B9B0CE220DA5EA9E0F58012FE`. Note you may use `Sui CLI client` to [view objects owned by the address](https://docs.sui.io/build/wallet#view-objects-owned-by-the-address).
