...
Now that you've [learned about Sui](../learn/index.md), it's time to [install](install.md) all the required tools and start building. Start by becoming familiar with these key concepts:
