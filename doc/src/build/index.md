...
1. [Create](../build/wallet#genesis) and [Start](../build/wallet#starting-the-network) a *local Sui network*.
1. [Start](../build/rest-api#start-local-rest-server) a *local REST Gateway server*.
1. [Connect](../build/wallet#rest-gateway) to the Sui network Gateway service with the *Sui Wallet*.
