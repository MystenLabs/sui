...
genesis from `wallet.conf`. Ensure you have run [`sui_syncAccountState`](#sui_syncaccountstate)
...
Follow the instructions to [execute the transaction](json-rpc.md#3-execute-the-transaction-using-the-transaction-data-signature-and-public-key).
