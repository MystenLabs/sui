...
Note that the exact data you see will be different. The first object ID in **Created Objects** is the package object ID (`0x7a137f312bac54fbf47c5a65f89ca0d116b1ce69` in this case). And the second object ID in **Mutated Objects** is your coin object ID (`0x91dfb762ebd7acd718828d72898ab8977d75b0eb` in this case) which is owned by your account address.
...
You can also look at the detailed content of the object by adding the `--json` parameter:
