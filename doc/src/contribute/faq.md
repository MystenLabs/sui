...
3. Experiment with the [Sui CLI client](../build/client.md).
...
You may also run a local, non-networked Sui node for development using the [Sui CLI client](../build/client.md). You can interact with the nodes with either the [Sui Wallet CLI](../build/client.md#command-line-mode) or over the [Sui RPC API](../build/json-rpc.md).
