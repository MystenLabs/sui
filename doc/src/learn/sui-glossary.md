...
For more information, see [Genesis](../build/client.md#genesis).
...
[Sui CLI client](../build/client.md) command line interface. It is one of the more common of many commands
available in the CLI client.

For more information, see [Transferring objects](../build/client.md#transferring-objects).
