...
- [GraphQL RPC](./graphql-indexer.mdx) will delegate historical lookups to the Archival Service using the planned integration. It will enable cost-efficient setup of a General-purpose Indexer database with limited retention.
