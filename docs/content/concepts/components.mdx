...
1. The **consensus mechanism** used to validate transactions.

1. **Transactions** themselves, which on Sui reflect on-chain operations such as creating objects or sending tokens.

1. **Tokens** used to pay for resources and transactions on the network.

On Sui specifically, other core components include:

1. **Move**, the programming language used to create smart contracts on Sui.
...
- [Validator Committee](/concepts/consensus.mdx)
