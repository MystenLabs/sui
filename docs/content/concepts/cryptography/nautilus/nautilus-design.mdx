...
Nautilus uses cloud-based enclaves designed to protect against software-level attacks. Our focus on cloud-hosted TEEs, like AWS Nitro Enclaves, is intentional for the following reasons:
...
- **They operate under strict compliance standards**. Providers like AWS and GCP are regularly audited against frameworks like SOC 2, ISO 27001, CSA STAR etc., ensuring operational integrity.

Developers are encouraged to evaluate whether this trust model aligns with their application’s threat profile and security needs.
