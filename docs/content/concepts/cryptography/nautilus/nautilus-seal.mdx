...
description: Details on how to use Seal for secure secret loading in Nautilus enclaves
---
...
This pattern is ideal for workloads that require confidential data handling, secure AI workflows, or fine-grained access control policies enforced cryptographically.
...
You can also explore [seal-kms](https://github.com/lockin-bot/seal-kms), a minimal open-source key management service for Nautilus, built using Seal and contributed by the community.
