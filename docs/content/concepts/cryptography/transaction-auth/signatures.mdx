...
Cryptographic agility is core to Sui. The system supports multiple cryptography algorithms and primitives and can switch between them rapidly. Not only can you choose best-of-breed cryptography for the system, you can also implement the latest algorithms as they become available.
