...
- If you are seeing the Error message "Call to rapidsnark service took longer than 15s", consider increasing the timeout by setting the environment variable `PROVER_TIMEOUT` further, e.g., `PROVER_TIMEOUT=30`.
