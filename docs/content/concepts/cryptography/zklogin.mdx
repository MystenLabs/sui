...
To use zkLogin in your project, run the following command in your project root:
...
1. Register for an [Apple developer account](https://developer.apple.com/). Go to the **Certificates, Identifiers and Profiles** section.
   ...
   _This is where you can create Certificates, Identifiers and Profiles_
...
1. Create an App ID
   ...
   _This is how you can enable Sign In with Apple for your App ID_
...
1. Create a Services ID
   ...
   _This is where you Create a Services ID_
...
1. Create a new identifier and select **Services IDs** as the identifier type.
   ...
   _This is where you Set Redirect URL_
...
```typescript
import { getExtendedEphemeralPublicKey } from '@mysten/sui.js/zklogin';
...
```typescript
import { genAddressSeed, getZkLoginSignature } from '@mysten/sui.js/zklogin';
