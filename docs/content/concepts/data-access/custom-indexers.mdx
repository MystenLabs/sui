...
Use custom indexers when your application's data needs cannot be fulfilled with managed services from RPC providers, or if the [General-Purpose Indexer](/concepts/data-access/graphql-rpc-gp-indexer.mdx) is too complex for your use case. Custom indexers are a good choice for app-specific or protocol-specific logic and data layout.
...
<RelatedLink to="/guides/developer/accessing-data/custom-indexer/pipeline-architecture.mdx" />
