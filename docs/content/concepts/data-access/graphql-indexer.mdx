...
- **GraphQL service:** Serves structured queries over indexed data. It follows the [GraphQL specification](https://graphql.org/) and the supported schema is documented in the [GraphQL API reference](/references/sui-graphql). Refer to the [GraphQL getting started guide](/guides/developer/advanced/graphql-rpc.mdx).
