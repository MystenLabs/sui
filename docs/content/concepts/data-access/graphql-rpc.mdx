...
description: Core concepts for using GraphQL to query Sui RPC, including headers, variables, fragments, pagination, scope, and service limits.
keywords: [ graphql, graphql headers, x-sui-rpc-version, x-sui-rpc-show-usage, variables, fragments, pagination, graphql limits, scope, checkpoint scope, root version scope ]
---
...
For more examples of scope usage, see [Querying Sui RPC with GraphQL](/guides/developer/accessing-data/query-with-graphql.mdx).
