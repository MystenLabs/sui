...
{@inject:  ../../../crates/sui-framework/packages/sui-framework/sources/dynamic_field.move#fun=borrow noComments}

{@inject:  ../../../crates/sui-framework/packages/sui-framework/sources/dynamic_field.move#fun=borrow_mut noComments}
