...
<TabItem label="zkLogin" value="zklogin" >

Most players are familiar with using some sort of single sign-on (SSO) or social login to create their game accounts. On Sui, you can leverage [zkLogin](https://www.sui.io/zklogin) to simplify player account creation through a Web2-like onboarding process, removing the friction of wallet setup.
