...
Many players use single sign-on (SSO) or social login to create game accounts. [zkLogin](https://www.sui.io/zklogin) enables blockchain account creation through familiar authentication flows, reducing the complexity of traditional wallet setup processes.
