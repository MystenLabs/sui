...
The sections that follow detail some select gaming integrations on the Sui platform and the features leveraged to provide the desired gaming experience.

- [ShadowQuest](#shadowquest)
- [Sui for Speed](#sui-for-speed)
- [ArcaneBattles](#arcanebattles)

## ShadowQuest integration on Sui {#shadowquest}
...
ShadowQuest uses NFTs as entry tickets for different game modes and events. Players can acquire or earn various Runes, which grant access to specific game challenges or seasonal competitions. These NFTs cannot be traded or transfered to other players.
...
## Sui for Speed integration on Sui {#sui-for-speed}
...
## ArcaneBattles integration {#arcanebattles}
...
- [Coin Standard](../standards/coin.mdx)
- [Create Coins and Tokens](../guides/developer/coin.mdx)
- [Create a Non-Fungible Token](../guides/developer/nft.mdx) 
- [Asset Tokenization](../guides/developer/nft/asset-tokenization.mdx)
- [NFT Rental Example](../guides/developer/nft/nft-rental.mdx)
- [Kiosk](../standards/kiosk.mdx)
- [Kiosk Apps](../standards/kiosk-apps.mdx)
- [zkLogin](../concepts/cryptography/zklogin.mdx)
- [Enoki](https://docs.enoki.mystenlabs.com/): Enoki empowers builders with the ability to exploit blockchain superpowers with the ease and convenience we are all familiar with in Web 2.0.
...
- Guides for example games
    - [Coin Flip](../guides/developer/app-examples/coin-flip.mdx)
    - [Blackjack](../guides/developer/app-examples/blackjack.mdx)
    - [Plinko](../guides/developer/app-examples/plinko.mdx)
