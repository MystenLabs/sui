...
Sui operates an instance of GraphQL Beta and the associated upstream components. Functionality prioritization is guided by builder adoption feedback focused on:
...
-	Infrastructure provisioning advice and cost estimates, based on Sui partner deployments.
...
Sui is evaluating sustainable paths for ongoing access, including:

-	Partnerships with external RPC providers.
-	Self-hosting support for builders.
-	Paid access to Sui-operated services.
