...
- `pageInfo`, of type <a href="/references/sui-api/sui-graphql/beta/reference/types/objects/page-info" data-noBrokenLinkCheck='true'>PageInfo</a>, which indicates whether there are more pages before or after the page returned.
