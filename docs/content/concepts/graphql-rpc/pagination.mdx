...
The results are the first and last checkpoint for which pagination will continue to work and produce a consitent result. At the time of writing the available range offers a 5 to 15 minute buffer period to finish pagination in.
