...
Zooming in, every transaction is sequenced by consensus, where validators agree to the same order of execution of the transactions, even if a minority of them are down or want to cause disruptions!
Sui currently uses Narwhal and Bullshark for consensus. They will soon be upgraded to Mysticeti.
