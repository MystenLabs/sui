...
In a simplified view, epochs are to the Sui network what individual days are to a calendar. Reconfiguration, then, is a process at the end of each epoch where that day's activity is tallied and the next day's parameters are set. The reconfiguration process is similar to how you can make ATM withdrawals throughout the day but the bank doesn't officially change your balance until the end of the day.  
