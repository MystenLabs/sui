...
1. A Sui developer codes the new feature, but restricts access to the feature using a feature flag. A feature flag is a boolean config variable that is initially set to false.
