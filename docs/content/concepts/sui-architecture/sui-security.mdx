...
Because all transactions are public, privacy-conscious users may use multiple addresses or custodial and non-custodial services. Smart contracts can also add cryptographic privacy protections.  
