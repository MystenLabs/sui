...
The biggest difference between Sui and Solana development lies in the programming language. Sui uses [**Move**](/concepts/sui-move-concepts.mdx), while Solana relies on **Rust**, typically paired with a development framework that simplifies app development and management. **Anchor** is the most popular Solana framework.
