...
See [Address](https://move-book.com/reference/primitive-types/address.html) in The Move Book for an overview on addresses and refer to <UnsafeLink href="/references/framework/sui-framework/object">object.move</UnsafeLink> in the Sui Framework for implementation details.
