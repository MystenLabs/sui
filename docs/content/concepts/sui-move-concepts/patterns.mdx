...
A witness is a pattern you use to confirm the ownership of a type. A one-time witness (OTW) is a special instance of a type created in the module initializer and guaranteed to be unique with only one instance. See the following topics for details.
