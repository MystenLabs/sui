...
The Sui repository includes [several examples](https://github.com/MystenLabs/sui/tree/main/examples/move) that demonstrate Sui capabilities. The following [Flash Loan](https://github.com/MystenLabs/sui/blob/main//examples/move/flash_lender/sources/example.move) code from the set of examples demonstrates the pattern this topic describes:
