...
1. You can stake SUI to participate in the proof-of-stake mechanism.
...
1. You can use SUI as a versatile and liquid asset for various applications.
...
1. The storage fund is funded by past transactions and functions as a tool for shifting gas fees across different epochs. This ensures that future validators are compensated for their storage costs by the past users who created those storage requirements in the first place.
