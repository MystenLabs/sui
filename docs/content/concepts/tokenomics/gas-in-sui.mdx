...
Using coarse bucketing accomplishes two important goals:
    ...
    - Frees you from optimizing your smart contracts to deliver marginal gains in gas costs via_gas golfing_. Instead, you can focus on step-function improvements in your products and services.
