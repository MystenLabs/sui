---
title: Gas in Sui
description: A Sui transaction pays for computation and storage. Learn how gas fees, units, rebates, and budgets work.
---

In the Sui network, every transaction incurs gas fees to cover:
...
Simple tx, 10 bytes storage | 1,000 | 1,000 | 75 | 1,000 | 0 | 1.075M | 1.075M
