...
- **Gas input**: A reference pointing to the object used to pay for the transaction's execution and storage. This object must be owned by the sender address and must be of type `sui::coin::Coin<SUI>`.
