...
Gas smashing happens automatically when you provide multiple coins to cover gas fees. During execution, Sui combines all provided gas coins into a single coin, regardless of their amounts or the specified gas budget (as long as the budget is within the allowed range).  
