...
goal:
  description: >-
    Reader can query historical Sui network data through the Archival Service
    gRPC API
  requires:
    - has_frontmatter:
        - title
...
questions:
  - How do I query historical data with archival service?
  - How do I query the service?
  - How do I run your own instance?
  - What is Querying Historical Data with Archival Service in Sui?
answer: Query historical Sui network data through the Archival Service gRPC API.
---
