...
description: >-
  The historical data API for fast lookups, served from a scalable and
  performant historical data store.
keywords:
  - archival store
  - archival service
  - historical data
...
goal:
  description: >-
    Reader understands the historical data API for fast lookups, served from a
    scalable and performant historical data store
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: When to use
        - pattern: 'How the Archival Store and Service fits '
