...
- [Custom indexers](/develop/accessing-data/custom-indexer/custom-indexers): [Build your own pipelines](/develop/accessing-data/custom-indexer/build) for application-specific data with the custom indexing framework. PostgreSQL is the built-in/default storage path, but custom indexers can write to any storage layer by implementing the framework storage traits.
...
<iframe
	width="560"
	height="315"
	src="https://www.youtube.com/embed/CL7H4QQSWd0?si=Mt2xo3HNfm2mbRtE"
