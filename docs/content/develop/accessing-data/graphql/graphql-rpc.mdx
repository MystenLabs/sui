...
description: Learn the core concepts for working with GraphQL on Sui RPC, including request headers, query composition with variables and fragments, pagination strategies, query scope, service limits, and the components of the GraphQL and General-purpose Indexer stack.
keywords:
  - graphql
  - graphql headers
  - x-sui-rpc-version
...
answer: Use GraphQL to make Sui RPC calls.
---
