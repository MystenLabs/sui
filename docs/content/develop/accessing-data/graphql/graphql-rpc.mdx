...
GraphQL RPC Server and the General-purpose Indexer are generally available. JSON-RPC is deprecated and was disabled on Sui Foundation Mainnet full nodes the week of July 27, 2026. Full decommission is planned for mid-October 2026. See the [JSON-RPC Migration Guide](/develop/accessing-data/json-rpc-migration) for the complete timeline.
