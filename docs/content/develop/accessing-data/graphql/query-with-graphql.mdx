...
description: >-
  Practical guide to making queries of the Sui RPC using the GraphQL service,
  with examples for common tasks.
keywords: - rpc, graphql
  - sui rpc
  - graphql
  - query transactions
  - query blocks
...
goal:
  description: >-
    Reader understands practical guide to making queries of the Sui RPC using
    the GraphQL service, with examples for common tasks
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  ...
  - path_id: walrus-agentic
    ...
    stage: Ship
questions:
  - How do I query data with graphql rpc?
  - What is Querying Data with GraphQL RPC in Sui?
  - Where can I find querying data with graphql rpc examples?
answer: >-
  Practical guide to making queries of the Sui RPC using the GraphQL service,
  with examples for common tasks.
---
