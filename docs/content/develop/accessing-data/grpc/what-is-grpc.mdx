...
gRPC polling and streaming APIs are generally available. JSON-RPC is deprecated and was disabled on Sui Foundation Mainnet full nodes the week of July 27, 2026. Full decommission, including code removal, is planned for mid-October 2026. For decision criteria, a JSON-RPC method mapping, the full timeline, and common migration gotchas, see the [JSON-RPC Migration Guide](/develop/accessing-data/json-rpc-migration).
