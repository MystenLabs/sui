...
description: Learn how to choose the right data access method in Sui — GraphQL RPC, gRPC, custom indexers, or the Archival Store — based on latency, throughput, and historical depth requirements.
keywords:
  - data types
  - data access
