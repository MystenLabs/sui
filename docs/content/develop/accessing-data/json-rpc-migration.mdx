...
| --- | --- | --- |
| `sui_getCheckpoint`, `sui_getLatestCheckpointSequenceNumber` | `LedgerService.GetCheckpoint` | `checkpoint` |
| `sui_getCheckpoints` | No paginated gRPC list. Use `LedgerService.GetCheckpoint` for point lookups, or `SubscriptionService.SubscribeCheckpoints` for an ordered stream, depending on your use case. | `checkpoints` |
| `sui_getTransactionBlock` | `LedgerService.GetTransaction` | `transaction` |
| `sui_multiGetTransactionBlocks` | `LedgerService.BatchGetTransactions` | `multiGetTransactions` |
...
| `sui_getObject`, `sui_tryGetPastObject` | `LedgerService.GetObject` (current state and recent history) | `object` |
| `sui_multiGetObjects` | `LedgerService.BatchGetObjects` | `multiGetObjects` |
