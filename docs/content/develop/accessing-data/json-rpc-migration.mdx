...
| `suix_getValidatorsApy` | No direct gRPC method and no APY field. Read validator-set data and compute APY client-side. | No direct APY field. Read validator-set data through `Epoch.validatorSet` and compute APY client-side. |
