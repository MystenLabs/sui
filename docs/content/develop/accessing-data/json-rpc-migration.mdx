...
JSON-RPC is deprecated and is being decommissioned on the following timeline. The Mainnet shutoff has already taken effect, so the remaining milestones remove the infrastructure behind it:
