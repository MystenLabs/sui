...
description: >-
  Learn how to define Move event structs, emit events from smart contracts, and
  process or query them using gRPC, the TypeScript SDK, or a custom indexer.
keywords:
  - using events
  - notify events
  - notify assets
...
:::info
The legacy `sui_sdk::SuiClientBuilder` JSON-RPC client has been removed. Use `sui-rust-sdk` instead.
:::
