...
keywords: [passkey, WebAuthn, authentication, cryptography, multisig, biometric]
goal:
  description: >-
    Reader understands sui supports the passkey signature scheme that enables
    you to sign in to apps and sign transactions using a private key stored
    securely on a passkey authenticator
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Benefits of using passkey
        - pattern: Limitations of passkey
