...
description: Orient yourself to Sui package management: resolving dependencies, managing package addresses across networks, verifying deployed packages, and understanding UpgradeCap security considerations.
keywords:
  - package management
  - Move packages
  - publishing
