...
goal:
  description: >-
    ...
    Transfer-to-Object capabilities, guaranteed uniqueness, and native
    parallelization for building scalable composable systems on Sui
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        ...
        - pattern: Derived objects and dynamic fields
        - pattern: '`derived_object`'
