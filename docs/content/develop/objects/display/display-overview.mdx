...
description: >-
  Object Display is a way to render any object on Sui using templating syntax.
  The current standard, Display V2, uses a registry-backed model with richer
  templating, dynamic field access, and GraphQL support, replacing the legacy V1
  event-discovery model.
keywords:
  - Object Display
  - object
  - display
...
goal:
  description: >-
    Reader understands object Display is a way to render any object on Sui using
    templating syntax
  requires:
    - has_frontmatter:
        - title
...
questions:
  ...
  - Why should I use object display?
answer: >-
  Object Display is a way to render any object on Sui using templating syntax.
  It renders Sui Move object values into human-readable strings, JSON, or
