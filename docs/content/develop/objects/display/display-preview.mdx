...
description: >-
  Learn how Object Display V2 templates work, including field-reference syntax
  and common properties like name, image_url, and link, then try them live in
  the interactive preview tool.
keywords:
  - Object Display
  - object
  - display
