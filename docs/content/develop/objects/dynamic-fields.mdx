...
<ImportContent
	source="crates/sui-framework/packages/sui-framework/sources/dynamic_field.move"
	mode="code"
	fun="add"
	noComments
/>
...
<ImportContent
	source="crates/sui-framework/packages/sui-framework/sources/dynamic_object_field.move"
	mode="code"
	fun="add"
	noComments
/>
...
<ImportContent
	source="examples/move/dynamic_fields/sources/example.move"
	mode="code"
	struct="Parent"
	noComments
/>
