...
keywords:
  ...
  - address ownership
goal:
  description: Reader understands address-owned objects are owned by a Sui 32-byte address
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  ...
  - path_id: walrus-agentic
    ...
    stage: Environment
questions:
  - What is Address-Owned Objects in Sui?
  - How does address-owned objects work on Sui?
  - How do I create address-owned objects?
  - How do I test address-owned objects?
answer: >-
  Address-owned objects are owned by a Sui 32-byte address, which can either be
  an account address or an object ID. Learn how to create and access these
  objects.
