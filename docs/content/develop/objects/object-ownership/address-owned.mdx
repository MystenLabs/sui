...
description: >-
  Address-owned objects are owned by a Sui 32-byte address, which can either be
  an account address or an object ID. Learn how to create and access these
  objects.
keywords:
...
goal:
  description: >-
    Reader can address-owned objects are owned by a Sui 32-byte address, which
    can either be an account address or an object ID. Learn how to create and
  ...
  requires:
    ...
    - headings:
        - pattern: Create address-owned objects
        - pattern: When to use address-owned objects
        - pattern: Interact with address-owned objects
