...
goal:
  description: >-
    ...
    deleted. Immutable objects cannot have an owner and anyone can use them
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Create immutable objects
        - pattern: When to use immutable objects
        - pattern: Interact with immutable objects
