...
builder_paths:
  - path_id: agentic-payments
    ...
    stage: Environment
questions:
  - What is Immutable Objects in Sui?
  - How do I create immutable objects?
  - When to use immutable objects?
  - How do I test immutable objects?
answer: >-
  Objects on Sui can either be immutable or mutable. An immutable object cannot
...
The function fails because the `ColorObject` parameter is passed by immutable reference (`&ColorObject`) rather than mutable reference (`&mut ColorObject`).
