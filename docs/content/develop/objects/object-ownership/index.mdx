...
description: Compare the five Sui object ownership types — address-owned, shared, immutable, wrapped, and consensus-address owned (party) — and learn how each affects transaction access, versioning path, and latency.
keywords:
  - object model
  - objects on sui
  - sui move package
