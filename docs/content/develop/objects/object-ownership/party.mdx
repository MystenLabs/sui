...
description: >-
  ...
  versioned by consensus. Learn how to create and access these objects.
keywords: [party objects, consensus, object ownership, transfer, shared objects]
goal:
  description: >-
    Reader understands party objects are owned by a specified party at the time
    of transfer and versioned by consensus. Learn how to create and access these
    objects
  requires:
    - has_frontmatter:
        - title
    ...
    - headings:
        - pattern: Create party objects
        - pattern: When to use party objects
