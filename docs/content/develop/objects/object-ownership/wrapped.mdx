...
description: >-
  Wrapped objects are object data structures nested inside of another object
  data structure. Objects can be wrapped directly, through `Option`, or through
  `vector` fields.
keywords:
  - wrapped objects
  - wrapping objects
...
goal:
  description: >-
    Reader understands wrapped objects are object data structures nested inside
    of another object data structure
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  ...
  - path_id: walrus-agentic
    ...
    stage: Environment
questions:
  - What is Wrapped Objects in Sui?
  - How does wrapped objects work on Sui?
  - Why should I use wrapped objects?
answer: >-
  Wrapped objects are object data structures nested inside of another object
  data structure. Objects can be wrapped directly, through `Option`, or through
  `vector` fields.
