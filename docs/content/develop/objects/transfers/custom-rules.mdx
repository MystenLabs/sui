...
goal:
  description: >-
    Reader understands custom transfer rules enable you to define a set of rules
    that must be met before Sui considers a transfer operation valid
  requires:
    - has_frontmatter:
        - title
        - description
