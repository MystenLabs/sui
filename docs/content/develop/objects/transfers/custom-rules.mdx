...
description: >-
  ...
  before Sui considers a transfer operation valid.
keywords:
...
goal:
  description: >-
    Reader can define custom transfer rules that must be satisfied before Sui
...
questions:
  - What is Custom Object Transfer Rules in Sui?
  - How does custom object transfer rules work on Sui?
answer: >-
  Custom transfer rules enable you to define a set of rules that must be met
  before Sui considers a transfer operation valid.
---
