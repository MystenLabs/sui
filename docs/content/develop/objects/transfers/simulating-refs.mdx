...
description: >-
  Use the borrow module in the Sui framework to include objects by reference in
...
goal:
  description: >-
    Reader can use the borrow module in the Sui framework to include objects by
...
questions:
  - What is Simulating References in Sui?
  - How does simulating references work on Sui?
...
const assetManager = tx.object(assetManagerId);
// retrieve the asset
const [asset, borrow] = tx.moveCall({
