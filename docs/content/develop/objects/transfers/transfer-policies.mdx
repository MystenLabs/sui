...
keywords:
  ...
  - transferrequest
goal:
  description: Reader can learn about transfer policies on Sui
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  - path_id: agentic-payments
    ...
    step: Transfer policies
    stage: Authorization
questions:
  - What are object transfer policies on Sui?
  - How do I add rules to a TransferPolicy?
  - How do TransferRequest receipts satisfy transfer policy rules?
answer: >-
  Learn how TransferPolicy rules and TransferRequest receipts control object
  transfers on Sui.
---
