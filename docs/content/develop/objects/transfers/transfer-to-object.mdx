...
description: >-
  On Sui, you can transfer objects to objects in the same way you can transfer
...
goal:
  description: >-
    Reader understands on Sui, you can transfer objects to objects in the same
...
questions:
  ...
  - What is Transfer to Object in Sui?
...
Make sure that the object ID exists that you are transferring the object to. Additionally, confirm that the object that you are transferring to is mutable. You can't access an object transferred to an immutable object.
