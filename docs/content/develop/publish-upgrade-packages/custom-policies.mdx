...
goal:
  description: >-
    ...
    while addressing the security risks of single key ownership upgrades
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: 'Compatibility \{#compatibility\}'
        - pattern: 'Upgrade overview \{#upgrade-overview\}'
        - pattern: '`UpgradeCap` \{#upgradecap\}'
