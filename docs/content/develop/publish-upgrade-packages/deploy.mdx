...
description: >-
  Compile and publish a Move package to a Sui network using the Sui CLI,
  estimate gas costs with a dry run, verify onchain bytecode, and serialize
  publish transactions for multisig signing.
keywords:
  - move packages
  - move
  - packages
