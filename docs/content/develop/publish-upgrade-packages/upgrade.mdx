...
description: >-
  Upgrade a published Move package on Sui using the Sui CLI, understand
  layout-compatibility requirements, manage UpgradeCap and UpgradeTicket, and
  apply custom upgrade policies to control what changes are permitted.
keywords:
  - upgrading packages
...
goal:
  description: >-
    Reader understands sui provides a method of upgrading your packages while
...
questions:
  ...
  - How do I upgrade?
  - What is Upgrading Packages in Sui?
answer: >-
  Sui provides a method of upgrading your packages while still retaining their
