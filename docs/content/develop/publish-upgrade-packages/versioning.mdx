...
description: Understand how Sui assigns and increments package versions on publish and upgrade, how framework packages preserve their IDs across upgrades, and what package manifest version fields actually control.
keywords:
  - package versioning
  - package versions
  - versioning packages
