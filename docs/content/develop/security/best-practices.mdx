...
For implementation patterns and code examples, see the [Access control](/develop/write-move/move-best-practices) section of the Move best practices guide and the [capability pattern example app](https://github.com/MystenLabs/sui-move-bootcamp/tree/solution/C1/capability).
...
No other party can operate on your owned assets without your private signature key. However, if your key is compromised, an attacker can operate on your assets, which is why key management practices like multisig, hardware wallets, and key rotation are essential.
