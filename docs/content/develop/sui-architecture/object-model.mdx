...
title: Object Model
description: >-
  Everything on the Sui blockchain is an object that has metadata, a type of
...
goal:
  description: >-
    Reader understands everything on the Sui blockchain is an object that has
...
Every object has an owner field that dictates who can use it in transactions, except for immutable objects which have no owner. This field can contain one of the following options:
