...
description: >-
  The Sui protocol, framework, and execution engine are frequently extended to
...
goal:
  description: >-
    Reader understands the Sui protocol, framework, and execution engine are
    frequently extended to include new functionality and bug fixes
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Protocol upgrade process
        - pattern: Framework upgrades
