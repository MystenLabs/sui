...
title: Security
description: >-
  Assets on Sui, including coins and tokens, are types of objects, and can only
...
goal:
  description: >-
    Reader understands assets on Sui, including coins and tokens, are types of
    objects, and can only be used by their owners unless otherwise defined
    according to predefined logic in a smart contract
  requires:
    - has_frontmatter:
        - title
        - description
