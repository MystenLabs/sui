...
title: Storage
description: >-
  An overview of Sui's storage architecture, including validator and full node
  storage requirements, pruning, snapshots, checkpoints, and how storage fees
...
goal:
  description: >-
    ...
    the cost of operations on the Sui network
  requires:
    - has_frontmatter:
        - title
        - description
