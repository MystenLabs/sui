...
Indicates that another inflight transaction is already using an object version your transaction also needs. Modern transaction submission rejects these conflicts instead of leaving objects locked until the next epoch.
