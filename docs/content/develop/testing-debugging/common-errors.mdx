...
goal:
  description: >-
    Reader can identify common Sui errors by their message and apply the
    documented fix
  requires:
    - has_frontmatter:
        - title
...
questions:
  - What is Troubleshooting Common Errors in Sui?
  - How do I address errors?
  - How does troubleshooting common errors work on Sui?
answer: >-
  Find solutions to common issues with addresses, transactions, and Move
  packages.
---
...
Verify that your source files do not use the same module name and address combination twice. Check your package's dependencies to see if there is a duplicate name defined. Check if you have a conflicting address assignment in the `Move.toml` file. 
