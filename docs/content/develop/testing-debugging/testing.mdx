...
For a complete walkthrough with access control, cross-module interactions, and transaction effects inspection, see the [scenario testing example app](https://github.com/MystenLabs/sui-move-bootcamp/tree/solution/G1/scenario).
