...
title: Gas Smashing
description: >-
  Gas smashing lets you pay transaction fees using multiple coins, which Sui
  combines into a single coin. Learn how gas smashing works, its interaction
  with address balance gas payment, and how to use it with programmable
  transaction blocks.
keywords:
  - gas smashing
  - smash gas
...
builder_paths:
  ...
  - path_id: agentic-payments
    ...
    stage: Authorization
questions:
  - What is Gas Smashing in Sui?
  - How does gas smashing work on Sui?
