...
The stablecoins eligible for gasless stablecoin transfers are governed by the protocol configuration (`get_gasless_allowed_token_types` in `sui-types`) and can change across protocol versions. To see the current allowlist, please see [here](https://github.com/MystenLabs/sui/pull/26417/changes). 
