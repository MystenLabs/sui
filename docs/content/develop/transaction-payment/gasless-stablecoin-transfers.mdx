...
description: >-
  Gasless stablecoin transfers on Sui enable peer-to-peer payments of qualified
  stablecoins to execute without paying gas fees in SUI.
keywords:
  - usdc
  - stablecoins
  - sui dollar
...
goal:
  description: >-
    Reader understands gasless stablecoin transfers on Sui enable peer-to-peer
    payments of qualified stablecoins to execute without paying gas fees in SUI
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Eligible stablecoins
        - pattern: 'What gasless stablecoin transfers don''t '
        - pattern: Monitoring gasless stablecoin transfers
