...
goal:
  description: >-
    ...
    transactions writing to a single shared object
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  - path_id: p2p-payments
    ...
    stage: Gas
questions:
  - What is Object-Based Local Fee Markets in Sui?
  - How does object-based local fee markets work on Sui?
  - How do I subscribe to object-based local fee markets events?
answer: >-
  Object-based local fee markets limit the rate of transactions writing to a
  single shared object, preventing the network from becoming overloaded with
  checkpoints that take too long to execute.
