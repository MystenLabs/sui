...
You can use a sponsor proposed transaction to propose rewards claims, promotional offers, or to incentivize specific user actions without requiring the user to pay for gas fees.
