...
description: >-
  ...
  reducing onboarding friction for users who don't own SUI.
keywords:
...
builder_paths_source:
  ...
  snapshot: '2026-07-10'
questions:
  - What is Sponsored Transactions in Sui?
  - How do I create sponsored transactions using a gasdata object?
  - How does sponsored transactions work on Sui?
answer: >-
  A transaction on Sui requires a gas payment to execute. The payment is a list
  of `0x2::coin::Coin<0x2::sui::SUI>` objects.
---
...
You can use a sponsor proposed transaction to propose transactions (such as rewards claims or promotional offers) and incentivize specific user actions without requiring the user to pay for gas fees.
