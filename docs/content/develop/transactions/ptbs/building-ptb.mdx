...
goal:
  description: >-
    Reader understands using the Sui TypeScript SDK, you can create programmable
    transaction blocks to perform multiple commands in a single transaction
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Build PTBs with the CLI
        - pattern: Constructing inputs
        - pattern: Passing transaction results as arguments
