...
description: >-
  ...
  the Sui TypeScript SDK, with separate backend keypair and frontend wallet
  examples.
keywords:
  - typescript sdk
  - ptb
  ...
  - sui dapp kit
questions:
  - What is TypeScript SDK PTB Template in Sui?
  - How does typescript sdk ptb template work on Sui?
