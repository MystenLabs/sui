...
Sui has migrated data access from JSON-RPC to gRPC and GraphQL RPC. JSON-RPC was disabled on Sui Foundation Mainnet full nodes the week of July 27, 2026. The public full-node gRPC API does not include soft bundle execution. See [Sui and Community SDKs](/references/sui-sdks) for current SDK support.
