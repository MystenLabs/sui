...
Sui is migrating data access from JSON-RPC to gRPC and GraphQL RPC, with JSON-RPC disabled on Sui Foundation mainnet full nodes the week of August 27, 2026. The public full-node gRPC API does not include soft bundle execution. See [Sui and Community SDKs](/references/sui-sdks) for current SDK support.
