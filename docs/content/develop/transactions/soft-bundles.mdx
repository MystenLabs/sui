...
Sui has migrated data access from JSON-RPC to gRPC and GraphQL RPC. Sui Foundation disabled JSON-RPC on Mainnet full nodes the week of July 27, 2026. The public full-node gRPC API does not include soft bundle execution. See [Sui and Community SDKs](/references/sui-sdks) for current SDK support.
