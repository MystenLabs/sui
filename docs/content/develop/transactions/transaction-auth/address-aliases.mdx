...
description: >-
  ...
  sign transactions for a particular address on the Sui network.
keywords:
  - address aliases
  - aliases
  - key rotation
...
goal:
  description: >-
    Reader can address aliases can be used to configure the set of keys that are
    allowed to sign transactions for a particular address on the Sui network
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: How aliases work
        - pattern: Managing aliases with the Sui CLI
