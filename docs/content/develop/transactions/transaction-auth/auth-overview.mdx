...
For the full set of `Signer` implementations the TypeScript SDK ships, including cloud KMS, Ledger hardware wallets, Web Crypto, and the built-in passkey, multisig, and zkLogin signers, see [Signers](https://sdk.mystenlabs.com/sui/cryptography/signers) in the SDK reference.
