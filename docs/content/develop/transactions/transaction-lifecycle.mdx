...
goal:
  description: >-
    Reader understands the life of a transaction on the Sui network has some
    differences compared to those from other blockchains
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Transaction creation
        - pattern: Transaction submission
        - pattern: Transaction voting and sequencing in con
