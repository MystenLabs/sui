...
description: >-
  The life of a transaction on the Sui network has some differences compared to
...
goal:
  description: >-
    Reader understands each stage of a transaction's lifecycle on Sui, from
...
builder_paths:
  ...
  - path_id: walrus-agentic
    ...
    stage: Ship
questions:
  - What is Life of a Transaction in Sui?
  - How does life of a transaction work on Sui?
  - Why should I use life of a transaction?
answer: >-
  At a high level, the following diagram outlines the life cycle of a
  transaction on the Sui blockchain. All transactions are sequenced by Sui's
  [Mysticeti DAG consensus](/develop/sui-architecture/consensus).
---
