...
description: >-
  Sui has two types of transactions, programmable transaction blocks and system
  transactions.
keywords:
  - ptbs
  - system transactions
...
goal:
  description: >-
    Reader understands sui has two types of transactions, programmable
  ...
  requires:
    ...
    - headings:
        - pattern: Transaction metadata
        - pattern: Example of a transaction flow
        - pattern: Anatomy of a transaction response
