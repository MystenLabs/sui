...
The generated `Move.toml` is all you need to get started:
...
The `edition = "2024"` line tells the CLI to resolve the Sui framework dependency automatically. You do not need a `[dependencies]` section for the Sui framework, and you do not need an `[addresses]` section.
...
The subtopics in this section cover everything you need to write Move packages on Sui, including the object model, abilities and type system, package structure, testing, and upgrade patterns.
