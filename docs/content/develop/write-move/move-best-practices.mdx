...
description: Recommended Move best practices for Sui development.
keywords:
  - Move best practices
  - Sui conventions
...
goal:
  description: Reader understands recommended Move best practices for Sui development
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Move Best Practices in Sui?
  - How does move best practices work on Sui?
answer: Recommended Move best practices for Sui development.
---
