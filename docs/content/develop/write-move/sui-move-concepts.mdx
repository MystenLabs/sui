...
See the [address section](https://move-book.com/reference/primitive-types/address) in The Move Book for an overview on addresses and refer to <UnsafeLink href="/references/framework/sui-framework/sui_sui/object">object.move</UnsafeLink> in the Sui framework for implementation details.
