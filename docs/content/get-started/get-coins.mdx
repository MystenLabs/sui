---
title: Get SUI for Testing
description: Use a network faucet to get SUI Devnet, Testnet, or Localnet test coins for development. 
---
...
If you are running a local Sui network, you can get tokens from your local faucet. See the [Connect to a Local Network](./connect.mdx#use-the-local-faucet) topic for details.
