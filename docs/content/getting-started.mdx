...
description: >-
  The Sui documentation home: start with agent skills, the MCP server, or the
  Hello World example; explore example apps, Move fundamentals, developer tools,
  SDKs, and migration guides from Ethereum or Solana.
keywords:
  - Sui getting started
  - Hello World
  - Sui examples
...
goal:
  description: >-
    Reader can pick a starting point for building on Sui — an agent skill, the
    Hello, World! example, or another example app
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Getting Started in Sui?
  - What topics does Getting Started cover?
  - How does getting started work on Sui?
answer: >-
  Sui delivers the full stack for a new global economy. Assets, data, and
  permissions can be owned, programmed, and verified.
---
