...
<ImportContent source="C1/capability/sources/hero.move" mode="code" org="MystenLabs" repo="sui-move-bootcamp" ref="solution" struct="AdminCap" />
...
<ImportContent source="C1/capability/sources/hero.move" mode="code" org="MystenLabs" repo="sui-move-bootcamp" ref="solution" fun="init" />
...
<ImportContent source="C1/capability/sources/hero.move" mode="code" org="MystenLabs" repo="sui-move-bootcamp" ref="solution" fun="create_hero" />
...
<ImportContent source="C1/capability/sources/hero.move" mode="code" org="MystenLabs" repo="sui-move-bootcamp" ref="solution" fun="new_admin" />
