...
description: >-
  ...
  contract, queries owned objects, and refreshes the UI automatically using Sui
...
goal:
  description: >-
    ...
    through a Move contract, queries owned objects, and refreshes the UI
    automatically using Sui dApp Kit and React Query
  requires:
    - headings:
