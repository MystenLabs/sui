...
- Create a starter template for any Sui dApp frontend that you can extend with your own contract calls.
...
<ImportContent source="E2/my-first-sui-dapp/src/dapp-kit.ts" mode="code" org="MystenLabs" repo="sui-move-bootcamp" ref="solution" />
...
<ImportContent source="E2/my-first-sui-dapp/src/components/ui/MintNFTForm.tsx" mode="code" org="MystenLabs" repo="sui-move-bootcamp" ref="solution" fun="MintNFTForm" />
...
<ImportContent source="E2/my-first-sui-dapp/src/OwnedObjects.tsx" mode="code" org="MystenLabs" repo="sui-move-bootcamp" ref="solution" fun="OwnedObjects" />
...
<ImportContent source="E2/my-first-sui-dapp/src/main.tsx" mode="code" org="MystenLabs" repo="sui-move-bootcamp" ref="solution" />
