...
description: >-
  Create deterministic Sui objects whose IDs you can predict offchain before the
  objects exist, using four derivation strategies in Move and the TypeScript
  SDK.
keywords:
  - example
  - derived-objects
...
goal:
  description: >-
    Reader can create deterministic Sui objects whose IDs you can predict
    offchain before the objects exist
  requires:
    - headings:
...
questions:
  - How do I create objects with predictable IDs on Sui?
  - What are the four derivation strategies for Sui objects?
  - How do I predict an object ID offchain before it exists?
answer: >-
  Create deterministic Sui objects whose IDs you can predict offchain before the
  objects exist, using four derivation strategies in Move and the TypeScript
  SDK.
