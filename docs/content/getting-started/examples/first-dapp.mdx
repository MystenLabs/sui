...
<ImportContent source="F1/move/hero/sources/hero.move" mode="code" org="MystenLabs" repo="sui-move-bootcamp" ref="solution" struct="Hero" />
...
<ImportContent source="F1/move/hero/sources/hero.move" mode="code" org="MystenLabs" repo="sui-move-bootcamp" ref="solution" fun="equip_weapon" />
...
<ImportContent source="F1/move/hero/sources/hero.move" mode="code" org="MystenLabs" repo="sui-move-bootcamp" ref="solution" fun="new_hero" />
...
<ImportContent source="F1/app/my-first-sui-dapp/src/components/ui/CreateHeroForm.tsx" mode="code" org="MystenLabs" repo="sui-move-bootcamp" ref="solution" fun="CreateHeroForm" />
...
<ImportContent source="F1/app/my-first-sui-dapp/src/components/ui/HeroesList.tsx" mode="code" org="MystenLabs" repo="sui-move-bootcamp" ref="solution" fun="HeroesList" />
...
**Fix:** Verify the `queryKey` in both the fetch (`["getObject"]`) and the invalidation match exactly. Ensure `await suiClient.waitForTransaction({ digest })` completes before calling `invalidateQueries`.
