...
title: Plinko
description: >-
  Build a provably fair, gasless Plinko game on Sui using onchain randomness and
...
goal:
  description: >-
    Reader can build a provably fair, gasless Plinko game on Sui using onchain
...
questions:
  - How do I build a plinko on Sui?
  - What is the plinko pattern in Sui?
answer: >-
  Build a provably fair, gasless Plinko game on Sui using onchain randomness and
  sponsored transactions through Enoki.
---
