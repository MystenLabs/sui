...
goal:
  description: >-
    Reader can write multi-transaction tests for Move smart contracts using
    test_scenario to simulate real-world flows with multiple users, shared
    objects, and cross-module interactions
  requires:
    - headings:
