...
builder_paths:
  - path_id: p2p-payments
    ...
    stage: Setup
questions:
  - What is Connect a Frontend to a Move Package in Sui?
  - What do I need before I can connect a frontend to a move package?
  - How do I verify that connect a frontend to a move package worked?
answer: >-
