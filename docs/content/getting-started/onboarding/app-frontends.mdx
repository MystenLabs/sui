...
builder_paths:
  - path_id: p2p-payments
    ...
    stage: Setup
questions:
  - How do I connect a frontend to a move package on Sui?
  - How do I connect the react interface to your move package?
  - How do I install frontend dependencies?
  - How do I run the react application?
answer: >-
  Connect a React interface to a basic Move package to create a full stack
  application.
---
