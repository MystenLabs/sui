...
description: >-
  Use the Sui faucet to obtain free SUI tokens for use on the Sui Devnet and
  Testnet networks.
keywords: - sui faucet, sui faucet
  - faucet
  - token faucet
  - sui devnet
  - sui testnet
...
goal:
  description: >-
    Reader can request SUI tokens from the faucet and confirm they arrived in
    their wallet
  requires:
    - pattern: '```'
      min: 2
...
questions:
  - How do I get SUI tokens from the faucet?
  - How do I request Testnet or Devnet SUI tokens?
  - How do I verify my SUI token balance?
answer: >-
  To perform transactions on a Sui network, you need SUI tokens to pay for gas
  and storage.
---
...
1. Use the network dropdown to select the correct network: Testnet, Devnet, or Localnet. Use the Testnet for most use cases before deploying to Mainnet for production. [Learn more](/getting-started/onboarding/configure-sui-client) about the available networks and their differences. 
...
After you have SUI tokens, you're ready to [build and publish your first package](/getting-started/onboarding/hello-world).
