...
description: >-
  Each Sui release provides a set of binaries for several operating systems. You
  can download these binaries from GitHub and use them to install Sui.
keywords:
  - install sui
  - install sui binaries
  - binaries
goal:
  description: Reader can install prebuilt Sui binaries for their platform
  requires:
    - pattern: '```'
      min: 2
...
questions:
  - How do I install Sui from prebuilt binaries?
  - What platforms have prebuilt Sui binaries?
  - How do I verify my Sui binary installation?
answer: >-
  Each Sui release provides a set of binaries for several operating systems. You
  can download these binaries from GitHub and use them to install Sui.
---
