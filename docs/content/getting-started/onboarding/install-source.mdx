...
keywords: - install sui, install sui
  - how to install sui
  - install sui cli
...
goal:
  description: >-
    Reader can build and install the Sui framework from source, either locally
...
questions:
  - How do I build the Sui CLI from source?
  - What dependencies do I need to build Sui from source?
  - When should I install from source instead of using prebuilt binaries?
answer: >-
  You can install Sui from source, either locally or directly from GitHub. At
  minimum, you need Rust and Cargo installed for the Sui framework:.
---
