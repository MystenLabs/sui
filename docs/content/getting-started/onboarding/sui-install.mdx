---
title: Install Sui
description: Install the Sui CLI using suiup, Homebrew, or Chocolatey, verify the installation, and learn about available toolchain components including walrus and mvr.
keywords:
  - install sui
  - how to install sui
  - install sui cli
