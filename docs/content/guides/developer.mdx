...
The Sui 101 section includes Move concepts that help you create smart contracts that solve business problems and entertain users. These topics assume you are familiar with Move and the Sui blockchain.
