...
Refer to [Custom Indexing Framework](/guides/developer/accessing-data/custom-indexing-framework.mdx) and [Indexer Pipeline Architecture](/concepts/data-access/pipeline-architecture.mdx) for a conceptual overview of the indexer framework.
...
- [x] Read the [Custom Indexing Framework](/guides/developer/accessing-data/custom-indexing-framework.mdx) and [Indexer Pipeline Architecture](/concepts/data-access/pipeline-architecture.mdx) topics first to understand the overall architecture and concurrent pipeline concepts.
