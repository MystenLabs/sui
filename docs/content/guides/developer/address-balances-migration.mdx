...
- Requires up-to-date object state (version, digest) at transaction construction time
- Concurrent transactions risk using stale object references
- Complex coin selection algorithms needed for optimal gas usage
- Must handle coin fragmentation over time
