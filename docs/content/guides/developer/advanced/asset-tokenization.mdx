...
- **Burnability**
    ...
    When you tokenize an asset, you can define whether the fractions are eligible for removal or destruction from circulation. The process of removing or destroying fractions is called burning. 
...
- `PlatformCap`
    ...
    The PlatformCap refers to the capability transferred to the contract's publisher. 
This capability grants specific permissions or authority related to the platform's functionalities, allowing the deployer certain controlled actions or access rights within the deployed contract.
