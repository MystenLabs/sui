...
- [Indexer with Walrus example files](https://github.com/MystenLabs/sui/tree/main/examples/rust/walrus-attributes-indexer): Direcotry in the Sui repo containing the files for this example.
