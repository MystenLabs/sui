...
- Make sure that the "unhappy path" of your function does not charge more resources than the "happy path".
...
- Write the function in a way that the happy flow consumes more resources than the unhappy one. Please keep the following in mind:
