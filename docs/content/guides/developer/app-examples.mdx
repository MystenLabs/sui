...
- [Weather oracle](./app-examples/weather-oracle.mdx): The weather oracle demonstrates how to create a basic weather oracle that provides real-time weather data.
