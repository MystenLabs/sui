...
- [Weather Oracle](guides/developer/app-examples/weather-oracle.mdx): The SUI Weather Oracle demonstrates how to create a simple weather oracle that provides real-time weather data.
