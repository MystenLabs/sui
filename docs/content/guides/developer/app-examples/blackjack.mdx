...
keywords: [ http requests, serverless functions, on-chain randomness, generate randomness, create game, game app, game dApp, example game ]
---
...
After the user signs the sponsored transaction, this endpoint executes it on the Sui blockchain:
