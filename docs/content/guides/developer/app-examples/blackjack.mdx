...
- **Randomness and fair play:** Both games emphasize randomness for fairness. Both games use Sui's [on-chain randomness module](https://docs.sui.io/guides/developer/advanced/randomness-onchain), ensuring verifiable and truly random outcomes for every game.
