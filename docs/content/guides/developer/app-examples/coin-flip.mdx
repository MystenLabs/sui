...
In this part of the guide, you write the Move contracts that manage the house and set up the coin-flip logic. The first step is to [set up a Move package](../getting-started/hello-world.mdx) for storing your Move modules.
