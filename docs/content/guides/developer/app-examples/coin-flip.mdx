...
keywords: [ react app, react dApp, react example, on-chain randomness, shared objects, one-time witness, assets, address-owned objects, events, storage rebates, gas sponsorship, enoki, example app, example dApp ]
---
...
- **Type-safe Move bindings:** The guide shows you how to use [@mysten/codegen](https://www.npmjs.com/package/@mysten/codegen) to auto-generate TypeScript bindings from your Move contracts, ensuring type safety across your full-stack application.
