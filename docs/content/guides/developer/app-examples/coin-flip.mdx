...
The source code for the smart contracts and frontend can be found here: 
...
- **Events:** The guide teaches you how to emit [events](concepts/events.mdx)[events] in your contracts which can be used to track off-chain.
...
In this case, the `PackageID` would be `0x4120b39e5d94845aa539d4b830743a7433fd8511bdcf3841f98080080f327ca8` and the `HouseCap` ID would be `0xfa1f6edad697afca055749fedbdee420b6cdba3edc2f7fd4927ed42f98a7e63a`.
...
In this final part of the app example, you build a frontend (UI) that allows end users to place bets and take profits, and let's the admin manage the house.
