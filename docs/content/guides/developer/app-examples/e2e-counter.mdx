...
```toml reference
https://github.com/MystenLabs/ts-sdks/blob/main/packages/create-dapp/templates/react-e2e-counter/move/counter/Move.toml
```
...
```move reference
https://github.com/MystenLabs/ts-sdks/blob/main/packages/create-dapp/templates/react-e2e-counter/move/counter/sources/counter.move#L9-L15
```
...
```move reference
https://github.com/MystenLabs/ts-sdks/blob/main/packages/create-dapp/templates/react-e2e-counter/move/counter/sources/counter.move#L17-L24
```
...
```move reference
https://github.com/MystenLabs/ts-sdks/blob/main/packages/create-dapp/templates/react-e2e-counter/move/counter/sources/counter.move#L26-L29
```

The `increment` function accepts a mutable reference to any shared `Counter` object and increments its `value` field.

```move reference
https://github.com/MystenLabs/ts-sdks/blob/main/packages/create-dapp/templates/react-e2e-counter/move/counter/sources/counter.move#L31-L36
```
...
```move reference
https://github.com/MystenLabs/ts-sdks/blob/main/packages/create-dapp/templates/react-e2e-counter/move/counter/sources/counter.move
```
...
```ts reference
https://github.com/MystenLabs/ts-sdks/blob/main/packages/create-dapp/templates/react-e2e-counter/src/networkConfig.ts 
```
...
```ts reference
https://github.com/MystenLabs/ts-sdks/blob/main/packages/create-dapp/templates/react-e2e-counter/src/CreateCounter.tsx 
```
...
```ts reference
https://github.com/MystenLabs/ts-sdks/blob/main/packages/create-dapp/templates/react-e2e-counter/src/Counter.tsx 
```
...
```ts reference
https://github.com/MystenLabs/ts-sdks/blob/main/packages/create-dapp/templates/react-e2e-counter/src/App.tsx 
```
