---
title: Escrow Backend
sidebar_label: Backend
---

:::note Multi-Page Guide

This is the first in a [three-part guide](/guides/developer/app-examples/escrow) on how to build a trustless atomic swap on Sui.
...
You can view the [complete source code for this module](https://github.com/MystenLabs/sui/blob/main/examples/trading/contracts/escrow/sources/shared.move) in the Sui repository.
...
You have written and deployed the Move package. To turn this into a complete dApp with frontend, you will need to create a frontend. For the frontend to be updated, you will need to create an indexer that listens to the blockchain as escrows are made and swaps are fulfilled.

For the next step, you will [create the indexing service](/guides/developer/app-examples/escrow-indexer-api).