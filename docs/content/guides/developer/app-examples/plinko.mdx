...
Navigate to the setup/ folder from the repository's root directory and execute the `publish.sh` script. Refer to the README instructions for deploying the smart contracts and testing them locally.
