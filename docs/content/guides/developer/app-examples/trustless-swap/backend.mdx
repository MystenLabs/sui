...
This is the second in a [three-part guide](./intro.mdx) on how to build a trustless atomic swap on Sui.
...
- Understand [the mechanism behind the Trading backend](./intro.mdx).
