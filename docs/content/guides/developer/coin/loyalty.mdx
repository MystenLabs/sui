...
description: The Sui Closed-Loop Token standard can be used to create tokens that are only valid within specific workflows and services. One example of Closed-Loop Tokens is a loyalty token.
