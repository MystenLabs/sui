...
This example assumes you're familiar with publishing packages on Sui and the Move language. For more detailed guides on example apps, see [App Examples](../app-examples.mdx). For more information on the Move language, see [The Move Book](https://move-book.com/).
