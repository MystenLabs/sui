...
{@inject: examples/move/coin/sources/regcoin.move#fun=add_addr_from_deny_list noComments}

{@inject: examples/move/coin/sources/regcoin.move#fun=remove_addr_from_deny_list noComments}
