...
You publish the smart contract to a network the same way as any other package. See [Publish a Package](/guides/developer/getting-started/hello-world.mdx) if you would like more details on the publishing process. 
