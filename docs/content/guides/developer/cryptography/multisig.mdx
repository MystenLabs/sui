...
- [Token Launches on Sui](../../../concepts/tokenomics/token-launches.mdx): Following best practices when launching tokens on Sui can help ensure your project avoids some common pitfalls.
