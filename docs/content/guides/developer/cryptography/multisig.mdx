...
The topic also assumes that your active environment is Testnet (`sui client avtive-env`). You can perform these steps on Devnet or a local network as well, but you must adjust the instructions approriately.
