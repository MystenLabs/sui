...
description: Learn how to create currencies and mint coins and tokens on the Sui network using legacy coin creation or the new Coin Registry system.
...
1. **Standard creation:** Call `new_currency<T>()` any time after publishing the coin type.
...
- **Extension fields:** Include custom data for advanced use cases
