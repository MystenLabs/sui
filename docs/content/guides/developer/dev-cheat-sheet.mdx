...
- Call the proving service as sparingly as possible. Design your app flows such that you only call the proving service when the user is about to perform a real transaction.
