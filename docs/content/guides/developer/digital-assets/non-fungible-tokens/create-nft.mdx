...
On Sui, every object is unique and has an owner, so the [object model](/guides/developer/objects/object-model) handles uniqueness and ownership natively. Other blockchains, like Ethereum, require a dedicated standard such as [ERC-721](https://erc721.org/) to achieve the same result.
