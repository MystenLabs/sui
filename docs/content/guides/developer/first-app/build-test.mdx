...
{@inject: examples/move/first_package/sources/example.move#test-dummy}
...
{@inject: examples/move/first_package/sources/example.move#fun=sword_create}
...
{@inject: examples/move/first_package/sources/example.move#fun=init}
...
{@inject: examples/move/first_package/sources/example.move#fun=new_sword}
