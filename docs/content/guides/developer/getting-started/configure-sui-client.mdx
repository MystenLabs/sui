...
If the Sui client is already configured, running this command returns the `sui client --help` output rather return interactive prompts. Skip to [learning about the [`client.yaml`](#client-yaml) file.
