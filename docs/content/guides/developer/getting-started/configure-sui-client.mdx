...
If the Sui client is already configured, running this command returns the `sui client --help` output rather return interactive prompts. If this happens, skip to [learning about the [`client.yaml`](#client-yaml) file.
