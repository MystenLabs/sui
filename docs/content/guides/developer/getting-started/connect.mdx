 ...
 * Four validator nodes operated by Mysten Labs. Clients send transactions and read requests via this endpoint: `https://fullnode.<SUI-NETWORK-VERSION>.sui.io:443` using [JSON-RPC](/references/sui-api/json-rpc-format.mdx).
...
## Data wipes in Devnet and Testnet
- Devnet: Data are regularly wiped as part of the scheduled software updates
- Testnet: Data wipes are *not* part of the regular update process and will be announced ahead of time

For more information about the differences in Sui networks, see the [Sui Network Release](https://sui.io/networkinfo/) page.
