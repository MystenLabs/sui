...
Both Indexer 2.0 and GraphQL RPC Server are in alpha and not recommended for production use. Check out [this getting started document for GraphQL RPCs](guides/developer/getting-started/graphql-rpc.mdx) that refers to Mysten Labs managed relevant infrastructure. A sneak preview of how Indexer 2.0 could be setup is also available [here](https://github.com/amnn/sui-sender-indexer).
