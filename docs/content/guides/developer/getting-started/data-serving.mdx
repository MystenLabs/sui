...
| September 2025 | GA release of polling-based and streaming APIs with appropriate SDK support. | You can start migration and cutover of your application in the production environment. **JSON-RPC will be deprecated at this point and migration notice period will start.** |
