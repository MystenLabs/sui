...
GraphQL API format has been a key ask from many application builders, and the overall combination will come with following capabilities:
...
GraphQL with Indexer 2.0 is in alpha and not recommended for production use. Check out [this getting started document](guides/developer/getting-started/graphql-rpc.mdx) that refers to Mysten Labs managed relevant infrastructure. A sneak preview of how Indexer 2.0 could be setup is available [here](https://github.com/amnn/sui-sender-indexer).

GraphQL RPC was earlier shared to be in beta in 2024. But based on valuable feedback from the community, its release stage has been updated to alpha. You can refer to the updated high-level timeline for beta and GA releases below.
...
| **Tentative time** | **Milestone** | **Description** |
| -------- | ------- | ------- |
| July 2025 | Beta release of GraphQL server and Indexer 2.0 | You can start validating the setup of Indexer 2.0, along with testing the GraphQL server to access the indexed Sui data. You can also start migrating your application in the non-production environments, and share feedback on the improvements you would like to see. |
| September 2025 | Deprecation of JSON-RPC | **JSON-RPC will be deprecated at this point and migration notice period will start.** |
| December 2025 | GA release of GraphQL server and Indexer 2.0 | You can start migration and cutover of your application in the production environment. |
| June 2026 | End of migration timeline | **JSON-RPC will be fully deactivated at this point.** This timeline assumes about 9 months of migration notice period. |
