...
If you already created a new address in [Configure a Sui Client](/guides/developer/getting-started/configure-sui-client.mdx), you can skip to [Using the SUI Faucet](/guides/developer/getting-started/get-coins.mdx) to continue the onboarding steps.
...
Data displayed on an explorer differs depending on which network you created your address on. If you've followed the [Configure a Sui Client](/guides/developer/getting-started/configure-sui-client.mdx) page previously, you are most likely using the Sui Testnet. Be sure to select Testnet on the Sui explorer or use the dedicated URL, such as https://**testnet**.suivision.xyz/.
...
Next, [obtain Testnet SUI tokens](/guides/developer/getting-started/get-coins.mdx) from the SUI faucet.
