...
If you already have an address or created a new address in [Configure a Sui Client](/guides/developer/getting-started/configure-sui-client.mdx), you can skip to [Using the SUI Faucet](/guides/developer/getting-started/get-coins.mdx) to continue the onboarding steps.
