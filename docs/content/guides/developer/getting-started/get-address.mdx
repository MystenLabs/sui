...
This returns all available addresses along with their aliases, and indicates which one is currently active:
...
Data displayed on an explorer differs depending on which network you created your address on. If you've followed the [Configure a Sui Client](/guides/developer/getting-started/configure-sui-client.mdx) page previously, you are most likely using the Sui Testnet. Be sure to select the Testnet network on the Sui explorer or use the dedicated URL, such as https://**testnet**.suivision.xyz/.
