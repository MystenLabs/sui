...
- Brief introduction
    - What is an address?
    - What is your address used for?
- What are recovery phrases?
    - Why they are important
- Prerequisites
    - Install Sui
- Introduce command to create a new address
    - Different key signature types
        - What does each mean / use cases for each
        - Which one to pick?
- If followed previous page on configure client, introduce commands to view current active address and list all addresses
- What part of the output is the address?
- Next steps
    - Link to next page Use the SUI faucet
