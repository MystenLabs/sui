...
The faucet drains from a finite pool of SUI. If the pool empties, it disrupts faucet service for the rest of the community. To help ensure this doesn't happen, you can use the online faucet to return your unused SUI to the pool.
...
- [Distributed Counter](/guides/developer/app-examples/e2e-counter.mdx)
