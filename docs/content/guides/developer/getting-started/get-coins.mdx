---
title: Use the Testnet SUI Faucet
...
- Include instructions for the browser Faucet and Discord
    - Mention that sui client faucet exists for local network but not testnet/devnet
    - Link to page on local network config/setup
    - add community faucet options
- How to verify you got some
    - CLI command
    - Sui explorer
- Links to other faucet options as a child page
