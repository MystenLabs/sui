...
- https://stakely.io/faucet/sui-sui (both mainnet and testnet)
...
If you are running a local Sui network, you can get SUI tokens from your local faucet. See the [Connect to a Local Network](/guides/developer/getting-started/local-network.mdx#use-the-local-faucet) topic for details.
