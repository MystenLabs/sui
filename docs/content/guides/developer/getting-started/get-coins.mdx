...
An online faucet is available for test token requests.

URL: https://faucet.sui.io/

Connect your wallet or paste your wallet address in the address field. Use the network dropdown to select the correct network and click the Request SUI button.

You can refresh your browser and click the Request SUI button again to quickly repeat the process. The requests are rate limited, however, so too many requests results in a waiting period before you are able to request more tokens. 
...
If you connect your wallet that contains the unused SUI to the online faucet, you can click the **Return tokens to faucet** button. Approve the transaction using your wallet and your Testnet SUI are returned to the pool. 

If you prefer not to connect your wallet, you can click the **Copy** button to the right of the return address and send the tokens via a separate transaction.

When you need those tokens again, just revisit the faucet.
