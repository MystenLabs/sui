...
keywords: [ rpc, sui rpc, graphql, how to use graphql, schema, graphql schema, query transactions, query blocks, query blockinformation, query dynamic field, execute transaction ]
mdx:
  format: md
---
