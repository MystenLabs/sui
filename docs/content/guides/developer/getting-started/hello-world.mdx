...
Now that your package has been built, you need to publish it onto Testnet. After you publish it, other packages and users can use the package's modules and functions by making calls to the package ID.
