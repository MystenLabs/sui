...
If you have followed the Getting Started path, you should be ready to continue your journey on Sui. To make sure you have everything you need, paste the following commands into a console in your local environment:
