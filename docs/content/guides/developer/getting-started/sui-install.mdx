...
1.  Install [Sui binaries from source](#install-sui-binaries-from-source).
1.  Configure an [integrated development environment](./sui-environment).
1.  Request [SUI test tokens](./get-coins) to use on Sui Devnet or Sui Testnet networks.
