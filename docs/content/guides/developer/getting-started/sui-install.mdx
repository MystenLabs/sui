...
Sui Docker images provide a clean install of Sui into a Docker container from any operating system that supports Docker Desktop.

1. Install the [Docker Desktop](https://docs.docker.com/get-docker/?_gl=1*1l95hq6*_ga*MTE1MDgyMjE5OS4xNjk0NzkxOTc1*_ga_XJWPQMJYHQ*MTY5NjU0MzQyOC4yLjEuMTY5NjU0MzQ3Ni4xMi4wLjA.) appropriate for your operating system.
1. 
...
* [Get coins](./get-coins.mdx) - Now that you have Sui installed, you need to get some coins on a development network to start using Sui.