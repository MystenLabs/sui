...
`suiup` repository's [README](https://github.com/mystenLabs/suiup?tab=readme-ov-file#paths-used-by-the-suiup-tool) has all the information about which paths it uses.
