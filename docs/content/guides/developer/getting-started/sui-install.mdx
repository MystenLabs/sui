...
### Homebrew complete install

You can install Sui along with prerequisites using the following commands.

First, create a tap to the Sui repository.

```bash
brew tap mystenlabs/tap
```

Second, install Sui using the tap you created.
...
You do not need to install prerequisites if you install Sui using the tap.
