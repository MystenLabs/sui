...
Installations using Homebrew or Chocolatey make take several minutes if you do not have any of the [Sui prerequisites](/guides/developer/getting-started/install-source) installed. Using `suiup` is often much faster and highly recommended.
