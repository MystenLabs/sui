...
## Install using Chocolately (Windows)

If you are on Windows and use `chocolatey`, you can install Sui with the following command:

```
choco install sui
```

Find more versions of Sui for Windows [here](https://community.chocolatey.org/packages/sui).
