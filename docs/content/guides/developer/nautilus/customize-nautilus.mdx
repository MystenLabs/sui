...
These customization, testing, and management steps are for self-managed TEEs. Alternatively, you can use the [Marlin Oyster marketplace](/docs/guides/developer/nautilus/marlin) for Docker-based simplicity that removes testing and management overhead.
