...
As an app developer, follow these steps to deploy a self-managed TEE. Alternatively, you can use the [Marlin Oyster marketplace](/docs/guides/developer/nautilus/marlin) for Docker-based simplicity.
