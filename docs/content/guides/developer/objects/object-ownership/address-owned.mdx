...
- Use the `sui::transfer::transfer` function if you are defining [custom transfer rules](/concepts/transfers/custom-rules.mdx) for the object. 
...
<ImportContent source="examples/move/basics/sources/object_basics.move" mode="code" func="create" noComments />
...
<ImportContent source="examples/move/color_object/sources/example.move" mode="code" func="test_transfer"/>