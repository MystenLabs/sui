...
<ImportContent source="examples/move/color_object/sources/example.move" mode="code" func="test_immutable" />
...
Consider a function that copies the value of 1 object to another:
