...
You can also publish or upgrade using the `sui client ptb` command. See [Building Programmable Transaction Blocks](/guides/developer/transactions/building-ptb.mdx) for details.
