...
Run the following command in your terminal or console, and select React as the framework, and then select 1 of the TypeScript templates:
...
To use all the features of dApp Kit, wrap your app with 2 `Provider` components.
