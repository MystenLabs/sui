...
description: Because Sui uses owned objects for transactions, you need to have plans to manage coins in your programmable transaction block development. 
---
...
Gas smashing is a key feature - and a key concept to understand - to have for the optimal management of coins. See [Gas Smashing](/concepts/transactions/gas-smashing.mdx) for more details.
...
From a cost perspective, those are very cheap transactions, however they require you to be aware of your coin distribution and your own needs.
...
Concurrency is a difficult subject and is beyond the scope of this documentation. You must maximum care when dealing with coin management in the face of concurrency, and the right strategy is often tied to the specific scenario, rather than universally available. 
