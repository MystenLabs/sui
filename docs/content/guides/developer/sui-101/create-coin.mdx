...
You can create a coin and specify a list of addresses that are denied from using it. You can update the list of addresses, as needed. The network updates the list of denied addresses quickly, without having to form a consensus. 
