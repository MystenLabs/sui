...
description: On Sui object ownership can be represented in a number of different ways. Weigh the benefits of each to decide the best approach for your project.
---
