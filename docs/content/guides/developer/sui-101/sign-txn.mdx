...
There are various ways to instantiate a `SuiKeyPair` and to derive its public key and Sui address using the Sui Rust SDK. You can find the complete runnable code under the crates/sui-sdk folder of the Sui repository. 
