...
If you are using the [address balances](/guides/developer/digital-assets/address-balances/using-address-balances) feature, then you do not need to use gas smashing. Address balance gas payment removes the need to select or merge gas coins entirely.
