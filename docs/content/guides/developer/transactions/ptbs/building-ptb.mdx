...
This guide explores creating a [programmable transaction block (PTB)](/guides/developer/transactions/ptbs/prog-txn-blocks) on Sui using the [TypeScript SDK](https://sdk.mystenlabs.com/typescript/install).
...
Learn more about [inputs](/guides/developer/transactions/inputs-and-results).
