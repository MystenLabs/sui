...
You can modify aliases for an address using the Move API in the [`sui::address_alias` module](/references/framework/sui-framework/sui_sui/address_alias). These modification functions must be invoked as top-level PTB commands and cannot be called from other Move functions.
