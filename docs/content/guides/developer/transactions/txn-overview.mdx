...
- **[System transactions](/guides/developer/transactions/system-transactions.mdx):** Manage network events such as epoch changes and checkpoint creation. Only validators can submit system transactions.
