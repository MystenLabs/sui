...
[SuiLink](https://www.suilink.io/) is a Mysten Labs product that lets you securely link wallet addresses from different blockchain networks to your Sui wallet. When you create a SuiLink, you receive a soulbound NFT that serves as authenticated proof of ownership for your connected wallets.
...
You can permanently unlink a wallet by burning the corresponding NFT pass. To unlink an address:
