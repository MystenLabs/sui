...
:::info
Starting with the 1.49 release, the existing special archive format is being deprecated in favor of a generic data ingestion format. Please migrate your configs using the configuration example listed below. The deprecation configuration is mentioned below for reference, but will be removed after a few releases.
:::
...
## Set up archival fallback(deprecated) {#set-up-archival-fallback}
<Tabs groupId="object-store">
