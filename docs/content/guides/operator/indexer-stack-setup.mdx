...
Note that multiple `--indexer-config` parameters can be provided, one for each general-purpose indexer instance.

| CLI param                        | Description                                                                        |
|----------------------------------|------------------------------------------------------------------------------------|
| `CONFIG_FILE`                    | Path to GraphQL configuration file                                                 |
| `INDEXER_CONFIG_FILE`            | Path to indexer configuration file that can be set multiple times                  |
