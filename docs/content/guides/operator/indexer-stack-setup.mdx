...
| Table | Heap 30d (GB) | Idx 30d (GB) | Heap 90d (GB) | Idx 90d (GB) |
|-------|---------------|--------------|---------------|--------------|
| `tx_affected_objects` | 64–70 | 276–397 | 188–202 | 580–752 |
| `tx_calls` | 27–30 | 239–366 | 82–87 | 560–715 |
| `ev_struct_inst` | 15–19 | 174–267 | 45–50 | 432–531 |
| `tx_affected_addresses` | 17–18 | 63–92 | 50–54 | 151–183 |
| `ev_emit_mod` | 8–9 | 54–85 | 22–24 | 129–167 |
| `tx_balance_changes` | 18–20 | 5–6 | 57–63 | 10–16 |
| `tx_digests` | 8 | 21–25 | 24–26 | 45–55 |
| `tx_kinds` | 5 | 14–16 | 15–16 | 30–36 |
| `cp_sequence_numbers` | 10 | 5 | 10 | 5 |
| **TOTAL** | **444–450** | **1,827–1,842** | **755–842** | **2,440–3,181** |

### Run `sui-indexer-alt`

<details>
<summary>`sui-indexer-alt` full command parameter list</summary>

<ImportContent mode="code" source="crates/sui-indexer-alt/docs/indexer_help.txt"/>
</details>
...
| `<CHECKPOINT_NUMBER>`| (Optional) For prunable pipelines only. Identifies the checkpoint to start indexing from based on retention requirements.                        |
