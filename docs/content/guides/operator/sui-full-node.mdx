...
Instructions for building, installing, or downloading the `sui-node` binary are available in the [Install from Binaries](/guides/developer/getting-started/install-binaries.mdx) guide. 
