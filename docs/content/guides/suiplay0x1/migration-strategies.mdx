...
<RelatedLink href="https://wallet.playtron.one) (in development" label="Companion web application" desc="Support linking the Playtron wallet to other self-custodied wallets using Sui Link, enabling read-access of associated wallets while on the device." />
