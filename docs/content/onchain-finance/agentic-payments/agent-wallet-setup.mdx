...
<ImportContent source="examples/onchain-finance/agent-wallet/src/keypair.ts" mode="code" tag="generate-new" />
...
<ImportContent source="examples/onchain-finance/agent-wallet/src/keypair.ts" mode="code" tag="from-mnemonic" />
...
<ImportContent source="examples/onchain-finance/agent-wallet/src/keypair.ts" mode="code" tag="from-secret-key" />
...
<ImportContent source="examples/onchain-finance/agent-wallet/src/keypair.ts" mode="code" tag="env-load" />
...
Every key pair maps to a Sui address. This address is where the agent receives objects, holds coins, and is identified onchain.

<ImportContent source="examples/onchain-finance/agent-wallet/src/keypair.ts" mode="code" tag="derive-address" />
...
<ImportContent source="examples/onchain-finance/agent-wallet/src/keypair.ts" mode="code" tag="sign-execute" />
...
<ImportContent source="examples/onchain-finance/agent-wallet/src/keypair.ts" mode="code" tag="sign-sponsored" />
...
<ImportContent source="examples/onchain-finance/agent-wallet/src/keypair.ts" mode="code" tag="key-rotation" />
