...
<ImportContent source="examples/onchain-finance/production-hardening/sources/snippet_1.move" mode="code" tag="snippet_1" />
...
<ImportContent source="examples/onchain-finance/production-hardening/sources/snippet_2.move" mode="code" tag="snippet_2" />
