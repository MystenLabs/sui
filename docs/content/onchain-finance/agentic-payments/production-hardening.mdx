...
<ImportContent source="examples/onchain-finance/production-hardening/src/patterns.ts" mode="code" tag="kill-switch" />
...
<ImportContent source="examples/onchain-finance/production-hardening/sources/admin_config.move" mode="code" tag="admin_config" />
...
<ImportContent source="examples/onchain-finance/production-hardening/sources/snippet_1.move" mode="code" tag="guarded-spend" />
...
<ImportContent source="examples/onchain-finance/production-hardening/src/patterns.ts" mode="code" tag="safe-execute" />
...
<ImportContent source="examples/onchain-finance/production-hardening/sources/snippet_2.move" mode="code" tag="onchain-idempotency" />
...
<ImportContent source="examples/onchain-finance/production-hardening/src/patterns.ts" mode="code" tag="circuit-breaker" />
...
<ImportContent source="examples/onchain-finance/production-hardening/src/patterns.ts" mode="code" tag="rate-limiter" />
...
<ImportContent source="examples/onchain-finance/production-hardening/src/patterns.ts" mode="code" tag="structured-log" />
