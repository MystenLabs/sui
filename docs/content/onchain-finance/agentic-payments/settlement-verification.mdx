...
<ImportContent source="examples/onchain-finance/settlement/sources/settlement.move" mode="code" tag="settlement" />

In the PTB, chain `pay_and_prove` into `consume_receipt`:
