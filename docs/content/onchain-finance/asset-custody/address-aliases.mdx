...
This is simpler than [spending mandates](/onchain-finance/agentic-payments/spending-policies), but it is not sandboxed and offers no spending limits, since the alias has full authority over the aliased address. Use mandates when you need bounded spending. Use aliases only when you need full delegation to a trusted key.
