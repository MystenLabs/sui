...
goal:
  description: >-
    Reader understands how address balances replace the UTXO-style Coin model
    with address-owned balances that remove coin-selection complexity
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Address Balances in Sui?
  - What topics does Address Balances cover?
  - Why should I use address balances?
answer: >-
  Address balances introduce a canonical balance system for fungible assets tied
  to Sui addresses.
---
