...
- Constructing transactions after querying onchain state first.
- Letting another address spend from your balance within limits you set, through [allowances](/onchain-finance/allowances).
