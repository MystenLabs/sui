...
Address balances introduce a canonical balance system for fungible assets tied to Sui addresses. This replaces the UTXO-style `Coin<T>` model with direct address-owned balances, which simplifies transaction construction and eliminates coin selection complexity.
