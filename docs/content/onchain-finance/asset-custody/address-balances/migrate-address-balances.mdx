...
description: >-
  What changes with address balances on Sui and what action to take for existing
  integrations.
keywords:
  - address balances
  - migration
...
goal:
  description: >-
    Reader understands what changes with address balances on Sui and what action
...
questions:
  - What is Migrating from Coin to Address Balances in Sui?
  - How does migrating from coin to address balances work on Sui?
