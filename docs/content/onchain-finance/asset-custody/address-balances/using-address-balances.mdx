...
goal:
  description: >-
    Reader can address balances introduce a canonical balance system for
    fungible assets tied to Sui addresses. Learn how to send, withdraw, and
  ...
  requires:
    ...
    - headings:
        - pattern: Sending funds
        - pattern: Withdrawing funds
        - pattern: Paying for gas from address balances
