...
description: >-
  Learn about self-custodial wallets on Sui,
  how to integrate any Wallet Standard wallet into your app using Sui dApp Kit.
keywords:
  - wallet
  - self-custodial
  - ledger
...
goal:
  description: >-
    Reader can learn about self-custodial wallets on Sui
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Self-Custodial Wallets in Sui?
  - How does self-custodial wallets work on Sui?
  - Why should I use self-custodial wallets?
answer: >-
  Learn about self-custodial wallets on Sui, how to integrate any Wallet Standard wallet into your app using Sui dApp Kit.
---
...
The [Sui dApp Kit](https://sdk.mystenlabs.com/dapp-kit) is the official SDK for building Sui apps. Any wallet that implements the Wallet Standard, including Ledger, is detected automatically and appears in the connection UI without any wallet-specific configuration.
