...
goal:
  description: >-
    Reader can learn about Slush Wallet, its features, and how to integrate it
    into your wallet or app using the Slush Wallet SDK and Sui dApp Kit
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Slush basics
        - pattern: Slush Wallet SDK
        - pattern: Sui dApp Kit integration
