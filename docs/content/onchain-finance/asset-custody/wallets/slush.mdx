...
Users who have the Slush browser extension installed see only the extension in the connection modal. Users without the extension can use a delegated session key instead.
