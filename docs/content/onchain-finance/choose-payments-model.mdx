...
- **Sponsored transaction:** A gas station pays gas on behalf of the sender. Works with any transaction type. See [Sponsored Transactions](/develop/transaction-payment/sponsor-txn).
