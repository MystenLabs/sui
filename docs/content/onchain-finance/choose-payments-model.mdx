...
<ImportContent source="examples/onchain-finance/choose-payments-model/src/examples.ts" mode="code" tag="basic-transfer" />

Address balance transfers use `send_funds` and are eligible for [gasless stablecoin transfers](/develop/transaction-payment/gasless-stablecoin-transfers):
...
<ImportContent source="examples/onchain-finance/choose-payments-model/src/examples.ts" mode="code" tag="payment-kit" />
...
<ImportContent source="examples/onchain-finance/choose-payments-model/sources/payments.move" mode="code" tag="payments" />
