...
goal:
  description: >-
    Reader gets a clear overview of closed-loop token and knows which subtopic
    to read next
  requires:
    - has_frontmatter:
        - title
    ...
    - headings:
        - pattern: Background and use cases
        - pattern: Difference with Coin
        - pattern: Compliance and rules
