...
To mint a referral, use the core DeepBook SDK's `mintReferral` function. See the [DeepBookV3 SDK documentation](/onchain-finance/deepbookv3-sdk/deepbookv3-sdk#referral-functions) for more details on minting and managing referrals.
