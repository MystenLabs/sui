...
goal:
  description: >-
    Reader understands understanding risk ratios and how they determine leverage
    limits, collateral requirements, and liquidation thresholds in DeepBook
    Margin
  requires:
    - has_frontmatter:
        - title
    ...
    - headings:
        - pattern: What is a risk ratio\?
        - pattern: Risk ratio thresholds
        - pattern: How leverage is determined
