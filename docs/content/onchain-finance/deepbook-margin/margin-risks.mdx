...
goal:
  description: >-
    Reader understands understand the risks of margin trading on DeepBook,
    including liquidation, interest rate fluctuations, and how to protect your
    positions
  requires:
    - has_frontmatter:
        - title
    ...
    - headings:
        - pattern: Liquidation risk
        - pattern: Interest rate risk
        - pattern: Oracle risk
