...
title: Design
description: >-
  Learn about DeepBook Predict design, including Predict, PredictManager,
  OracleSVI, Vault, and PLP.
keywords:
...
goal:
  description: >-
    Reader can learn about DeepBook Predict design, including Predict,
    PredictManager, OracleSVI, Vault, and PLP
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: '`Predict` shared object \{#predict\}'
        - pattern: '`PredictManager` shared object \{#predic'
        - pattern: 'Positions and ranges \{#positions-and-ra'
