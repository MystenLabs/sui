...
<ImportContent source="packages/deepbook-v3/src/contracts/deepbook_margin/margin_pool.ts" mode="code" fun="withdrawMaintainerFees" org="MystenLabs" repo="ts-sdks" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/contracts/deepbook_margin/margin_pool.ts" mode="code" fun="withdrawProtocolFees" org="MystenLabs" repo="ts-sdks" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginAdmin.ts" mode="code" fun="adminWithdrawDefaultReferralFees" org="MystenLabs" repo="ts-sdks" signatureOnly />
