...
sidebar_position: 2
description: >-
  DeepBook Margin contract addresses, supported coins, margin pools, and risk
  parameters on Sui Mainnet.
keywords:
  - deepbook margin
  - contract address
  - package id
...
goal:
  description: >-
    Reader understands deepBook Margin contract addresses, supported coins,
    margin pools, and risk parameters on Sui Mainnet
  requires:
    - has_frontmatter:
        - title
        - description
...
Risk parameters determine the leverage limits and liquidation thresholds for each trading pair. See [Risk Ratio](/onchain-finance/deepbook/deepbook-margin/contract-information/risk-ratio) for a detailed explanation of how these parameters work.
