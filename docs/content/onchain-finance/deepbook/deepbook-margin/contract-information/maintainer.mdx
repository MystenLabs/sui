...
title: Maintainer
description: >-
  Learn about maintainer functions for creating margin pools, enabling or
  disabling DeepBook pools, updating interest rate parameters, withdrawing fees,
  and the events emitted by the margin registry.
keywords:
  - maintainer
  - margin pool admin
  - pool configuration
