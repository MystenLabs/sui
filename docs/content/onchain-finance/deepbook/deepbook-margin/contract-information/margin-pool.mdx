...
The protocol captures a portion of the interest income as fees. These fees accumulate separately and are withdrawn by authorized maintainers and the protocol.
...
4. Call `withdraw` when you want to reclaim your assets plus accrued interest. Specify an exact token amount or pass all your shares to withdraw everything.
