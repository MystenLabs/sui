---
title: Orders
description: Learn how to place, modify, and cancel orders, manage staking and governance participation, and claim rebates using margin managers via the pool_proxy module in DeepBook Margin.
keywords:
  - orders
  - limit order
  - market order
