...
sidebar_label: DeepBook Margin Indexer
description: >-
  DeepBook Margin Indexer provides access to margin trading events including
  loans, liquidations, and margin pool operations.
keywords:
...
goal:
  description: >-
    Reader understands DeepBook Margin Indexer provides access to margin trading
    events including loans, liquidations
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  - path_id: defi-deepbook
    ...
    step: Margin event indexing
    stage: Advanced
questions:
  - What is DeepBook Margin Indexer in Sui?
  - How does deepbook margin indexer work on Sui?
  - How do I subscribe to deepbook margin indexer events?
answer: >-
  The DeepBook Margin Indexer extends the DeepBookV3 Indexer with endpoints for
  margin trading data. These endpoints provide access to margin manager events,
  margin pool operations, and liquidation monitoring.
---
