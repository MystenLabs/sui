...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="287-295" />

To construct the client without `$extend`, pass `network`, your Sui client, and an optional `config` to `new PredictClient`:

<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="327-331" />
...
<ImportContent source="packages/deepbook-v3/src/predict/config/index.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="10-10" />
...
<ImportContent source="packages/deepbook-v3/src/predict/config/types.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="29-60" />
...
<ImportContent source="packages/deepbook-v3/src/deployments/index.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="65-65" />
...
<ImportContent source="packages/deepbook-v3/src/predict/units.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="40-48" />
...
<ImportContent source="packages/deepbook-v3/src/predict/errors.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="14-43" />
...
<ImportContent source="packages/deepbook-v3/src/predict/errors.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="75-75" />
...
<ImportContent source="packages/deepbook-v3/src/predict/decode.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="27-41" />
...
<ImportContent source="packages/deepbook-v3/src/predict/tx/trade.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="32-35" />
