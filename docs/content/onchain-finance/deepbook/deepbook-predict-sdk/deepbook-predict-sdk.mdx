...
answer: >-
  Install @mysten/deepbook-v3 version 2.5.0 or later with its @mysten/sui
...
Install `@mysten/deepbook-v3` version 2.5.0 or later from [npm](https://www.npmjs.com/package/@mysten/deepbook-v3), together with its `@mysten/sui` peer dependency at version 2.30.0 or later. The package requires Node.js 22 or later.
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="5952632740af0598d4ca40669ba8247b2b1d041e" lines="273-281" />

To construct the client without `$extend`, pass `network`, your Sui client, and an optional `config` to `new PredictClient`:

<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="5952632740af0598d4ca40669ba8247b2b1d041e" lines="313-317" />
...
<ImportContent source="packages/deepbook-v3/src/predict/config/index.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="5952632740af0598d4ca40669ba8247b2b1d041e" lines="10-10" />
...
<ImportContent source="packages/deepbook-v3/src/predict/config/types.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="5952632740af0598d4ca40669ba8247b2b1d041e" lines="26-57" />
...
<ImportContent source="packages/deepbook-v3/src/deployments/index.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="5952632740af0598d4ca40669ba8247b2b1d041e" lines="65-65" />
...
<ImportContent source="packages/deepbook-v3/src/predict/units.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="5952632740af0598d4ca40669ba8247b2b1d041e" lines="40-48" />
...
<ImportContent source="packages/deepbook-v3/src/predict/errors.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="5952632740af0598d4ca40669ba8247b2b1d041e" lines="14-43" />
...
<ImportContent source="packages/deepbook-v3/src/predict/errors.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="5952632740af0598d4ca40669ba8247b2b1d041e" lines="75-75" />
...
<ImportContent source="packages/deepbook-v3/src/predict/decode.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="5952632740af0598d4ca40669ba8247b2b1d041e" lines="27-41" />
...
<ImportContent source="packages/deepbook-v3/src/predict/tx/trade.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="5952632740af0598d4ca40669ba8247b2b1d041e" lines="31-34" />
