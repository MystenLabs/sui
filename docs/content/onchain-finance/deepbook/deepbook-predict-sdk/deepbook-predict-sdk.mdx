...
answer: >-
  Install @mysten/deepbook-v3 version 2.6.1 or later with its @mysten/sui
...
Install `@mysten/deepbook-v3` version 2.6.1 or later from [npm](https://www.npmjs.com/package/@mysten/deepbook-v3), together with its `@mysten/sui` peer dependency at version 2.30.0 or later. The package requires Node.js 22 or later.
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="56d51645cd231010e39d96dd23583056c5266426" lines="287-295" />

To construct the client without `$extend`, pass `network`, your Sui client, and an optional `config` to `new PredictClient`:

<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="56d51645cd231010e39d96dd23583056c5266426" lines="327-331" />
...
<ImportContent source="packages/deepbook-v3/src/predict/config/index.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="56d51645cd231010e39d96dd23583056c5266426" lines="10-10" />
...
<ImportContent source="packages/deepbook-v3/src/predict/config/types.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="56d51645cd231010e39d96dd23583056c5266426" lines="29-60" />
...
<ImportContent source="packages/deepbook-v3/src/deployments/index.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="56d51645cd231010e39d96dd23583056c5266426" lines="65-65" />
...
<ImportContent source="packages/deepbook-v3/src/predict/units.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="56d51645cd231010e39d96dd23583056c5266426" lines="40-48" />
...
<ImportContent source="packages/deepbook-v3/src/predict/errors.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="56d51645cd231010e39d96dd23583056c5266426" lines="14-43" />
...
<ImportContent source="packages/deepbook-v3/src/predict/errors.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="56d51645cd231010e39d96dd23583056c5266426" lines="75-75" />
...
<ImportContent source="packages/deepbook-v3/src/predict/decode.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="56d51645cd231010e39d96dd23583056c5266426" lines="27-41" />
...
- The Predict bindings: a `MoveCalls` namespace for each Predict module with a callable function, such as `plpMoveCalls`, `expiryMarketMoveCalls`, `predictAccountMoveCalls`, and `registryMoveCalls`.
- The Predict event layouts: `orderEvents`, `vaultEvents`, `configEvents`, and `builderCodeEvents`.
...
[Predict Liquidity SDK](/onchain-finance/deepbook/deepbook-predict-sdk/liquidity) covers the floor, the queue, and how the flush fills the request.
...
<ImportContent source="packages/deepbook-v3/src/predict/tx/trade.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="56d51645cd231010e39d96dd23583056c5266426" lines="32-35" />
