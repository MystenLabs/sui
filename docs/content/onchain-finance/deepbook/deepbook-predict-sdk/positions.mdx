...
answer: >-
  ...
  Predict package version 2, which SDK 2.6.0 addresses on Testnet only, though
  both networks run it onchain.
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="912-916" />
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="221-250" />
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="692-692" />

<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="121-125" />
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="699-703" />

<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="128-134" />
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="922-926" />
...
`tx.mintCost` and `read.quoteMintCost` call an entrypoint that arrived in `predict` package version 2. Both networks run that version onchain, so both calls are valid on either.

The published `@mysten/deepbook-v3` 2.6.0 predates the Mainnet upgrade and still carries `0x89aea622…`, the version 1 address, as its Mainnet `predict` call target. On that release these 2 calls work on Testnet and fail on Mainnet, because the package they address has no `mint_exact_cost`. The fix is on `main` and ships in the next patch; until then, override the Mainnet call target with the one on [Contract Information](/onchain-finance/deepbook/deepbook-predict/contract-information#packages). The snippet below still carries the SDK's own comment saying Testnet only, which both upgrades have since overtaken.
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="696-696" />

<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="136-142" />
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="931-935" />
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="253-265" />
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="729-729" />

<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="146-149" />
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="732-736" />
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="863-863" />

<ImportContent source="packages/deepbook-v3/src/predict/reads/positions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="41-44" />
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="857-857" />
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="1003-1004" />

<ImportContent source="packages/deepbook-v3/src/predict/decode.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="106-147" />
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="1005-1007" />

<ImportContent source="packages/deepbook-v3/src/predict/decode.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="149-184" />
...
<ImportContent source="packages/deepbook-v3/src/predict/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="1008-1010" />

<ImportContent source="packages/deepbook-v3/src/predict/decode.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="186-195" />

## Examples {#examples}

The following samples live in the `examples/deepbook-predict` package, which type-checks against version 2.6.0 of `@mysten/deepbook-v3`. None of them signs a transaction: every builder returns an unsigned `Transaction`, and the SDK never holds keys.
