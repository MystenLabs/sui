...
verified_against: '@mysten/deepbook-v3 2.6.0 plus the unreleased Mainnet id bump at ts-sdks b0422900; predict and sessions v2 on both networks, publication records at deepbookv3 2378336b'
---
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="68-70" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="150-150" />

### `SessionsConfig` {#sessions-config}

`SessionsConfig` holds the IDs every builder needs: the latest `deepbook_sessions` package to call, the original `deepbook_sessions` package ID that v1 structs and dynamic-field keys still carry, the shared `SessionsConfig` object, the `account` package, and the shared `AccountRegistry`. `sessionsPackageIdV1` is optional and matters only where the package has been upgraded: on Testnet, where `sessions` is at version 2, the two IDs differ, and on Mainnet, where it is at version 1, they are the same. The account IDs are the same ones `AccountContract` takes on [Predict Accounts SDK](/onchain-finance/deepbook/deepbook-predict-sdk/accounts#account-subpath), because sessions is an account app on the same registry.

<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="27-38" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="45-50" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="53-56" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="84-84" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="87-87" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="168-168" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="180-180" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="193-193" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="214-214" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="253-253" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="105-110" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="458-458" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="479-479" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="491-491" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="279-289" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="315-325" />

### `mintExactCost` {#mint-exact-cost}

Use `mintExactCost` to mint inside an all-in budget as the session key, the session form of `mint_exact_cost`. It returns a `(tx: Transaction) => TransactionResult` function whose result is the new order ID, a `u256`. Unlike the other 2 mint builders it takes no separate cost cap, because `maxCost` is the budget the fill is sized inside rather than a ceiling checked afterward.

:::info

`mintExactCost` calls a wrapper that arrived in `sessions` package version 2, which both networks now run. The published `@mysten/deepbook-v3` 2.6.0 predates the Mainnet upgrade and still resolves the version 1 Mainnet call target, so on that release this builder works on Testnet and fails on Mainnet; pass the Mainnet call target from [Contract Information](/onchain-finance/deepbook/deepbook-predict/contract-information#packages) until the next patch ships. The other 4 wrappers are unaffected, because they existed at version 1.
...
- `lowerTick`: The lower bound of the position's strike range, as an absolute tick.
- `higherTick`: The upper bound of the position's strike range, as an absolute tick.
- `maxCost`: The all-in budget, fees included, in raw quote units. The contract caps it at the account's available balance before sizing.
- `minQuantity`: The smallest payout quantity you accept, in raw units. This is the builder's only slippage guard, and `0` disables it.

<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="350-359" />

Set `minQuantity` deliberately here. The spend is fixed, so an adverse move between building the transaction and executing it arrives as fewer contracts, and this floor is what rejects a fill that moved too far. [Predict Positions SDK](/onchain-finance/deepbook/deepbook-predict-sdk/positions#mint-cost) covers the sizing limits, and [Predict Cost SDK](/onchain-finance/deepbook/deepbook-predict-sdk/cost#mint-cost-for-budget) runs the same search locally to derive a floor with no chain call.
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="388-397" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="422-427" />
...
- **Required mint caps:** The session mint builders require their caps. `mintExactQuantity` takes `maxCost` and `maxProbability` as required parameters, and `mintExactAmount` requires `maxCost`. The facade's `tx.mint`, on [Predict Positions SDK](/onchain-finance/deepbook/deepbook-predict-sdk/positions#mint), sends `U64_MAX` for a cap you omit, which is a cap that can never trip. `mintExactCost` is the one shape with nothing to forget: its budget bounds the debit by construction, and `minQuantity` is its only guard.
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="237-237" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="501-508" />
...
<ImportContent source="packages/deepbook-v3/src/sessions.ts" mode="code" org="MystenLabs" repo="ts-sdks" branch="b042290014120fd45fcf234a7f1d2af26418f751" lines="12-13" />
