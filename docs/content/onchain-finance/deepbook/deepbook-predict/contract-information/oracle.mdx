...
title: Oracle
description: >-
  Learn about OracleSVI lifecycle, price updates, SVI updates, settlement, and
  oracle read functions in DeepBook Predict.
keywords:
  - oraclesvi
...
goal:
  description: >-
    Reader can learn about OracleSVI lifecycle, price updates, SVI updates,
    settlement, and oracle read functions in DeepBook Predict
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Oracle in Sui?
  - How does oracle work on Sui?
  - Why should I use oracle?
answer: '`OracleSVI` is the market state for one underlying asset and one expiry.'
---
