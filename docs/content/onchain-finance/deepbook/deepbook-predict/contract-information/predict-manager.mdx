...
| Mint | `expiry_market::mint_exact_quantity`, `expiry_market::mint_exact_amount`, `expiry_market::mint_exact_cost` | Debits the all-in cost and records a position in Predict's account slot. |
