...
answer: >-
  ...
  mint_exact_cost, new in package version 2 and live on Testnet only, sizes the
  fill inside an all-in budget so fees come out of the spend rather than on top
  of it. Live trades close in the last no_trade_window_ms before expiry, and
  settlement is the permissionless try_settle.
last_verified: 2026-09-21
verified_against: deepbookv3 4e9bfe90; deepbook-predict-mainnet 7b169bde (predict v1); deepbook-predict-testnet predict v2 at 8d7d42a0
---
...
`mint_exact_cost` arrived in package version 2, which is live on Testnet only. Mainnet is still at version 1 and does not carry it. See [Contract Information](/onchain-finance/deepbook/deepbook-predict/contract-information#two-ids).
