...
goal:
  description: >-
    Reader understands prediction market protocol built alongside DeepBook, with
    binary positions, vertical ranges
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is DeepBook Predict in Sui?
  - How do I user flow?
  - How does deepbook predict work on Sui?
answer: >-
  Prediction market protocol built alongside DeepBook, with binary positions,
  vertical ranges, oracle-driven pricing, and shared vault liquidity on Sui.
---
