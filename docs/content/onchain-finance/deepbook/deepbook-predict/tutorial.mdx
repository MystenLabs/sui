...
- [x] Node.js 22 or later, with `@mysten/deepbook-v3` 2.6.1 or later and its `@mysten/sui` 2.30.0 or later peer dependency installed. See the [Sui TypeScript SDK](https://sdk.mystenlabs.com/typescript) for client setup.
