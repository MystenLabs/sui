...
description: >-
  Learn how to use the DeepBookV3 SDK to manage balance managers and their
  capabilities.
keywords:
  - balance manager
  - balancemanager
...
goal:
  description: >-
    Developer can use the DeepBookV3 SDK to manage balance managers and their
    capabilities
  requires:
    - has_frontmatter:
        - title
...
builder_paths:
  - path_id: defi-deepbook
    ...
    step: 'SDK: Balance manager'
    stage: DeFi SDK
questions:
  - How do I use the BalanceManager SDK?
  - What is BalanceManager SDK in Sui?
  - What methods does the BalanceManager SDK provide?
answer: >-
  The `BalanceManager` is a core component of DeepBookV3 that holds all asset
  balances. The SDK provides comprehensive functions to create, manage, and
  interact with balance managers.
---
