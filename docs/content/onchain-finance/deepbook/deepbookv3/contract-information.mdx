...
description: >-
  DeepBookV3 contract addresses, supported coins, and pool information on Sui
  Mainnet.
keywords:
  - deepbook
  - deepbookv3
...
goal:
  description: >-
    Reader understands deepBookV3 contract addresses, supported coins, and pool
    information on Sui Mainnet
  requires:
    - has_frontmatter:
        - title
        - description
...
Taker and maker fees are subject to change based on governance proposals. See [Staking and Governance](/onchain-finance/deepbook/deepbookv3/contract-information/staking-governance) for more information on how the governance process adjusts fees.
