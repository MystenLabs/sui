...
Taker and maker fees are subject to change based on governance proposals. See [Staking and Governance](/onchain-finance/deepbook/deepbookv3/contract-information/staking-governance) for more information on how fees can be adjusted through the governance process.
