...
description: >-
  Reference for the DeepBookV3 pool read API: query whitelist status, estimate
  quote or base quantities with DEEP or input-token fees, check DEEP fee
  required, retrieve mid price, list open orders, and read level2 order book
  data.
keywords:
  - deepbook
  - deepbookv3
