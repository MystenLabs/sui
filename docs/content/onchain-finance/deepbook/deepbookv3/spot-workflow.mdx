...
The client references pools and coins by SDK key. Read-only calls work without a manager; all trading operations require the manager to be associated with the correct DeepBook pool.
