...
Placing orders is a main function of any DeepBook integration. Before you can place orders, though, you must first set up a balance manager. See [DeepBookV3 SDK](/onchain-finance/deepbookv3-sdk/deepbookv3-sdk) for information on setting up a balance manager.
