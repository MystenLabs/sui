...
description: >-
  A Pool is a shared object that represents a unique market pair, such as
  SUI/USDC.
keywords:
  - deepbook
  - deepbookv3
...
goal:
  description: >-
    Reader can query pool state such as orders, balances, and quantities via the
    DeepBookV3 pool read API
  requires:
    - has_frontmatter:
        - title
        - description
