...
title: DeepBookV3
description: >-
  A central limit order book that offers features and functionality for
  marketplaces on Sui. Token exchanges leveraging the layer can feature
...
goal:
  ...
  requires:
    ...
    - headings:
        - pattern: DeepBookV3 tokenomics
        - pattern: Liquidity support
        - pattern: Transparency and privacy
