...
goal:
  description: >-
    Reader understands deepBookV3 Indexer provides streamlined, real-time access
    to order book and trading data from the DeepBookV3 protocol
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Public DeepBookV3 indexer
        - pattern: Asset conversions
