...
title: Design
description: >-
  Learn about DeepBookV3 design, including the Pool, PoolRegistry, and
  BalanceManager shared objects.
keywords:
  - deepbook design
  - deepbookv3
  - deep book
...
goal:
  description: >-
    Reader can learn about DeepBookV3 design, including the Pool, PoolRegistry,
    and BalanceManager shared objects
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: 'Pool shared object \{#pool\}'
        - pattern: Place limit order flow
      label: Has expected section structure
builder_paths:
  - path_id: defi-deepbook
    path_name: DeFi / DeepBook
    step: DeepBook architecture
