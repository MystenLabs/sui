...
goal:
  description: >-
    Reader can implement use the asset tokenization packages to create
    fractional NFTs and fungible tokenized assets on Sui, with support for
    Kiosk-based transfer policies
  requires:
    - headings:
