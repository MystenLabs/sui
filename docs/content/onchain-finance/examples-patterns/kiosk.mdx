...
This reference implementation uses the [Kiosk standard](/onchain-finance/kiosk), Sui's decentralized system for commerce applications, to ensure that tokenized assets operate within their defined policy. Use the implementation as presented to have marketable tokenized assets that support rules like royalties and commissions.
