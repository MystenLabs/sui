...
goal:
  description: >-
    Reader can implement use the Sui Closed-Loop Token standard to create tokens
    that are only valid within specific workflows and services. One example of
    Closed-Loop Tokens is a loyalty token
  requires:
    - headings:
