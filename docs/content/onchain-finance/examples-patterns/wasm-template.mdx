...
goal:
  description: >-
    Reader can implement this feature was developed to enable Move bytecode
    serialization and deserialization on the web. In essence, this feature
    allows you to edit existing contracts in a web environment
  requires:
    - headings:
