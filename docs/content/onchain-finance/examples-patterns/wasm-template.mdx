...
description: >-
  Use the WASM bytecode-template library to serialize, edit, and deserialize
  Move bytecode in a web environment, enabling you to create and publish new
  asset tokenization types without recompiling Move source code.
keywords:
  - asset tokenization
  - WASM
  - bytecode template
