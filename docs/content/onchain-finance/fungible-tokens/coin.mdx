...
description: >-
  ...
  the Sui network to satisfy a number of use cases.
sidebar_label: Coin
keywords:
  - sui coin standard
  - erc-20
...
goal:
  description: >-
    Reader understands the Coin standard enables you to create a broad range of
    fungible tokens on the Sui network to satisfy a number of use cases
  requires:
    - has_frontmatter:
        - title
        - description
