...
description: >-
  Learn how to create and mint coins using the Coin standard on Sui, and manage
  fungible assets with address balances or coin objects.
keywords:
  - mint tokens
  - create tokens
  - use tokens
...
questions:
  ...
  - 'What is Create Fungible Tokens: Coin Standard in Sui?'
...
[View the full example](https://github.com/MystenLabs/sui-move-bootcamp/blob/main/I1) or learn more about the [Coin Standard](/onchain-finance/fungible-tokens/coin).
