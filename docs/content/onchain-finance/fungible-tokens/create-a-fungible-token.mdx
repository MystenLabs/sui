...
description: >-
  Learn how to create currencies using the Currency standard on Sui, including
  standard and One-Time Witness creation flows, supply model configuration, and
  regulated token setup.
keywords:
  - mint tokens
  - create tokens
  - use tokens
