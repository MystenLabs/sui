...
description: >-
  ...
  tokens on the Sui network using the centralized coin registry system, with
  support for regulated coins, supply state management, and metadata
  capabilities.
...
goal:
  description: >-
    ...
    range of fungible tokens on the Sui network
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  - path_id: p2p-payments
    ...
    stage: Tokens
questions:
  - What is Currency Standard in Sui?
  - How does currency standard work on Sui?
