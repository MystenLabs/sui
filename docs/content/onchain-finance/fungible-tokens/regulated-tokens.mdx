...
description: >-
  Create regulated currencies on Sui using the Coin Registry system with deny
...
goal:
  description: >-
    Reader can create regulated currencies on Sui using the Coin Registry system
...
builder_paths:
  - path_id: p2p-payments
    ...
    stage: Tokens
questions:
  - What is Regulated Currencies in Sui?
  - How do I create regulated currency?
  - How does regulated currencies work on Sui?
answer: >-
...
- **Global pause support:** Regulated currencies include an `allow_global_pause` Boolean field. When set to `true`, the bearer of the `DenyCapV2` object for the coin type can pause coin activity indefinitely for emergency situations.
