...
description: >-
  ...
  tokens from another blockchain to Sui, you can use the Sui Bridge, Wormhole
...
goal:
  description: >-
    Reader can bridge tokens to and from Sui using Sui Bridge and Wormhole, and
...
questions:
  - What is Bridging Tokens in Sui?
  - How does bridging tokens work on Sui?
...
Sui supports bridging through Sui Bridge, Wormhole Connect, Wormhole Portal Bridge, and ZetaChain. Each bridge offers different features and capabilities to suit various use cases. Sui Bridge is the native bridge optimized for Sui integration, while Wormhole and ZetaChain offer cross-chain alternatives.
...
To learn how to set up a Sui Bridge full node, see [Sui Bridge Validator Node Configuration](/operators/bridge-node-configuration).
