...
The vesting strategies on this page distribute tokens to specific recipients on a fixed schedule. For continuous, pro-rata reward distribution to a pool of stakers (yield farming, liquidity mining, revenue sharing), see [Staking rewards](/onchain-finance/examples-patterns/staking-rewards).