...
title: Sui Kiosk
description: >-
  Kiosk is a decentralized system for commerce applications on Sui. Kiosk is a
  part of the Sui framework, native to the system, and available to everyone.
keywords:
  - kiosk
  - sui kiosk
  - create a kiosk
...
goal:
  description: >-
    Reader understands kiosk is a decentralized system for commerce applications
    on Sui
  requires:
    - has_frontmatter:
        - title
    ...
    - headings:
        - pattern: Sui Kiosk owners
        - pattern: Sui Kiosk for buyers
        - pattern: Sui Kiosk for marketplaces
