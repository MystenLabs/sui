...
goal:
  description: >-
    Reader can open and configure a Sui Kiosk and understands its guarantees for
...
questions:
  - What is Sui Kiosk in Sui?
  - How does sui kiosk work on Sui?
  - Why should I use sui kiosk?
answer: >-
  Kiosk is a decentralized system for commerce applications on Sui. Kiosk is a
  part of the Sui framework, native to the system, and available to everyone.
---
