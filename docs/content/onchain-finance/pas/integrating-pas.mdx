...
keywords:
  ...
  - integrate with pas
goal:
  description: Reader can learn how to integrate with the PAS standard
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Define an approval witness
        - pattern: Set up a policy for a currency
        - pattern: Define approval logic
