...
goal:
  description: >-
    Reader can learn how to move assets through the Permissioned Asset Standard
    (PAS) on Sui using Accounts, Requests, and Policies
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Create Accounts
        - pattern: Transfer a balance
        - pattern: Clawback a balance
