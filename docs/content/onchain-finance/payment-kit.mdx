...
description: >-
  The Sui Payment Kit is a robust, open-source payment processing toolkit that
  provides secure payment verification, receipt management, and duplicate
  prevention for applications built on the Sui blockchain.
...
builder_paths_source:
  ...
  snapshot: '2026-07-10'
questions:
  - What is Payment Kit Standard in Sui?
  - How does payment kit standard work on Sui?
  - What are the security considerations for payment kit standard?
answer: >-
  The Sui Payment Kit is a framework for secure, flexible payment processing on
  Sui. It provides persistent and ephemeral payment options, event-driven
...
**2. Ephemeral payments**: Process one-time payments without persistent storage.
