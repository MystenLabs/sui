...
goal:
  description: >-
    Reader understands the Sui Payment Kit is a robust, open-source payment
    processing toolkit that provides secure payment verification, receipt
    management, and duplicate prevention for applications built on the Sui
    blockchain
  requires:
    - has_frontmatter:
        - title
