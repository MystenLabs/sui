...
description: >-
  Represent real-world assets as onchain fractional tokens using the
  tokenized_asset module on Sui.
keywords:
  - asset tokenization
  - fractionalization
  - NFT
...
goal:
  description: >-
    Reader understands represent real-world assets as onchain fractional tokens
    using the tokenized_asset module on Sui
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Asset Tokenization in Sui?
  - How does asset tokenization work on Sui?
  - Why should I use asset tokenization?
answer: >-
  Represent real-world assets as onchain fractional tokens using the
  tokenized_asset module on Sui.
---
