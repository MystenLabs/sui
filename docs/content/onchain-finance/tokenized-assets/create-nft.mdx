...
description: >-
  Create NFTs on Sui using the native object model, without needing a dedicated
  token standard.
keywords:
  - ERC-721
  - NFT
...
goal:
  description: >-
    Reader can create NFTs on Sui using the native object model, without needing
...
questions:
  - How do I create a non-fungible token?
  - How do I use cases?
  - What is Create a Non-Fungible Token in Sui?
answer: >-
  On Sui, every object is unique and has an owner, properties that other
