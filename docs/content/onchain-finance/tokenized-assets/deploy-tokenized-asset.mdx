...
goal:
  description: >-
    Reader can publish the asset_tokenization and template packages on Sui and
    interact with your tokenized asset using the CLI and TypeScript scripts
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Clone the repository
        - pattern: Initialize the Sui Client CLI
        - pattern: Publishing
