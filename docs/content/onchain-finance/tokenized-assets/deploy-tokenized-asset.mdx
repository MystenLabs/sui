...
The WASM feature enables Move bytecode serialization and deserialization in a browser environment, but building packages is always done relative to a build environment. For asset tokenization, this lets you create and publish new asset types directly from the browser.
