...
description: >-
  Sui provides a variety of asset standards with different features for multiple
  usage patterns.
keywords:
  - coin
  - currency
...
goal:
  description: >-
    Reader understands sui provides a variety of asset standards with different
    features for multiple usage patterns
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Types of Assets in Sui?
  - How does types of assets work on Sui?
  - Why should I use types of assets?
answer: >-
  Sui provides a variety of asset standards with different features for multiple
  usage patterns.
---
...
PAS uses Sui [Address Balances](/onchain-finance/asset-custody/address-balances/using-address-balances). PAS balances are managed by PAS on behalf of the wallet address. They are held in a derived Account object, however, transfers always target the Account address, not the wallet address.
