...
answer: >-
  ...
  onchain payments. The server issues a challenge with a unique nonce
  amount, the client pays that exact amount, and the server verifies the
  payment onchain before serving the resource.
---
