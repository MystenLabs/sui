...
- **Full node**: Stores the full chain state, answers queries and serves read requests, and submits transactions to validators. 
...
- Handling key management and operational security, and following the exchange integration guides when connecting an exchange to Sui
