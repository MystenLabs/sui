...
questions:
  - What is Sui Bridge Validator Node Configuration in Sui?
  - How do I set up sui bridge validator node configuration?
  - What are the requirements for sui bridge validator node configuration?
answer: >-
  Correct configuration of your node ensures optimal performance and valid
  metrics data.
---
...
| `metrics:push-url` | The URL of the remote Sui metrics pipeline (for example, `https://metrics-proxy.[testnet_OR_mainnet].sui.io:8443/publish/metrics`). See the [metrics push section](#metrics-push) for more details. |
