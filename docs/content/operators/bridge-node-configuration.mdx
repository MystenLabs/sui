...
goal:
  description: >-
    Operator understands correct configuration of your node ensures optimal
    performance and valid metrics data
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Committee registration
        - pattern: Update metadata \(after committee is fin
        - pattern: Bridge node
