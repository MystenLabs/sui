...
- Access to the Sui checkpoint buckets for your target network:
   ...
   - **Mainnet full-retention backfill bucket:** `gs://mysten-mainnet-checkpoints-use4` via `--remote-store-gcs mysten-mainnet-checkpoints-use4`. This bucket is Requester Pays enabled.
   - **Testnet full-retention backfill bucket:** `gs://mysten-testnet-checkpoints-use4` via `--remote-store-gcs mysten-testnet-checkpoints-use4`. This bucket is Requester Pays enabled.
