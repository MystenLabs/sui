...
| `epochs` | 83 MB |
| `packages` | Pending backfill |
| `packages_by_id` | Pending backfill |
| `packages_by_checkpoint` | Pending backfill |
| `protocol_configs` | Pending backfill |
| `system_packages` | Pending backfill |
| **Total** | **~13.3 TB** |
