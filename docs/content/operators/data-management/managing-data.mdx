...
description: >-
  A high-level description of data management on the Sui network that you can
  use to optimize your Sui full node configuration.
keywords:
  - data management
  - run data management
...
goal:
  description: >-
    Operator understands data management on Sui full nodes and can configure
...
questions:
  - How do I manage data on a Sui full node?
  - What are the pruning strategies for Sui nodes?
  - How do I reduce disk usage on a Sui full node?
answer: >-
  A high-level description of data management on the Sui network that you can
  use to optimize your Sui full node configuration.
---
...
2. **Checkpoints:** Sui groups committed transactions in checkpoints, and then uses those checkpoints to achieve state synchronization. Checkpoints keep transaction digests that contain additional integrity metadata. Sui full nodes require checkpoint data for state synchronization and cannot prune this data.
