...
goal:
  description: >-
    Operator understands a high-level description of data management on the Sui
    network that you can use to optimize your Sui
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Basic Sui full node functionality
        - pattern: Sui full node data and RPC types
        - pattern: Sui archival data
