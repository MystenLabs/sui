...
goal:
  description: >-
    Operator understands setup instructions for running the checkpoint blob
    indexer to populate a remote store with protobuf checkpoint blobs
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        ...
        - pattern: Pipelines
        - pattern: Backfill from an existing bucket
