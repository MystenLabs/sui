...
description: >-
  Update your Sui full node to the latest version to remain in sync with the
  network.
keywords: - update a full node, update a full node
  - update full node
  - update node
...
goal:
  description: >-
    Node operator understands update your Sui full node to the latest version to
...
questions:
  - How do I update a Sui full node to a new version?
  - When should I update my Sui full node?
  - How do I handle database migrations during a node update?
answer: >-
  Each Sui network is deployed on a consistent schedule. Extenuating
...
Each Sui network is deployed on a consistent schedule. Extenuating circumstances might delay releases occasionally, but these delays are rare and communicated through [official channels](#communication).
