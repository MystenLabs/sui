...
description: >-
  Set up and manage logging, tracing, metrics, and observability for Sui
...
questions:
  - 'What is Logging, Tracing, Metrics, and Observability in Sui?'
  - 'How do I set up logging, tracing, metrics, and observability?'
  - 'What are the requirements for logging, tracing, metrics, and observability?'
answer: Good observability capabilities are key to the development and growth of Sui.
---
