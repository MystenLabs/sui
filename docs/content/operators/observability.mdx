...
keywords: [observability, logging, tracing, metrics, Prometheus, monitoring]
goal:
  ...
  requires:
    ...
    - headings:
        - pattern: 'Contexts, scopes, and tracing transactio'
        - pattern: 'Key-value pairs schema \{#key-value-pair'
        - pattern: 'Logging levels \{#logging-levels\}'
