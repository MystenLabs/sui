...
goal:
  description: >-
    ...
    operators a way to bootstrap a full node without having to execute all the
    transactions that occurred after genesis
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Supported snapshot types
        - pattern: Formal snapshots
        - pattern: Restoring a full node using snapshots
