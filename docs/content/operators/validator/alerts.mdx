...
keywords: [validator, alerts, Prometheus, monitoring, full node, Alertmanager]
goal:
  description: >-
    Validator operator understands a collection of the Prometheus Alertmanager
    rules that trigger alerts and warnings on Validator and Full nodes
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: High-priority health alerts
        - pattern: Non-urgent and warning alerts
