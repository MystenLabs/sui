...
questions:
  - What Prometheus alerts should I configure for a Sui validator?
  - How do I set up Alertmanager for Sui validator monitoring?
  - What are the critical alert thresholds for Sui validators?
answer: >-
  A collection of the Prometheus Alertmanager rules that trigger alerts and
  warnings on Validator and Full nodes.
---
