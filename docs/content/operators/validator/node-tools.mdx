...
goal:
  description: >-
    Validator operator can use the Sui CLI to interact with a full node's
    validator commands
  requires:
    - has_frontmatter:
        - title
...
questions:
  - What is Validator Node Tools in Sui?
  - How do I set up validator node tools?
  - What are the requirements for validator node tools?
answer: Use the Sui CLI to interact with a full node's validator commands.
---
...
- [x] Complete all [Sui installation prerequisites](/getting-started/onboarding/sui-install).
