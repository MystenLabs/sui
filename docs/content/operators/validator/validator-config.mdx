...
goal:
  description: 'Validator operator can set up, configure, and manage a Sui validator node'
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I deployment?
  - How do I set up validator deployment and configuration?
  - What are the requirements for validator deployment and configuration?
answer: >-
  Validators on Sui run specialized validator nodes that can execute more tasks
