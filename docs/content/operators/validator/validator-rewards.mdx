...
goal:
  description: >-
    Validator operator can learn how Sui calculates and distributes validator
    and staker rewards
  requires:
    - has_frontmatter:
        - title
...
questions:
  - How do Sui validator rewards work?
  - How are staking rewards calculated on Sui?
  - What is the validator commission rate on Sui?
answer: Learn how Sui calculates and distributes validator and staker rewards.
---
