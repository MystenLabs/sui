---
title: Sui CLI
description: Sui provides command line tools to interact with the network, its features, and the Move programming language. Individual command groups and utilities are referred to as Sui Client CLI, Sui Keytool CLI, Sui Move CLI, Sui Completion CLI, and Sui Validator CLI.
keywords: [ Sui Client CLI, Sui Keytool CLI, Sui Move CLI, Sui Completion CLI, Sui Validator CLI, sui cli, update cli, sui cli commands, sui client PTB CLI, sui PTB CLI ] 
