...
<table class="w-100">
	...
	<tbody>
		...
		<tr>
			<td class="w-2/3">`sui move format`</td>
			<td class="w-1/3">Format Move source files in the current project using the `prettier-move` auto-formatter</td>
		</tr>
		<tr>
			<td class="w-2/3">`sui move format --path PATH`</td>
			<td class="w-1/3">Format Move source files from the given path</td>
		</tr>
		<tr>
