...
<a href="/doc/sui-cli-cheatsheet.pdf" target="_blank" rel="noreferrer">
...
<table class="w-100">
	...
	<tbody>
		...
		<tr>
			...
			<td class="w-1/3">
				Add a new key to Sui CLI Keystore using either the input mnemonic phrase or a Bech32 encoded
				33-byte flag || privkey starting with "suiprivkey"
			</td>
		</tr>
		<tr>
...
<table class="w-100">
	...
	<tbody>
		...
		<tr>
			...
			<td class="w-1/3">
				Create an execution trace for the Move tests in the current directory. Use with the [Move
				Trace Debugger](https://marketplace.visualstudio.com/items?itemName=mysten.move-trace-debug)
				extension.
			</td>
		</tr>
	</tbody>
