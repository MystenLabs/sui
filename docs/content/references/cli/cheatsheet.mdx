...
keywords:
  ...
  - quick reference
goal:
  description: Reader can quickly look up common Sui CLI commands grouped by task.
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What common Sui CLI commands does the cheat sheet cover?
  - How do I manage Sui addresses and aliases with the CLI?
  - 'How do I create, build, and test a Move project with the Sui CLI?'
answer: The cheat sheet highlights common Sui CLI commands.
---
...
<table class="w-100">
	...
	<tbody>
		...
		<tr>
			...
			<td class="w-1/3">List the gas coins and total SUI balance for the active address</td>
		</tr>
		<tr>
			<td class="w-2/3">`sui client gas ADDRESS`</td>
			<td class="w-1/3">List the gas coins and total SUI balance for the given address (accepts also an alias)</td>
		</tr>
		<tr>
...
<table class="w-100">
	...
	<tbody>
		...
		<tr>
			<td class="w-2/3">`sui client verify-source`</td>
