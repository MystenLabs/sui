...
questions:
  - What is Sui CLI Cheat Sheet in Sui?
  - How do I addresses and aliases?
  - 'How do I create, build, and test a move project?'
answer: Use this cheat sheet to learn common Sui CLI commands.
---
