...
<table class="w-100">
	...
	<tbody>
		...
		<tr>
			...
			<td class="w-1/3">Create an execution trace for the Move tests in the current directory. This can be used with the [Move Trace Debugger](https://marketplace.visualstudio.com/items?itemName=mysten.move-trace-debug) extension.</td>
		</tr>
	</tbody>
</table>
