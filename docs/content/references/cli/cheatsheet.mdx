...
<table class="w-100">
	...
	<tbody>
		...
		<tr> 	<td class="w-2/3">`sui keytool convert PRIVATE_KEY`</td>
		...
		<tr> 	<td class="w-2/3">`sui keytool import INPUT KEY_SCHEME`</td>
...
<table class="w-100">
	...
	<tbody>
		...
		<tr>
			<td class="w-2/3">`sui client merge-coins \`<br/>&nbsp;&nbsp;`--primary-coin COIN_ID \`<br/>&nbsp;&nbsp;`--coin-to-merge COIN_ID`</td>
