...
Use [speedscope](https://www.speedscope.app/) to inspect the file.
...
and you can hover your mouse over a bar or click a bar to see the computational power the relevant call used in relation to the rest of the call stack. Although not a one to one relationship, the percentage of use roughly translates to the percentage of total gas the call is responsible for.
