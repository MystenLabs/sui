...
In order for the profiler to be enabled, the Sui Client binary must be locally built or installed with `--features gas-profiler`.
```shell
...
and you can hover your mouse over a bar or click a bar to see the precise amount of gas consumed in nano-sui.
...
https://docs.sui.io/guides/developer/getting-started/local-network for more details. Then create a transaction that calls
