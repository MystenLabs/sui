...
If you use one of the standard public RPCs (e.g., `fullnode.testnet.sui.io:443`), you can use the `faucet` command to request for a gas coin. If you use a custom faucet service, then pass in the URL to the faucet using the `--url` option.
