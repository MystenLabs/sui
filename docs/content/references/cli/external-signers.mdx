...
questions:
  - What is Sui External Signers CLI in Sui?
  - What are the available sui external signers cli commands?
  - What flags does sui external signers cli support?
answer: Use external signers like Ledger and Yubikey with the Sui CLI.
---
