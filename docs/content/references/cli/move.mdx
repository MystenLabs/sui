...
title: Sui Move CLI
description: >-
  The Sui CLI move command provides commands for working with Move source code
  directly from a terminal or console.
keywords: - sui move, sui move
  - sui move help
  - move
  - move reference
  - move commands
  ...
  - move project cli
goal:
  description: 'Reader can look up move cli command syntax, flags, and usage examples'
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Sui Move CLI in Sui?
  - What are the available sui move cli commands?
  - What flags does sui move cli support?
answer: >-
  The Sui CLI move command provides commands for working with Move source code
  directly from a terminal or console.
---
