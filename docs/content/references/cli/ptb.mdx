...
description: >-
  The Sui Client PTB CLI enables a user to construct a PTB and execute it from
...
questions:
  - What is Sui Client PTB CLI in Sui?
  - What are the available sui client ptb cli commands?
  - What flags does sui client ptb cli support?
answer: >-
