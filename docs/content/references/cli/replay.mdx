...
Replay is a tool that allows you to replay a given transaction to view transaction effects. In addition, you can enable tracing to generate traces that can be used
for debugging via the VSCode Move Plugin.
