...
description: Use the Sui CLI `analyze-trace` command to analyze transaction trace files and produce gas profiles for understanding transaction gas consumption.
keywords:
  - sui cli
  - trace analysis
  - gas profiling
...
questions:
  - What is Sui Trace Analysis in Sui?
  - What are the available sui trace analysis commands?
  - What flags does sui trace analysis support?
answer: Use the Sui CLI to analyze transaction traces.
---
