...
description: >-
  The Sui Validator CLI is used to access the validator features of the Sui
  network.
keywords:
  - sui validator cli
  - sui validator
...
questions:
  - What is Sui Validator CLI in Sui?
  - What are the available sui validator cli commands?
  - What flags does sui validator cli support?
answer: >-
  The Sui CLI `validator` command provides command-level access to validator
