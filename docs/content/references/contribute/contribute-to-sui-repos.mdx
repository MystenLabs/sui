...
goal:
  description: >-
    Contributor understands the contribute to sui repositories requirements for
  ...
  requires:
    ...
    - headings:
        - pattern: 'Join the community \{#join-the-community'
        - pattern: 'Open issues \{#open-issues\}'
        - pattern: 'Fork Sui to contribute \{#fork-sui-contr'
