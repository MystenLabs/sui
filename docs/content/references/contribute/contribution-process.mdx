...
goal:
  description: >-
    Contributor can edit Sui docs via the GitHub web editor or a local
...
questions:
  - What is Contribute to Sui Documentation in Sui?
  - How do I set up a local environment local-environment?
  - Where can I find the contribute to sui documentation reference?
answer: >-
  Help the Sui community through documentation contributions. Whether it's to
  fix errors or add new content, the entire Sui community benefits from your
  contributions.
