...
description: >-
  Help the Sui community through documentation contributions. Whether it's to
  fix errors or add new content, the entire Sui community benefits from your
  contributions.
keywords:
  - contribute docs
...
goal:
  description: >-
    Contributor understands the contribute to sui documentation requirements for
  ...
  requires:
    ...
    - headings:
        - pattern: Follow the style guide
        - pattern: GitHub web editor
        - pattern: 'Set up a local environment \{#local-envi'
