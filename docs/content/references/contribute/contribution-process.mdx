...
1. Submit a PR to the main Sui repository.  
...
1. Reviewers will provide feedback. It’s your responsibility to update your PR based on their comments. Multiple reviewers may give input.  
1. Once at least one reviewer approves your PR, it will be merged into `main`, and your contribution will go live. Changes will be reflected on the live website within 5-10 minutes after the PR has been merged into `main`. 
