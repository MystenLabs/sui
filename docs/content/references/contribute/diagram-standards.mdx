...
Use Black, Gray 500, and Sui Blue 500 to encode emphasis level: Black for primary elements, Gray 500 for secondary elements, and Sui Blue 500 for tertiary elements and all arrows. If more than 3 fill colors are required to maintain clarity, expand into the Gray extended palette first, then the Blue extended palette. See the extended palette at [https://live.standards.site/sui-media-kit/sui-color](https://live.standards.site/sui-media-kit/sui-color).
...
Use Black, Gray 500, and Sui Blue 500 to encode emphasis level across all elements:
...
All arrows use Sui Blue 500 as the stroke color. The table below defines the 3 arrow styles and their C4 relationship types.
...
- Prefer white text on Black (`#000000`) or Gray 500 (`#6C7584`) fills. Avoid white text on Sui Blue 500 for normal-size text because the contrast ratio of 3.31:1 fails AA for normal text.
