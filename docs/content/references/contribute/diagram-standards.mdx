...
questions:
  - What is Technical Diagram Standards in Sui?
  - Where can I find the technical diagram standards reference?
  - How does technical diagram standards work on Sui?
answer: >-
  Standards and guidelines for creating technical diagrams in Sui documentation,
  including the C4 model, brand style, tooling, diagram types, and export
  requirements.
...
- Every pull request that adds or updates a diagram must include an editable source file alongside the exported PNG, except for Mermaid diagrams which use inline code blocks.
