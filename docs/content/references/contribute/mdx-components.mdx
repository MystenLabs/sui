...
keywords: [MDX, components, documentation, frontmatter, Docusaurus, contributing]
goal:
  description: >-
    Contributor understands the mdx components requirements for the Sui
    documentation
  requires:
    - has_frontmatter:
        - title
    ...
    - headings:
        - pattern: Custom frontmatter
        - pattern: '`UnsafeLink`'
        - pattern: Custom admonition boxes
