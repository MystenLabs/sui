...
- **Avoid redefining common words.**  
  Don't give familiar words new or unexpected meanings (for example, don't use "object" to mean something other than its standard technical or everyday sense). This prevents confusion, especially for new readers.  
...
- **Avoid jargon and slang.**  
  Don't assume readers understand informal expressions, company-specific shorthand, or unnecessary buzzwords. Use precise terms instead.  
...
- Sui CLI
- Sui Client PTB CLI
- Sui Closed-Loop Token or Closed-Loop Token
- Sui dApp Kit
- Sui Explorer
- SuiJSON
- Sui Keystore
...
- SUI token
- Testnet
- Wallet standard: Used when referring specifically to the Sui Wallet standard.
- Web2
- Web3
- zkSend SDK
...
- Sui object
- validator node
- wallet: Used when referring to the general concept of wallets.
...
Don't all uppercase for emphasis, use bold instead. 

> Example: IMPORTANT vs **Important**

Don't use bi-capitalization or internal capitalization unless it is part of a brand.
...
Avoid using italic text in favor of bold text 
...
Use for related items that don't need order. Use sentence capitalization and consistent punctuation. Add periods only if the item is a full sentence.
...
Use list with inline code formatting to list attributes for components such as objects
...
> Example: There are few details to take note of in this code:
...
Don't nest collapsible components inside one another. Limit collapsible content to material that supplements (not replaces) the visible text.  
...
Use info alerts to provide important but neutral context that readers should be aware of. It's less about best practices and more about ensuring readers don't miss critical background or conditions.  
