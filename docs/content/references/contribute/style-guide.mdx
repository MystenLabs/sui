...
Every sidebar category must have a corresponding index page when the category uses `link`. This applies to all levels of the documentation hierarchy, including nested categories.
