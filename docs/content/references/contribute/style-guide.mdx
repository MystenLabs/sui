...
goal:
  description: >-
    Contributor understands the style guide requirements for the Sui
    documentation
  requires:
    - has_frontmatter:
        - title
...
questions:
  - What is Style Guide in Sui?
  - Where can I find the style guide reference?
  - How does style guide work on Sui?
answer: All contributions to the Sui documentation must adhere to the style guide.
---
...
> Before you install Sui, make sure to install the [prerequisites](/getting-started/onboarding/sui-install).
...
Every sidebar category must have a corresponding index page when the category uses `link.type: 'category'`. This applies to all levels of the documentation hierarchy, including nested categories.
