...
description: >-
  Get the background information you need before you start developing on Sui.
  Learn the layout of the Sui monorepository and the suggested development
  environment for working with Move.
keywords:
  - setup environment
...
goal:
  description: >-
    Contributor understands the environment setup requirements for the Sui
    documentation
  requires:
    - has_frontmatter:
        - title
...
questions:
  - What is Sui Environment Setup in Sui?
  - Where can I find the sui environment setup reference?
  - How does sui environment setup work on Sui?
answer: >-
  Before you start developing with Sui and Move, you should familiarize yourself
  with how to contribute to Sui, how Sui is structured, what tools and SDKs
  exist, and what plugins are available to use in your IDE.
---
