...
The JSON-RPC API used in some examples in this guide is deprecated. For new integrations, use the gRPC or GraphQL APIs. See the [Sui API documentation](/references/sui-api) for migration guidance.
