...
title: Sui Framework
description: >-
  The Sui framework documentation is generated from source code comments using
  the Rust `cargo doc` process. This section covers the bridge, std, sui, and
  sui_system libraries, with links to source code and instructions for building
  the docs locally.
keywords:
  - sui framework
  - sui libraries
...
questions:
  - What is Sui Framework in Sui?
  - How do I build documentation locally?
  - Where can I find the sui framework reference?
answer: >-
