...
[Sui Full node gRPC API](../references/fullnode-protocol.mdx) will replace the JSON-RPC on Full nodes, such that JSON-RPC will be deprecated when gRPC API is generally available.
