...
Syntax highlighting is provided by the [Move Syntax](https://marketplace.visualstudio.com/items?itemName=damirka.move-syntax) extension.
...
The move extension will attempt to autocomplete upon a dot operator, displaying the available methods and fields for the type.
...
The move extension supports go-to-definition for all Move symbols including types, functions, and macros, as long as the type was present when move-analyzer last built the file.
