...
description: >-
  Learn how to use Display V2 format strings to render Sui Move object values
  into human-readable strings, JSON, or encoded representations.
keywords:
  - display
  - template
  - format string
...
goal:
  description: >-
    Reader can use Display V2 format strings to render Sui Move object values
    into human-readable strings, JSON
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Object Display V2 Syntax in Sui?
  - Where can I find the object display v2 syntax reference?
  - How does object display v2 syntax work on Sui?
answer: >-
  Display V2 is a template language for rendering Sui Move object values into
  human-readable strings, JSON, or encoded representations.
---
