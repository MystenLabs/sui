...
description: Reference for Move.toml manifest syntax, fields, and configuration options, including package, dependencies, environments, and dep-replacements sections.
keywords:
  - move
  - move reference
  - package management
