...
With any change of this magnatude there are bound to be some issues that crop up. Please report any issues you encounter while using the new package system [here](https://github.com/MystenLabs/sui/issues/24540).
...
The new implementation is a solid foundation for future features that we're planning, including improved source verification and on-chain dependencies.

## Installing and running the new package manager

The new package system will be included in the 1.63 release of the Sui CLI, which will be released in January. However, you can install it before then using [`suiup`](https://github.com/MystenLabs/suiup):
