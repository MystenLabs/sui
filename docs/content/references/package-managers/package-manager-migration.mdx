...
description: >-
  Understand the changes introduced in Sui CLI v1.63's package management
  overhaul and follow step-by-step guidance to migrate your Move.toml files,
  dependency names, and publishing workflows to the new system.
keywords:
  - move
  - move reference
  - package management
...
goal:
  description: >-
    Reader can look up package management migration syntax and configuration
    options
  requires:
    - has_frontmatter:
        - title
...
questions:
  - What is Package Management Migration in Sui?
  - How do I publish on devnet and localnet?
  - Where can I find the package management migration reference?
answer: >-
  Understand the changes introduced in Sui CLI v1.63's package management
  overhaul and follow step-by-step guidance to migrate your Move.toml files,
  dependency names, and publishing workflows to the new system.
...
You must define a dependency for every package that you directly use in your source code. The name you use in `Move.toml` for the dependency is what defines the name in your Move code. The name you use in the `[package]` section is how you refer to your own address in Move.
