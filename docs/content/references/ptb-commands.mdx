...
title: PTB Commands
description: >-
  Reference for all PTB commands — TransferObjects, SplitCoins, MergeCoins,
  MakeMoveVec, MoveCall, Publish, and Upgrade — including each command's form,
  arguments, return type, and conceptual Move signature.
keywords:
...
questions:
  - What is PTB Commands in Sui?
  - Where can I find the ptb commands reference?
  - How does ptb commands work on Sui?
answer: >-
