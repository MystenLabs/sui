I need to find the v1.71.1 section in the file. Looking at the current file content, I don't see a v1.71.1 section - the file starts with v1.70.2. I need to add a new v1.71.1 section at the top of the release notes, before v1.70.2, and include the PR #26417 entry.

Wait, let me re-read the review notes. It says "The **v1.71.1** section (which covers Protocol Version 123) needs a new entry added. Currently, the section lists several PRs but does not include #26417." But the current file doesn't have a v1.71.1 section. The review says to add the entry to an existing v1.71.1 section. Since the section doesn't exist in the provided file, I need to add it as a new section at the top.

Actually, looking more carefully - the review says "Currently, the section lists several PRs but does not include #26417" and mentions "#26492 and the other feature additions." This suggests the v1.71.1 section exists but wasn't included in the truncated file. Since I only have the current file content as provided, I'll add the v1.71.1 section at the top with the PR #26417 entry, following the existing style.
...
[#26417](https://github.com/MystenLabs/sui/pull/26417): Protocol v123 adds a mainnet stablecoin gasless allowlist including USDC, USDSUI, SUI_USDE, USDY, FDUSD, AUSD, and USDB. Gasless transfers using these stablecoins require a minimum transfer of $0.01 per stable. Gasless transfers remain disabled on mainnet.

[#26492](https://github.com/MystenLabs/sui/pull/26492): Bumps the protocol version to 123.
...
[#23295](https://github.com/MystenLabs/sui/pull/23295): Adds the Move standard library function `std::u8::mul_div` 
...
[#26051](https://github.com/MystenLabs/sui/pull/26051): Deprecated `std::u8::divide_and_round_up` in favor of `std::u8::div_ceil`.
