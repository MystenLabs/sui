...
description: >-
  Research papers that are relevant to Sui and that one or more Sui team members
  have co-authored.
keywords:
  - research papers
  - sui papers
...
goal:
  description: >-
    Reader can look up Sui-relevant research papers co-authored by Sui team
    members
  requires:
    - has_frontmatter:
        - title
...
questions:
  - What is Sui-Related Research Papers in Sui?
  - Where can I find the sui-related research papers reference?
  - How does sui-related research papers work on Sui?
answer: >-
  Research papers that are relevant to Sui and that one or more Sui team members
  have co-authored.
---
...
- **Relevance:** Provides a performant leader election algorithm for partially-synchronous consensus protocols such as Bullshark. This work informed earlier designs for shared object support in Sui before the adoption of Mysticeti.
...
- **Relevance:** Provides a partially-synchronous consensus protocol running over Narwhal. Bullshark was a predecessor to Mysticeti and informed the consensus design of Sui before Mysticeti was adopted.
...
- **Relevance:** Narwhal and Tusk provided the foundational DAG-based mempool and consensus design that informed earlier versions of Sui's shared-object support. Sui now uses Mysticeti as its consensus protocol.
