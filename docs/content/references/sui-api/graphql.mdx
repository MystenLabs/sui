---
title: Overview
description: GraphQL Reference page overview
---

The Sui GraphQL RPC is a public good that enables interacting with the Sui [network](https://sui.io/networkinfo).
