...
For more details on how to query the service, please check out the [interacting with the service](./guides.mdx#interacting-with-the-graphql-service) guidelines.
