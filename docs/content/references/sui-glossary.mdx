...
A validator in Sui plays a passive role analogous to the more active role of validators and miners in other blockchains. In Sui, validators do not continuously participate in the consensus protocol but are called into action only when receiving a transaction or
certificate.
