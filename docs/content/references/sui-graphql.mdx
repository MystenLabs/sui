...
To get started with GraphQL for the Sui RPC, check out the [Getting Started](/guides/developer/advanced/graphql-rpc) guide. If you'd like to learn more about the concepts used in the GraphQL service, check out the [GraphQL](/concepts/data-access/graphql-rpc.mdx) for Sui RPC concepts page.
