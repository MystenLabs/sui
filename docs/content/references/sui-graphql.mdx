...
To get started with GraphQL for the Sui RPC, check out the [Getting Started](/concepts/data-access/graphql-rpc) guide. If you'd like to learn more about the concepts used in the GraphQL service, check out the [GraphQL](/concepts/data-access/graphql-rpc.mdx) for Sui RPC concepts page. If you'd like to view the reference documentation, check out the [schema](./sui-api/sui-graphql/beta/reference).
...
- <UnsafeLink href="/references/sui-api/sui-graphql/alpha/reference/types/objects/object">Object</UnsafeLink> is the type representing all onchain objects (Move values and packages).
