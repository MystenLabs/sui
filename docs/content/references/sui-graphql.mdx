...
- <UnsafeLink href="/references/sui-api/sui-graphql/reference/types/objects/owner">Owner</UnsafeLink> represents any entity that can own a <UnsafeLink href="/references/sui-api/sui-graphql/reference/types/objects/move-object">MoveObject</UnsafeLink> to handle cases where it is not known whether the owner is an <UnsafeLink href="/references/sui-api/sui-graphql/reference/types/objects/object">Object</UnsafeLink> or an <UnsafeLink href="/references/sui-api/sui-graphql/reference/types/objects/address">Address</UnsafeLink> (for example, from the perspective of a Move object looking at its owner).
