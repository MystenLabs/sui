...
description: Move references for Sui, including auto-generated framework documentation from the sui move summary command, the Sui Framework, The Move Book, and The Move Reference.
keywords:
  - move
  - move reference
  - move book
...
goal:
  description: >-
    Reader can find links to Move language references, the Move Book, and Sui
    framework docs
  requires:
    - has_frontmatter:
        - title
...
questions:
  - What is Move References in Sui?
  - Where can I find the move references reference?
  - How does move references work on Sui?
