...
description: >-
  Collection of SDKs and utilities for developing on Sui using various
...
goal:
  description: >-
    Reader can look up collection of SDKs and utilities for developing on Sui
...
questions:
  - What is Sui and Community SDKs in Sui?
  - Where can I find the sui and community sdks reference?
  - How does sui and community sdks work on Sui?
answer: >-
  Sui provides developer kits that act as wrappers for the Sui API. The Sui
  community broadens the code coverage with its own set of developer kits
  targeting the Sui blockchain.
---
...
`sui-rust-sdk` does not support JSON RPC, and the [legacy Rust SDK](/references/rust-sdk) no longer includes a JSON RPC client. Use gRPC or GraphQL from Rust.
...
<Card title="Legacy Rust SDK" href="/references/rust-sdk">
    The wallet and client configuration crate used by the Sui CLI. It no longer includes a JSON RPC client.
</Card>
