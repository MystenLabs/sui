...
`sui-rust-sdk` does not support JSON RPC. If you need JSON RPC access, use the [legacy Rust SDK](https://github.com/MystenLabs/sui/tree/main/crates/sui-sdk). It is forward and backward compatible.
