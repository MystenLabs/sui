...
goal:
  description: >-
    Reader can look up how the tokenized_asset module represents real-world
    assets as onchain fractional tokens
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I tokenize assets using the TypeScript SDK?
  - What is the Sui asset tokenization template?
  - How do I create fractional NFTs on Sui?
answer: >-
  The `tokenized_asset` module operates in a manner similar to the `coin`
  library.
---
...
- `transfer_policy`
  ...
  ```move
  public(package) fun transfer_policy<T>(
