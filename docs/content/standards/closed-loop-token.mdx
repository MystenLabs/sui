...
The [Currency Standard](/standards/currency.mdx) on Sui is an example of an open-loop system. Coins are free-flowing, [wrappable](/guides/developer/objects/object-ownership/wrapped.mdx), [freely transferable](/guides/developer/objects/transfers/custom-rules.mdx) and you can store them in any application. 
