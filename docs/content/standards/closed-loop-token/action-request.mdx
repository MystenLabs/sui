...
description: Tokens do not allow transfers, conversions, or spends by default. To allow these actions, an `ActionRequest` must be used. 
keywords: [action request, protected actions, action, request, from_coin, to_coin, transfer, spend, ]
---
