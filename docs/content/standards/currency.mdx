...
- **Uncontrolled supply:** Traditional model where the `TreasuryCap` holder controls minting and burning.
...
- **One-Time Witness (OTW) creation:**
    ...
    The `new_currency_with_otw` function uses an OTW for uniqueness proof. See The Move Book for more information on [OTWs](https://move-book.com/programmability/one-time-witness).
