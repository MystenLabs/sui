...
:::caution Warning Zone: Risk Ratio 1.1 - 1.2
When your risk ratio falls between 1.1 and 1.2, you are in the **warning zone**. At this level, even minor price movements can push you into liquidation. Monitor your position carefully and consider adding collateral or reducing your position size.
:::

### Partial liquidation

Liquidation in DeepBook Margin is **partial**, not total. The protocol only liquidates enough of your position to restore your risk ratio to the **Target Liquidation Risk Ratio** (typically 1.25 for SUI/USDC).
...
4. Your position is restored to the target risk ratio of 1.25
5. You keep the remaining position, but with less equity

This means if you're liquidated at a 1.1 risk ratio, you won't lose your entire position. The liquidator repays just enough debt to bring your ratio back to 1.25, leaving you with a smaller but healthier position.
...
- You borrow **400 USDC** worth of SUI at a SUI price of 1.50 USDC, receiving approximately 267 SUI
- Your position: 100 USDC collateral + 267 SUI worth 400 USDC
...
- You lose approximately **22 USDC** of your original 100 USDC collateral
...
- **Price delays:** Oracle prices may lag behind real market prices during extremely volatile periods. The protocol mitigates this by rejecting prices older than 60 seconds, but brief delays within this window can still occur.
...
- **Staleness protection:** Prices older than 60 seconds are automatically rejected, preventing liquidations based on stale data
