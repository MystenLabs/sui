...
description: The `Pool` structure is a hyper-efficient shared object that uses the Sui Mysticeti consensus engine.
keywords: [ pool structure, deepbook pool, Mysticeti, consensus ]
---
