...
description: The DeepBookV3 SDK allows for direct interactions with the `DeepBook` package.
keywords: [ TypeScript SDK, DeepBook, mysten/deepbook, balance manager, BalanceManager, DEEP ]
---
