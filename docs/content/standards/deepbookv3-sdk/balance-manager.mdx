...
The `BalanceManager` is a core component of DeepBookV3 that holds all balances for different assets. The SDK provides comprehensive functions to create, manage, and interact with balance managers.
