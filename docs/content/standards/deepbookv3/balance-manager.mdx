...
```move reference 
https://github.com/MystenLabs/deepbookv3/blob/master/packages/deepbook/sources/balance_manager.move#L76-L90
```
...
```move reference 
https://github.com/MystenLabs/deepbookv3/blob/master/packages/deepbook/sources/balance_manager.move#L92-L95
```
...
```move reference 
https://github.com/MystenLabs/deepbookv3/blob/master/packages/deepbook/sources/balance_manager.move#L137-L141
```
...
```move reference 
https://github.com/MystenLabs/deepbookv3/blob/master/packages/deepbook/sources/balance_manager.move#L143-L156
```
...
```move reference 
https://github.com/MystenLabs/deepbookv3/blob/master/packages/deepbook/sources/balance_manager.move#L171-L198
```
...
```move reference 
https://github.com/MystenLabs/deepbookv3/blob/master/packages/deepbook/sources/balance_manager.move#L200-L210
```
...
```move reference 
https://github.com/MystenLabs/deepbookv3/blob/master/packages/deepbook/sources/balance_manager.move#L250-L267
```
...
```move reference 
https://github.com/MystenLabs/deepbookv3/blob/master/packages/deepbook/sources/balance_manager.move#L212-L227
```
...
```move reference 
https://github.com/MystenLabs/deepbookv3/blob/master/packages/deepbook/sources/balance_manager.move#L229-L248
```

### Read endpoints

```move reference 
https://github.com/MystenLabs/deepbookv3/blob/master/packages/deepbook/sources/balance_manager.move#L447-L461
```
