...
<details>
<summary>Balance Manager</summary>

Manage your trading balances and deposits across DeepBook pools. See [Balance Manager](./balance-manager.mdx).
...
Place limit orders, market orders, and manage your order book positions. See [Orders](./orders.mdx).
...
Execute atomic flash loans for arbitrage and other DeFi strategies. See [Flash Loans](./flash-loans.mdx).
...
Perform instant token swaps through DeepBook liquidity. See [Swaps](./swaps.mdx).

</details>

<details>
<summary>Query the Pool</summary>

Read pool state, order book depth, and trading data. See [Query the Pool](./query-the-pool.mdx).

</details>

<details>
<summary>Staking and Governance</summary>

Stake DEEP tokens to participate in governance and earn fee discounts. See [Staking and Governance](./staking-governance.mdx).
...
Earn referral rewards by inviting traders to DeepBook. See [Referral](./referral.mdx).

</details>

<details>
<summary>Permissionless Pool</summary>

Create and manage your own trading pools. See [Permissionless Pool](./permissionless-pool.mdx).
...
Learn about the Exponentially Weighted Moving Average price oracle. See [EWMA](./ewma.mdx).
