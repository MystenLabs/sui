...
Decimal desired should be at most 1bps, or 0.01%, of the price between base and quote asset. For example, if 4 decimals is the target, 0.0001 / price should be less than or equal to 0.0001. Please consider a lower tick size for pools where both base and quote assets are stablecoins.
