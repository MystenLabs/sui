...
```move reference 
https://github.com/MystenLabs/deepbookv3/blob/master/packages/deepbook/sources/pool.move#fun=swap_exact_base_for_quote noComments}
...
```move reference 
https://github.com/MystenLabs/deepbookv3/blob/master/packages/deepbook/sources/pool.move#fun=swap_exact_quote_for_base noComments}
...
```move reference 
https://github.com/MystenLabs/deepbookv3/blob/master/packages/deepbook/sources/pool.move#fun=swap_exact_quantity noComments}
