...
<p class="flex justify-center">![Unrestricted asset ownership without PAS](./images/unrestricted-ownership.svg)</p>

**With PAS**

<p class="flex justify-center">![Restricted asset ownership with PAS](./images/restricted-ownership.svg)</p>
