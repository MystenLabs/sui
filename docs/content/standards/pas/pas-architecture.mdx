...
<img src="/standards/pas/images/unrestricted-ownership.svg" alt="Unrestricted asset ownership without PAS" style={{display: 'block', margin: '0 auto'}} />

**With PAS**

<img src="/standards/pas/images/restricted-ownership.svg" alt="Restricted asset ownership with PAS" style={{display: 'block', margin: '0 auto'}} />
