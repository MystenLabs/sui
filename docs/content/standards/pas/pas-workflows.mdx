...
Deposits are permissionless (anyone can deposit into any Chest). Withdrawals are internal (`public(package)`). Only PAS modules can withdraw, and only through Requests.
