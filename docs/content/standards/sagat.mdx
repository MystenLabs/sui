...
To takea control and use Sagat in a trustless manner, you can self host it. To do so, first download the Github repository:
...
Through the Sagat [web interface](https://sagat.mystenlabs.com/) you can use the signature analyzer and transaction signer tools to:
