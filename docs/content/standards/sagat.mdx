...
Sagat relies on the Sui infrastructure for its API layer, meaning you do not have full confidentiality of what you are signing. 

The application's frontend is also hosted through Sui services, which you must rely on to be secure. Always validate a transaction's preview in a secondary location, such as through your wallet, not just from the web interface.
...
First, connect your [Slush](https://slush.app/) or [Suilet](https://suiet.app/) wallet to the Sagat web interface:
...
Once a transaction has been signed, you can share a link to the transaction to others who can view and sign it. 
