...
- **Loyalty Points** - A token that can only be used for a specific service, e.g. for a specific airline, and granted to customers for their actions or purchases.
