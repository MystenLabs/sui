...
Similar to the connect (account authorization) feature, the Wallet Standard also includes `standard:disconnect` to revoke a app's access to wallet accounts. The following example calls this feature:
