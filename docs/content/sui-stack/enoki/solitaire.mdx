...
title: Solitaire
description: >-
  Play solitaire onchain where every card shuffle uses Sui's Random module and
...
goal:
  description: >-
    Reader understands play solitaire onchain where every card shuffle uses
    Sui's Random module and every move is a sponsored transaction verified on
    the blockchain and knows when to use it
  requires:
    - has_frontmatter:
        - title
        - description
