...
description: >-
  Build a decentralized ticketing and loyalty platform on Sui with NFT tickets,
  cryptographic mint permits, stage-based lifecycle transitions, and gasless
  transactions.
keywords:
  - example
  - ticketing
...
goal:
  description: >-
    Reader can build a decentralized ticketing and loyalty platform on Sui with
    NFT tickets, cryptographic mint permits
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I build a ticketing platform on Sui with Enoki?
  - What does the Enoki ticketing example demonstrate?
  - How do I use sponsored transactions for gasless ticket minting?
answer: >-
  Build a decentralized ticketing and loyalty platform on Sui with NFT tickets,
  cryptographic mint permits, stage-based lifecycle transitions, and gasless
  transactions.
