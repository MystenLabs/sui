---
title: Messaging SDK
description: Build end-to-end encrypted group messaging on Sui using Seal threshold encryption, a Walrus-backed relayer, and onchain permission management.
keywords: [messaging, sui-stack-messaging, encryption, seal, walrus, relayer, groups, permissions, e2e]
---
