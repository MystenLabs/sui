...
goal:
  description: >-
    Reader understands what the Messaging SDK provides and can navigate to guides covering its Move package, TypeScript client, Rust relayer, and discovery indexer
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Messaging SDK in Sui?
  - What topics does Messaging SDK cover?
  - How does messaging sdk work on Sui?
answer: >-
  Build end-to-end encrypted group messaging on Sui using Seal threshold
  encryption, a Walrus-backed relayer, and onchain permission management.
---
