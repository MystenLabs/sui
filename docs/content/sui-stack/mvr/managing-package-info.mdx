...
<Tabs groupId='language'>
  ...
  arguments: [
  transaction.pure.string('<Your git repository, for example `https://github.com/mystenlabs/mvr`>'),
  ...
  "\"<Your git repository, for example https://github.com/mystenlabs/mvr>\"" \
