...
Additionally, MVR can help you manage package versioning. With MVR, you call a specific version of a package without having to resolve the addresses yourself. You also do not need to worry about manually resolving addresses, because MVR handles the resolution automatically regardless of network.
