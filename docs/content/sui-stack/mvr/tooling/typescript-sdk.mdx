...
questions:
  ...
  - How do I register the MVR plugin for the Sui TypeScript SDK?
...
answer: >-
  ...
  @mysten/mvr-static plugin for build-time resolution.
---
...
The MVR plugin is exported directly from the `@mysten/sui` package. To enable the plugin, register it either globally or per PTB in your app.
