...
description: >-
  Access network-based time for your transactions. Sui provides a Clock module
  to capture near-real time or epoch time in your Sui packages.
keywords:
  - network-based time
  - onchain time
  - onchain time
...
goal:
  description: >-
    Reader understands access network-based time for your transactions. Sui
    provides a Clock module to capture near-real time or epoch time in your Sui
    packages and knows when to use it
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: 'The `sui::clock::Clock` module'
        - pattern: Epoch timestamps
