...
title: Sagat
description: >-
  Sagat is a multisig management platform designed for managing Sui multisig
  wallets.
keywords:
  - multisig
  - multi-signature
...
goal:
  description: >-
    Reader understands sagat is a multisig management platform designed for
    managing Sui multisig wallets and knows when to use it
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Sagat in Sui?
  - What is multisig?
  - How does sagat work on Sui?
answer: >-
  [Sagat](https://github.com/MystenLabs/sagat/tree/main) is a full-stack
  multisig management platform for Sui multisig wallets. It is built using Bun
  and a TypeScript API for the backend and React for the frontend.
---
...
[Multisig](/develop/transactions/transaction-auth/multisig) is a type of authentication that requires multiple signatures from different parties before a transaction can be executed. Several addresses can be invited to a multisig group. On Sagat, invited parties can accept or reject multisig invitations after the multisig is created.
