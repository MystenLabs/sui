...
goal:
  description: >-
    Reader can learn how to encrypt Walrus blobs and enforce onchain access
    control using Seal, by walking through OnlyFins
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Tooling
        - pattern: Access control management
        - pattern: Encrypting
