...
answer: >-
  Install the SuiNS SDK and its @mysten/sui peer dependency with npm i
  @mysten/suins @mysten/sui, then initialize a SuinsClient with either a network
  name or explicit package constants to query name records and build
  transactions.
---
