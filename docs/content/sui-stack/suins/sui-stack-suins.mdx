...
goal:
  description: >-
    ...
    offchain resolution, reverse lookup, subnames, and the Enoki subname API, by
    walking through Sui Messenger
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Introduction to SuiNS
        - pattern: Resolution types
        - pattern: Address types
