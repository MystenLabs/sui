...
Use [programmable transaction blocks (PTBs)](/develop/transactions/ptbs/building-ptb) to group multiple operations into a single transaction. This reduces the number of times a player must approve an action and lowers the total gas cost.
