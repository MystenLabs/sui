...
The Playtron wallet supports Enoki Connect out of the box, making it portable across apps: other applications, such as those that integrate the Sui dApp Kit, can choose to allow users to connect through this wallet.
