...
goal:
  description: >-
    Reader understands suiPlay0X1 is part of the Sui gaming ecosystem. Users can
    migrate accounts between on-device and off-device versions of a game and
  ...
  requires:
    ...
    - headings:
        - pattern: On-device ⇒ off-device
        - pattern: Off-device ⇒ on-device
