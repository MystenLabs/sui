...
goal:
  description: >-
    ...
    solutions, including self-custodial wallets, zkLogin wallets, Playtron
    wallets, and custodial wallets and knows when to use it
  requires:
    - has_frontmatter:
        - title
        - description
    ...
    - headings:
        - pattern: Selecting the optimal wallet integration
        - pattern: Requirements
        - pattern: Wallet strategies
