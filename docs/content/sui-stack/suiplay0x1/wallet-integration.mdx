...
description: >-
  SuiPlay0X1 supports integration with several wallet solutions, including
...
goal:
  description: >-
    Reader understands suiPlay0X1 supports integration with several wallet
...
questions:
  - What is Wallet Integration Options in Sui?
  - How does wallet integration options work on Sui?
  - Why should I use wallet integration options?
answer: >-
  You have several options for what wallet you develop for on the SuiPlay0X1.
...
- Unlike custodial wallets, users still need to pay for gas. You can always [sponsor transactions](/develop/transaction-payment/sponsor-txn) instead to assume this responsibility.
...
Enoki Connect is not required for SuiPlay integration. In other words, your game wallet doesn't need to use Enoki Connect to support basic game-specific functionality, but you should use it if you want the additional benefits of ecosystem portability. The Playtron wallet uses Enoki Connect, which allows it to connect to third-party apps if they enable support for the wallet.
