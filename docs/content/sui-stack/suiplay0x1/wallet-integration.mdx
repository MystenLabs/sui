...
Enoki Connect is not required for SuiPlay integration. In other words, your game wallet doesn't need to upgrade to Enoki Connect unless you want the additional benefits of portability. The Playtron wallet uses Enoki Connect, which allows it to connect to third-party apps if they enable support for the wallet.
