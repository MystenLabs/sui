...
<CodeWalkthrough source="frontend/move/posts/sources/posts.move" org="MystenLabs" repo="onlyfins-example-app" language="move">
  <Step lines="25-41" title="Post creation with optional encryption">
  ...
  <Step lines="43-48" title="Granting access with viewer tokens">
  ...
  <Step lines="50-67" title="Seal access control gate">
