...
description: >-
  ...
  site-builder CLI, with configuration, custom headers, and SuiNS domain names.
keywords:
  - walrus sites
  - site-builder
  - static site
...
goal:
  description: >-
    Reader can learn how to deploy and manage static websites on Walrus using
    the site-builder CLI, with configuration, custom headers, and SuiNS domain
    names
  requires:
    - has_frontmatter:
        - title
    ...
    - headings:
        - pattern: Introduction to Walrus Sites
        - pattern: Tooling
        - pattern: Restrictions and limitations
