...
- [x] [Sui CLI](/guides/developer/getting-started/sui-install) installed
...
For the step-by-step process of registering a name and linking it to your site object ID, see [Setting a SuiNS Name](https://docs.wal.app/docs/sites/custom-domains/setting-a-suins-name) in the Walrus documentation. For a complete walkthrough of SuiNS integration, including resolution, reverse lookup, and subnames, see [Domain Names with SuiNS](/sui-stack/sui-stack-suins).
