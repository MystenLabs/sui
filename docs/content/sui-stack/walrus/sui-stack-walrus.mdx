...
description: >-
  Learn how to store and retrieve data on Walrus by walking through OnlyFins, a
  content platform built on Sui and Walrus.
keywords:
  - walrus
  - blob storage
  - walrus SDK
...
goal:
  description: >-
    Reader can store and retrieve data on Walrus by walking through OnlyFins, a
    content platform built on Sui and Walrus
  requires:
    - has_frontmatter:
        - title
...
builder_paths:
  - path_id: walrus-general
    ...
    step: Walrus concepts
    stage: Environment
    eval: covered
  - path_id: walrus-general
    path_name: Walrus General Data Storage
    step: 'Storage resource, epochs & lifetime'
    stage: Environment
    eval: covered
  - path_id: walrus-general
    path_name: Walrus General Data Storage
  ...
  - path_id: walrus-general
    path_name: Walrus General Data Storage
    step: Verify availability & integrity
    stage: Read & Verify
    eval: covered
  - path_id: walrus-general
    path_name: Walrus General Data Storage
    step: Integrate into app
    stage: Ship
    eval: covered
  - path_id: walrus-general
    path_name: Walrus General Data Storage
    step: Manage lifecycle
    stage: Ship
    eval: covered
  - path_id: walrus-agentic
    path_name: Walrus Agentic Data Storage
    step: Object model for agent blobs
    stage: Environment
    eval: covered
  - path_id: walrus-agentic
    path_name: Walrus Agentic Data Storage
    step: Storage resource & payment
    stage: Environment
    eval: covered
  - path_id: walrus-agentic
    path_name: Walrus Agentic Data Storage
    step: Programmatic store via SDK
    stage: Agent Write
    eval: covered
  - path_id: walrus-agentic
    path_name: Walrus Agentic Data Storage
    step: Batch small blobs (Quilt)
    stage: Agent Write
    eval: covered
  - path_id: walrus-agentic
    path_name: Walrus Agentic Data Storage
    step: Content addressing & metadata/tags
    stage: Agent Write
    eval: covered
  - path_id: walrus-agentic
    path_name: Walrus Agentic Data Storage
    step: Verify availability before acting
    stage: Verify & Secure
    eval: covered
  - path_id: walrus-agentic
    path_name: Walrus Agentic Data Storage
    step: Versioned datasets/immutable lineage
    stage: Verify & Secure
    eval: covered
builder_paths_source:
  ...
  snapshot: '2026-07-10'
questions:
  - What is Data Storage Using Walrus in Sui?
  - How does data storage using walrus work on Sui?
  - Why should I use data storage using walrus?
answer: >-
  Walrus is a decentralized storage and data availability protocol built
  specifically for large binary files, or blobs.
---
