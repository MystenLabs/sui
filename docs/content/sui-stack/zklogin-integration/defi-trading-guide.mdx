...
Build a DeepBook swap PTB client-side, then serialize the transaction kind bytes for the sponsor.
...
- [DeepBook](/onchain-finance/deepbookv3/design): Sui's native orderbook
