...
- **Funding the address:** The zkLogin address starts with no tokens. Users need to receive tokens before they can trade (via fiat on-ramp, transfer from another address, or an airdrop).
