...
questions:
  ...
  - What is Configure OpenID Providers in Sui?
answer: >-
  zkLogin can be integrated with an application using an OpenID provider's OAuth
  Client ID and redirect URI.
---
...
4. **Update your Enoki Portal configuration (if applicable).** If you use the [Enoki platform](https://docs.enoki.mystenlabs.com/) for managed salt or proof generation, add the new domain to your Enoki app configuration. The Enoki salt service only accepts JWTs from allowlisted client IDs and origins.
