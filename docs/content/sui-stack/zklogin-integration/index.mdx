...
builder_paths:
  ...
  - path_id: agentic-payments
    ...
    stage: Authorization
questions:
  - What is zkLogin Integration in Sui?
  - How do I install the zklogin typescript sdk?
  - How do I user salt management?
answer: >-
  Here is the high-level flow the wallet or frontend application must implement
  to support zkLogin-enabled transactions:.
---
