...
- **Native to Sui:** zkLogin is a protocol-level primitive, not a third-party service. It composes with [multisig](/develop/transactions/transaction-auth/multisig), [sponsored transactions](/develop/transactions/sponsored-transactions), and other Sui features.
...
| dApp where users may or may not have a wallet | zkLogin as one connection option alongside traditional wallets via [dApp Kit](/develop/sdks/frontend-apps) |
