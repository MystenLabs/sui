...
- **Two-factor security:** Deriving a Sui address requires both an OAuth credential and a per-user salt. Compromising one factor alone is not enough to move funds.
