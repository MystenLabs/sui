...
description: >-
  Build a React application that authenticates users with OAuth providers and
  derives Sui wallet addresses using zero-knowledge proofs, enabling
  passwordless blockchain access.
keywords:
  - example
  - zklogin
  - authentication
...
goal:
  description: >-
    Reader can build a React application that authenticates users with OAuth
    providers
  requires:
    - has_frontmatter:
        - title
...
questions:
  - How do I build a zkLogin demo app on Sui?
