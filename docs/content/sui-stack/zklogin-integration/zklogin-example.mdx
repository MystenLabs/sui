...
goal:
  description: >-
    Reader understands an example that breaks down the logic behind each step of
    zkLogin and knows when to use it
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths_source:
  ...
  snapshot: '2026-07-10'
questions:
  - What is zkLogin Example in Sui?
  - How does zklogin example work on Sui?
  - Where can I find zklogin example examples?
answer: >-
  The Sui community created an example to facilitate a comprehensive
  understanding of each step involved in Sui zkLogin for developers.
---
