    ...
    <>
      ...
      <Em>
        <Text as="div" mb="2">
          ...
          the game requires two fast path (single-owner) transactions: One from
          the player's address to authorize the move, and one from the
          multi-sig, signed by the player's address, to make the move.
        </Text>
        <Text as="div">
          In order to construct the multi-sig, we need to know the public keys
          of the two players. Although addresses on Sui are derived from public
          keys, the derivation cannot be reversed, so to start a multi-sig game,
          we ask for the public keys directly.
        </Text>
      </Em>
    </>
  );
