        ...
        mutations
            ...
            .map(|(mutation, interesting_offsets_idx)| {
                ...
                let (new_bytecode, err) = match code[bytecode_idx] {
                    ...
                    | Neg | LdTrue | LdFalse | ReadRef | WriteRef | Add | Sub | Mul | Mod
...
fn is_interesting(bytecode: &Bytecode) -> bool {
    ...
    match bytecode {
        ...
        | LdU256(_) | LdI8(_) | LdI16(_) | LdI32(_) | LdI64(_) | LdI128(_) | LdI256(_)
        | CastU8 | CastU16 | CastU32 | CastU64 | CastU128 | CastU256 | CastI8 | CastI16
        | CastI32 | CastI64 | CastI128 | CastI256 | Neg | LdTrue | LdFalse | ReadRef
        | WriteRef | Add | Sub | Mul | Mod | Div | BitOr | BitAnd | Xor | Shl | Shr | Or
        | And | Not | Eq | Neq | Lt | Gt | Le | Ge | Abort | Nop => false,
    }
}
