...
module test::if_expression {
    public fun basic() {
        ...
        if (false) { call_something_else(); } else { another_call(); };
        if (very_long_binding) { call_something(); } else {
            call_something_else();
        };
    }
    ...
    public fun folding() {
        if (true) call_something()
        else if (false) call_something_else() else call_something_otherwise();
        if (true) { call_something() } else if (false) {
            call_something_else()
        ...
        let a = if (true) { call_something_else(); } else {
            call_something_else();
        };
        if (
            very_very_long_if_condition > very_very_long_if_condition ||
