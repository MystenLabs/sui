...
module prettier::expression {
    ...
    fun call_expression_type_arguments() {
        ...
        call<InnerTypeArguments, InnerTypeArguments>();
        ...
        module::another_call<TypeArgument>(
            module::another_call<A>(),
            module::another_call<B>(),
            module::another_call<C>(),
        );
    ...
    fun break_expression() {
        ...
        'very_long_label: { break 'very_long_label; }
    }
    ...
    fun continue_expression() {
        ...
        'very_long_label: { continue 'very_long_label; }
    }
    ...
    fun annotate_expression() {
        (expr: Type);
        (really_long_expression: ReallyLongType).say_something();
        let a = (call_expression(): Type);
    ...
    fun dot_expression() {
        a().b().c();
        first().second().ultra_long_third();
        start_a_chain().then_call_something().then_call_something_else();

        let a = first().second().ultra_long_third();
        let a = first().second().ultra_long_third();
    }
