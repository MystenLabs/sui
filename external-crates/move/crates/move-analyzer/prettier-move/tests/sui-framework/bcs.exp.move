...
module sui::bcs {
    ...
    public fun peel_bool(bcs: &mut BCS): bool {
        ...
        if (value == 0) { false } else if (value == 1) { true } else {
            abort ENotBool
        }
    }
