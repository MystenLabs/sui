...
module sui::bls12381 {
    ...
    public fun scalar_add(
        e1: &Element<Scalar>,
        e2: &Element<Scalar>,
    ): Element<Scalar> { group_ops::add(SCALAR_TYPE, e1, e2) }
    public fun scalar_sub(
        e1: &Element<Scalar>,
        e2: &Element<Scalar>,
    ): Element<Scalar> { group_ops::sub(SCALAR_TYPE, e1, e2) }
    public fun scalar_mul(
        e1: &Element<Scalar>,
        e2: &Element<Scalar>,
    ): Element<Scalar> { group_ops::mul(SCALAR_TYPE, e1, e2) }
    /// Returns e2/e1, fails if a is zero.
    public fun scalar_div(
        e1: &Element<Scalar>,
        e2: &Element<Scalar>,
    ): Element<Scalar> { group_ops::div(SCALAR_TYPE, e1, e2) }
