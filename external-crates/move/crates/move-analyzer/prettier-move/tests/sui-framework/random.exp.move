...
module sui::random {
    ...
    #[test_only]
    public fun create_for_testing(ctx: &mut TxContext) { create(ctx); }
    ...
    #[test_only]
    public fun generator_seed(r: &RandomGenerator): &vector<u8> { &r.seed }
    #[test_only]
    public fun generator_counter(r: &RandomGenerator): u16 { r.counter }
    #[test_only]
    public fun generator_buffer(r: &RandomGenerator): &vector<u8> { &r.buffer }
    #[test_only]
