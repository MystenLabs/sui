...
import { JSON_FILE_EXT, TRACE_FILE_EXT } from './utils';
...
export class Runtime extends EventEmitter {
    ...
    public async start(openedFilePath: string, traceInfo: string, stopOnEntry: boolean): Promise<void> {
        ...
        const openedFileBaseName = path.basename(openedFilePath, JSON_FILE_EXT + TRACE_FILE_EXT);
        ...
        if (openedFileExt === TRACE_FILE_EXT && openedFileBaseName === REPLAY_TRACE_FILE_NAME) {
            // replay tool trace
            ...
            traceFilePath = path.join(pkgRoot, 'traces', traceInfo.replace(/:/g, '_') + JSON_FILE_EXT + TRACE_FILE_EXT);
