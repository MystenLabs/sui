...
use crate::{
    ...
    file_format::{
        ...
        VariantInstantiationHandle, VariantTag, VariantInstantiationHandleIndex,
    },
    CompiledModule,
};
use move_core_types::{
...
impl<'a> BinaryIndexedView<'a> {
    ...
    pub fn variant_instantiation_handle_at(&self, idx: VariantInstantiationHandleIndex) -> PartialVMResult<&VariantInstantiationHandle> {
        match self {
