...
impl Opcodes {
    /// Convert a u8 value to an Opcodes enum variant.
    ...
    pub fn from_u8(value: u8) -> Option<Self> {
        match value {
            ...
            0x29 => Some(Opcodes::EXISTS_DEPRECATED),
            0x2A => Some(Opcodes::MUT_BORROW_GLOBAL_DEPRECATED),
            0x2B => Some(Opcodes::IMM_BORROW_GLOBAL_DEPRECATED),
            0x2C => Some(Opcodes::MOVE_FROM_DEPRECATED),
            0x2D => Some(Opcodes::MOVE_TO_DEPRECATED),
            ...
            0x3B => Some(Opcodes::EXISTS_GENERIC_DEPRECATED),
            0x3C => Some(Opcodes::MUT_BORROW_GLOBAL_GENERIC_DEPRECATED),
            0x3D => Some(Opcodes::IMM_BORROW_GLOBAL_GENERIC_DEPRECATED),
            0x3E => Some(Opcodes::MOVE_FROM_GENERIC_DEPRECATED),
            0x3F => Some(Opcodes::MOVE_TO_GENERIC_DEPRECATED),
