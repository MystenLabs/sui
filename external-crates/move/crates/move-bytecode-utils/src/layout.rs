...
impl<'a, T: GetModule> SerdeLayoutBuilder<'a, T> {
    ...
    fn build_normalized_type_layout(
        ...
        Ok(match t {
            ...
            T::I8 => Format::TypeName("i8".to_string()),
            T::I16 => Format::TypeName("i16".to_string()),
            T::I32 => Format::TypeName("i32".to_string()),
            T::I64 => Format::TypeName("i64".to_string()),
            T::I128 => Format::TypeName("i128".to_string()),
            T::I256 => Format::TypeName("i256".to_string()),
