...
fn execute_inner(
    ...
    match bytecode {
        ...
        Bytecode::PackVariant(vidx) => {
            ...
            let variant_def = verifier.resolver.variant_def_at(handle.enum_def, handle.variant)?;
        ...
        Bytecode::PackVariantGeneric(vidx) => {
            ...
            let variant_def = verifier.resolver.variant_def_at(enum_def.def, handle.variant)?;
            pack_enum_variant(verifier, variant_def)?
        }
