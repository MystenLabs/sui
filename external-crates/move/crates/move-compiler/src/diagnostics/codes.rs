...
macro_rules! codes {
    ($($cat:ident: [
        ...
        pub const INTERNAL_FILTER_SIZES: &[u8] = &[
...
//**************************************************************************************************
// Dense filter index computation (operates on macro-generated data)
//**************************************************************************************************

/// Precomputed base offset for each category (cumulative sum of prior sizes).
pub const INTERNAL_FILTER_OFFSETS: &[usize] = &{
...
pub const TOTAL_INTERNAL_FILTER_IDS: usize = {
    ...
    if len == 0 {
        ...
        INTERNAL_FILTER_OFFSETS[len - 1] + INTERNAL_FILTER_SIZES[len - 1] as usize
    }
};
