    ...
    if public_package_usage.is_some() && friend_usage.is_some() {
        ...
        for (_, _, friend) in friends {
            context.add_diag(diag!(
                ...
                (
                    public_package_usage
                        .expect("Public/package usage missing for public package friend"),
            ...
            match function.visibility {
                E::Visibility::Friend(loc) => {
                    context.add_diag(diag!(
                        ...
                        (
                            public_package_usage.expect("Public/package usage missing for friend"),
                            package_definition_msg.clone()
                        )
                    ));
                }
                E::Visibility::Package(loc) => {
                    context.add_diag(diag!(
                        ...
                        (
                            friend_usage.expect("Needed friend usage missing for package"),
