...
fn write_signature_token(ctx: &mut Context, t: &SignatureToken) -> String {
    match t {
        ...
        SignatureToken::I8 => BT::I_8.to_string(),
        SignatureToken::I16 => BT::I_16.to_string(),
        SignatureToken::I32 => BT::I_32.to_string(),
        SignatureToken::I64 => BT::I_64.to_string(),
        SignatureToken::I128 => BT::I_128.to_string(),
        SignatureToken::I256 => BT::I_256.to_string(),
