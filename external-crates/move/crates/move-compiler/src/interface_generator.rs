...
fn write_signature_token(ctx: &mut Context, t: &SignatureToken) -> String {
    match t {
        ...
        SignatureToken::I8 => BT::I8.to_string(),
        SignatureToken::I16 => BT::I16.to_string(),
        SignatureToken::I32 => BT::I32.to_string(),
        SignatureToken::I64 => BT::I64.to_string(),
        SignatureToken::I128 => BT::I128.to_string(),
        SignatureToken::I256 => BT::I256.to_string(),
