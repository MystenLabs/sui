...
use crate::{
    ...
    sui_mode::{
        ...
        CLOCK_MODULE_NAME, COIN_METADATA_REGISTRY_CREATE, COIN_METADATA_REGISTRY_MODULE_NAME,
        DENY_LIST_CREATE, DENY_LIST_MODULE_NAME, ID_LEAK_DIAG, OBJECT_MODULE_NAME, OBJECT_NEW,
