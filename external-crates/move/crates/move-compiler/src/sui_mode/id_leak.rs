...
use crate::{
    ...
    sui_mode::{
        ...
        OBJECT_NEW_UID_FROM_HASH, RANDOMNESS_MODULE_NAME, RANDOMNESS_STATE_CREATE, REGISTRY_CREATE,
        REGISTRY_MODULE_NAME, SUI_ADDR_NAME, SUI_ADDR_VALUE, SUI_CLOCK_CREATE,
...
pub const FUNCTIONS_TO_SKIP: &[(AccountAddress, Symbol, Symbol)] = &[
    ...
    (SUI_ADDR_VALUE, REGISTRY_MODULE_NAME, REGISTRY_CREATE),
];
