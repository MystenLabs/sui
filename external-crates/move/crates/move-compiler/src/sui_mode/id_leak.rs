...
use crate::{
    ...
    sui_mode::{
        ACCUMULATOR_CREATE, ACCUMULATOR_MODULE_NAME, ALIAS_CREATE, ALIAS_MODULE_NAME,
        AUTHENTICATOR_STATE_CREATE, AUTHENTICATOR_STATE_MODULE_NAME, BRIDGE_ADDR_VALUE,
        BRIDGE_CREATE, BRIDGE_MODULE_NAME, CLOCK_MODULE_NAME, COIN_REGISTRY_MODULE_NAME,
        DENY_LIST_CREATE, DENY_LIST_MODULE_NAME, DERIVED_OBJECT_CLAIM, DERIVED_OBJECT_MODULE_NAME,
        DISPLAY_REGISTRY_MODULE_NAME, ID_LEAK_DIAG, OBJECT_MODULE_NAME, OBJECT_NEW,
...
pub const FUNCTIONS_TO_SKIP: &[(AccountAddress, Symbol, Symbol)] = &[
    ...
    (SUI_ADDR_VALUE, ALIAS_MODULE_NAME, ALIAS_CREATE),
];
