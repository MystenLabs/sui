...
use crate::{
    ...
    sui_mode::{
        ...
        OBJECT_NEW_UID_FROM_HASH, PACKAGE_CONFIG_MODULE_NAME, RANDOMNESS_MODULE_NAME,
        RANDOMNESS_STATE_CREATE, REGISTRY_CREATE_FUNCTION_NAME, SUI_ADDR_NAME, SUI_ADDR_VALUE,
