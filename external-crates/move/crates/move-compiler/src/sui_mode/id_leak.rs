...
use crate::{
    ...
    sui_mode::{
        ...
        COIN_REGISTRY_MODULE_NAME, DENY_LIST_CREATE, DENY_LIST_CREATE_ACTIVE,
        DENY_LIST_MODULE_NAME, DERIVED_OBJECT_CLAIM, DERIVED_OBJECT_MODULE_NAME,
        DISPLAY_REGISTRY_MODULE_NAME, FORWARDING_ADDRESS_CREATE, FORWARDING_ADDRESS_MODULE_NAME,
