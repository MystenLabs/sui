...
use super::{
    AUTHENTICATOR_STATE_CREATE, AUTHENTICATOR_STATE_MODULE_NAME, CLOCK_MODULE_NAME, FREEZER_CREATE,
    FREEZER_MODULE_NAME, ID_LEAK_DIAG, OBJECT_MODULE_NAME, OBJECT_NEW_UID_FROM_HASH,
...
pub const FUNCTIONS_TO_SKIP: &[(Symbol, Symbol, Symbol)] = &[
    ...
    (SUI_ADDR_NAME, FREEZER_MODULE_NAME, FREEZER_CREATE),
];
