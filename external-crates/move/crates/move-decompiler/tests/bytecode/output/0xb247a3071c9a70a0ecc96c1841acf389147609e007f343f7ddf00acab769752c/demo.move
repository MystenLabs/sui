...
fun calculate_enhanced_slot_rewards(l0: u64, l1: u64, l2: u64, l3: u64, l4: u64, l5: u64, l6: u64, l7: u64): u64 {
    ...
    let l17 = l15 as u128 * C47 / C46 as u128;
    let l16 = l14 as u128 * l17 / C47;
    return if (l16 > C48 as u128) {
        C48
    } else {
        l16 as u64
    }
...
fun create_enhanced_slot_configs(): vector<SlotConfig> {
    ...
    while (l2 <= C52) {
        ...
        (&mut l0).push_back(SlotConfig { slot_number: l2, unlock_cost: reg_6, reward_multiplier: reg_7, allowed_collections: vector[], is_open_to_all: true });
        l2 = l2 + 1u8;
    };
    return l0
}
...
public fun get_user_total_claimed_rewards<T0>(l0: &StakingPool<T0>, l1: address): u64 {
    ...
    let l8 = 0u64;
    let l3 = 0u64;
    let l4 = &l2.unlocked_slot_numbers.len();
    while (l3 < l4) {
...
public fun get_user_total_pending_rewards<T0>(l0: &StakingPool<T0>, l1: address, l2: &Clock): u64 {
    ...
    let l8 = 0u64;
    let l4 = 0u64;
    let l5 = &l3.unlocked_slot_numbers.len();
    while (l4 < l5) {
...
fun safe_add(l0: u64, l1: u64): u64 {
    let l2 = l0 as u128 + l1 as u128;
    assert!(l2 <= C48 as u128, C21);
    return l2 as u64
}
