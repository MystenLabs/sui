...
pub struct IntrinsicsAnnotation {
    ...
    intrinsic_structs: BTreeMap<QualifiedId<DatatypeId>, IntrinsicId>,
...
impl IntrinsicsAnnotation {
    ...
    pub fn get_decl_for_struct(&self, qid: &QualifiedId<DatatypeId>) -> Option<&IntrinsicDecl> {
