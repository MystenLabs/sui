...
#[serde(bound = "")]
pub struct Lockfile<F: MoveFlavor + std::fmt::Debug> {
...
#[derive_where(Clone)]
#[serde(bound = "")]
pub struct Publication<F: MoveFlavor + std::fmt::Debug> {
    #[serde(flatten)]
...
#[serde(bound = "")]
struct UnpublishedTable<F: MoveFlavor + std::fmt::Debug> {
...
impl<F: MoveFlavor + std::fmt::Debug> Publication<F> {
