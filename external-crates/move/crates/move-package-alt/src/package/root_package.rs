...
pkg_b = { local = "../pkg_b" }"#,
    ...
    async fn graph_to_lockfile() {
        ...
        manifest_digest = "DA6838770E01786BC9D86EDCFE2C41566C918E7ED0A656D5F177DA819497F2A7"
        deps = {}

        [pinned._test_env.baz]
        source = { local = "../baz" }
        use_environment = "_test_env"
        manifest_digest = "CBFECABC11F60874B7491BADE30AA7C33F8FFD0B06A5A496A06DCCFD76BE23A1"
        deps = { bar = "bar" }

        [pinned._test_env.example]
        source = { root = true }
        use_environment = "_test_env"
        manifest_digest = "2F26C8A4377743CF6A592D3EABE1F8456AA6E61E458AF972A299B75EAAE93E2A"
        deps = { baz = "baz" }
        "#);
    }
