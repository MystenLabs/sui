...
async fn external_basic() {
    ...
    source = { local = "../b" }
    use_environment = "_test_env"
    manifest_digest = "F2BA4D56C30BFD236D44969A4ABF5A216A058C03F0983BF2DD43126440D53E8B"
    deps = {}

    [pinned._test_env.root]
    source = { root = true }
    use_environment = "_test_env"
    manifest_digest = "64FEB985F7801F9284FB6CD8246EAA561CB38435420653FDADEF937200441784"
    deps = { a = "a" }
    "#);
}
...
async fn external_multiple_resolvers() {
    ...
    source = { local = "../res_1" }
    use_environment = "_test_env"
    manifest_digest = "37E94C11AFC5FFCCE8F0170DA53C10EAB3CB0840A4FAAA3CA49827CD7E4E29A1"
    deps = {}

    [pinned._test_env.res_2]
    source = { local = "../res_2" }
    use_environment = "_test_env"
    manifest_digest = "2E5ED01567349369DD296B30E917BC69E8079A7BD0D15095A4335D0BE0FCFD44"
    deps = {}
