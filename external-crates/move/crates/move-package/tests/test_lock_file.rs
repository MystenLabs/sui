...
fn update_lock_file_toolchain_version() {
    ...
    build_config.update_lock_file_toolchain_version("0.0.1".into());
    ...
    let expected = expect![[r##"
        ...
        compiler-flags = { additional_named_addresses = {}, default_edition = "2024.1", default_flavor = "sui", deps_as_root = false, dev_mode = false, fetch_deps_only = false, force_recompilation = false, generate_abis = false, generate_docs = false, lock_file = "/var/folders/yq/c752q7s95c3_yv5j8gq12_yr0000gn/T/.tmpBug2rN/Move.lock", silence_warnings = false, skip_fetch_latest_git_deps = false, test_mode = false, warnings_are_errors = false }
    "##]];
    expected.assert_eq(lock_contents.as_str());
}
