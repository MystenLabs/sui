...
use move_core_types::{
    ...
    compressed::{
        ...
        runtime::{
            ...
            MoveTypeLayoutBuilder, VariantLayout,
        },
    },
    u256,
...
struct VariantFields<'a>(&'a MoveFieldsLayout);
...
impl<'d> serde::de::DeserializeSeed<'d> for SeedWrapper<&MoveStructLayout> {
    ...
    fn deserialize<D: serde::de::Deserializer<'d>>(
        ...
        let fields = deserializer.deserialize_tuple(
            self.layout.0.field_count(),
            StructFieldVisitor(&self.layout.0),
        )?;
...
struct StructFieldVisitor<'a>(&'a MoveFieldsLayout);
...
struct EnumFieldVisitor<'a>(&'a MoveEnumLayout);
...
struct MoveRuntimeVariantFieldLayout<'a>(&'a MoveFieldsLayout);
