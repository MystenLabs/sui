...
pub fn instruction_summary(instruction: Bytecode, exact: bool) -> Summary {
    match instruction {
        ...
        Bytecode::Call(i) => Summary {
            preconditions: vec![
                state_function_is_not_generic!(i),
                state_stack_satisfies_function_signature!(i),
            ],
            effects: Effects::NoTyParams(vec![
        ...
        Bytecode::CallGeneric(i) => Summary {
            preconditions: vec![
                state_function_inst_is_generic!(i),
                state_stack_satisfies_function_inst_signature!(i),
            ],
