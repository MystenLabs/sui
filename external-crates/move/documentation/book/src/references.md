...
also means that they cannot exist in storage. All references created during program execution
...
would have to expand to support stored references, and it is something we are
