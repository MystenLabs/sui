...
module.exports = grammar({
    ...
    rules: {
        ...
        use_declaration: $ => seq(
            optional('public'),
            'use',
            choice($.use_fun, $.use_module, $.use_module_member, $.use_module_members),
            ';',
        ),
        ...
        // ================================================================
        // Datatype Fields (shared by structs and enums)
        // ================================================================
        ...
        block_item: $ => seq(
            choice($._expression, $.let_statement),
            ';',
        ),
        ...
        assign_expression: $ => prec.left(PRECEDENCE.assign, seq(
        ...
        _unary_expression: $ => prec(PRECEDENCE.unary_group, choice(
            $.unary_expression,
            $.borrow_expression,
        ...
        // ================================================================
        // Expressions: Calls & Constructors
        // ================================================================
        ...
        lambda_bindings: $ => seq('|', sepBy(',', $.lambda_binding), '|'),
        ...
        num_literal: $ => seq(
            choice(/[0-9][0-9_]*/, /0x[a-fA-F0-9_]+/),
            optional(choice('u8', 'u16', 'u32', 'u64', 'u128', 'u256')),
        ),
