...
function module_coverage() {
    pkill cargo; cargo run --release --bin source-coverage -- -t trace.mvcov -b "../../move-compiler-stable/build/modules/$1.mv" -s "../../../diem-move/diem-framework/core/sources/$2.move" -o tmp;
    less tmp
}
