...
pub struct SimpleFaucet {
    ...
    /// Pay for the gas incurred in transfer and split
...
impl SimpleFaucet {
    pub async fn new(mut wallet: WalletContext) -> Result<Self, FaucetError> {
        ...
        debug!("SimpleFaucet::new with active address: {active_address}");
    ...
    async fn transfer_coins(&self, _coins: &[Object], recipient: &str) -> Result<(), FaucetError> {
