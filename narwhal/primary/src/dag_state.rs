...
impl DagState {
    ...
    fn try_accept_internal(
        ...
        let _scope = monitored_scope("DagState::try_accept_internal");
...
impl Inner {
    ...
    fn try_propose(&mut self) -> ProposeResult {
        let _scope = monitored_scope("DagState::Inner::try_propose");
    ...
    fn try_commit(&mut self) -> (Vec<CommittedSubDag>, bool) {
        let _scope = monitored_scope("DagState::Inner::try_commit");
