  ...
  <div class="_sui-nfts">
    <div class="container">
        ...
        <div class="sui-isotope-wrapper">
          ...
          {:then item}
            {#if item.length}
              ...
              <div class="row row-35 isotope-list">
                {#each item as itm, ir (ir)}
                  <div
                    class="col-md-3 project _nft-item {itm.claim_status ===
                    'none'
                      ? ''
                      : 'claimed'}"
                  >
            ...
            <button
              ...
              on:click={switchWalletAddress}
              >Change Address <img
                class="metamask-logo"
                src="assets/logos/metamask-fox.svg"
                alt="metamask logo"
              />
            </button>
          {:catch err}
      ...
      {#if selectedNFT}
        <AddSuiWallet
          data={selectedNFT}
          on:selectNFT={selectAnotherNFT}
          on:changeWalletAddr={switchWalletAddress}
        />
      {/if}
    </div>
    <ul class="shape-group-7 list-unstyled">
      <li class="shape shape-1">
        <img src="./../assets/background/circle-2.png" alt="circle" />
      </li>
      <li class="shape shape-2">
        <img src="./../assets/background/bubble-2.png" alt="Line" />
      </li>
      <li class="shape shape-3">
        <img src="./../assets/background/bubble-1.png" alt="Line" />
      </li>
    </ul>
  </div>
</section>
