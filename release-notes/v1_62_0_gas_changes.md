...
- and/or the fields read are **large in size;**
- and/or each field is read only a few times per transaction.
...
- or **create dynamic fields** and then access them again in-transaction.
