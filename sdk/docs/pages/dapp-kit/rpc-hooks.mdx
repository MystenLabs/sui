...
In certain scenarios, You can utilize `useSuiClientQueries` for data retrieval. Also, this hook is a
wrapper around the [useQueries](https://tanstack.com/query/latest/docs/react/reference/useQueries)
