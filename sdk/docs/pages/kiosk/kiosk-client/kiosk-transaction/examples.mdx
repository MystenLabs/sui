...
For every scenario using Kiosk in dApps, the user who has connected their wallet
either has at least one kiosk already or you must create it for them.

The SDK supports the scenario of `silently` creating the kiosk, as part of our Programmable Transaction Blocks.
