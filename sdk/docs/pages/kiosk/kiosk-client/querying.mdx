...
Queries to find all the owned transfer policies. Useful to manage transfer policies, and can
be combined with `TransferPolicyTransaction` to easily add or remove rules and withdraw profits.
