...
Queries to find all the owned transfer policies. Useful to manage transfer policies easily, and can
be combined with `TransferPolicyTransaction` to easily add or remove rules & withdraw profits.
...
policies easily, and can be combined with
