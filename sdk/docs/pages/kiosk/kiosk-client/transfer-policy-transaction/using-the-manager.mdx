...
call any of the available functions to prepare your PTB.
...
After setting up the transaction, you can go ahead and add any of the supported rules to the policy.
