...
The Sui TypeScript SDK is available in the [Sui monorepo](https://github.com/MystenLabs/sui/tree/main/sdk) and NPM.
...
To build the SDK from the Sui monorepo, you must use [pnpm](https://pnpm.io/). With pnpm installed, run the following command from the `sui` root directory:
