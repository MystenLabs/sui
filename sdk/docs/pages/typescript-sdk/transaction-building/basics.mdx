...
This example starts by constructing a transaction block to send SUI. To construct transactions, import the `TransactionBlock` class and construct it:
...
You can attach multiple transactions of the same type to a transaction block, as well. For
