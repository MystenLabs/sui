...
The `@mysten/sui.js/bcs` package extends `@mysten/bcs` with Sui specific scheme definitions.

To learn more about using BCS see the [BCS documentation](/bcs).

the `bcs` export of `@mysten/sui.js/bcs` contains all the same exports as `bcs` from `@mysten/bcs`
