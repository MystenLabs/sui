...
const encoded = encodeSuiPrivateKey([59, 148, 11, 85, 134, 130, 61, 253, 2, 174, 59, 70, 27, 180, 51, 107, 94, 203, 174, 253, 102,39, 170, 146, 46, 252, 4, 143, 236, 12, 136, 28], 'ED25519');
const secret = 'suiprivkey1...';
const {schema, secretKey} = decodeSuiPrivateKey(secret);
if schema = 'ED25519' {
	const keypair = Ed25519Keypair.fromSecretKey(secretKey);
}
```
See [more](https://github.com/sui-foundation/sips/blob/main/sips/sip-15.md) in SIP-15 for additional context and motivation. 
