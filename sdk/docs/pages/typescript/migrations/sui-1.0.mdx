...
`txb.getBlockData()` method has been added, and returns the new internal representation of a
...
helpers have been removed Removed `is` and `assert` helpers
...
TODO: Add information about alternative for fetching additional data
...
For more details on how wallets can take advantage of these features, see the wallet-standard
documentation.

TODO: Add links to unwritten wallet-standard docs
