...
// txb.object will automaically convert the object iID to receiving transaction arguments if the moveCall expects it
txb.moveCall({
...
argument to a `moveCall`, the object reference will be automatically converted to a receiving
transaction argument. This greatly simplifies building transactions, but requires additional RPC
calls. You can optimize this process by providing a fully resolved object reference instead:
