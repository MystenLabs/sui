...
const options: {
	...
	types: {
		...
		MoveFunctionArgType: {
			alias: 'SuiMoveFunctionArgType',
		},
		PaginatedSuiObjectResponse: {
			alias: 'PaginatedObjectsResponse',
		},
		TransactionBlockResponseOptions: {
			alias: 'SuiTransactionBlockResponseOptions',
		},
		TransactionBlockResponse: {
			alias: 'SuiTransactionBlockResponse',
		},
		...
		ObjectResponseQuery: {
			alias: 'SuiObjectResponseQuery',
		},
		ObjectDataOptions: {
			alias: 'SuiObjectDataOptions',
		},
		ObjectData: {
			alias: 'SuiObjectData',
		},
		...
		TransactionBlockResponseQuery: {
			alias: 'SuiTransactionBlockResponseQuery',
		},
		TransactionBlockKind: {
			alias: 'SuiTransactionBlockKind',
		},
		Event: {
			alias: 'SuiEvent',
		},
		SuiProgrammableMoveCall: {
			alias: 'MoveCallSuiTransaction',
		},
		EventFilter: {
			alias: 'SuiEventFilter',
		},
		ValidatorApys: {
			alias: 'ValidatorsApy',
		},
