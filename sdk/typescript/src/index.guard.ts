    ...
    return (
        ...
        (
            Array.isArray(obj.splitAmounts) &&
                obj.splitAmounts.every(
                    (e: any) => isSequenceNumber(e)
                )
        ) &&
        (typeof obj.gasPayment === "undefined" ||
            isTransactionDigest(obj.gasPayment) as boolean) &&
