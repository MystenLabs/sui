...
describe('Keypair', () => {
	...
	it('`signWithIntent()` should return the correct signature', async () => {
		...
		expect(sig1.bytes).toEqual(toB64(bytes)).toEqual('CQAAAAVIZWxsbw==');
		...
		expect(sig2.bytes).toEqual(toB64(data)).toEqual('AAAABUhlbGxv');
		...
		expect(sig3.bytes).toEqual(toB64(bytes)).toEqual('CQAAAAVIZWxsbw==');
	...
	it('`signTransactionBlock()` should correctly sign a transaction block', async () => {
		...
		expect(sig1.bytes).toEqual(toB64(data)).toEqual('AAAABUhlbGxv');
		expect(sig1.signature).toEqual(
		...
		expect(sig3.bytes).toEqual(toB64(data)).toEqual('AAAABUhlbGxv');
		expect(sig3.signature).toEqual(
	...
	it('`signPersonalMessage()` should correctly sign a personal message', async () => {
		...
		expect(sig2.bytes).toEqual(toB64(bytes)).toEqual('CQAAAAVIZWxsbw==');
		expect(sig2.signature).toEqual(
