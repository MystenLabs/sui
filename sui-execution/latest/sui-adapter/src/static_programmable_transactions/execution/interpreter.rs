...
pub fn execute<'env, 'pc, 'vm, 'state, 'linkage, 'e, Mode: ExecutionMode>(
    env: &'env mut Env<'pc, 'vm, 'state, 'linkage, 'e>,
...
pub fn execute_inner<'env, 'pc, 'vm, 'state, 'linkage, 'e, Mode: ExecutionMode>(
