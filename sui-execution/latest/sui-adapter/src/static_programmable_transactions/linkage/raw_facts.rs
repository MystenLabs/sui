...
use crate::data_store::backing_package_metadata_store::{
    BackingPackageMetadata, BackingPackageMetadataStore,
};
...
fn linkage_facts_from_command(
    ...
    match command {
        ...
        Command::Upgrade(serialized_modules, dependencies, current_package_id, _) => {
            ...
            let upgrade_modules = package_store.deserialize_modules(serialized_modules)?;
