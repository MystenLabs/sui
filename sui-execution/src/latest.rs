...
mod latest_dual_replay {
    ...
    const OUTPUT_DIR: &str = "/opt/sui/replay-output/6055f8046705c428a8cad8d7dd306b09591f98fc";
    const GAS_TOLERANCE_PCT: f64 = 0.0_f64;
    const TIMINGS_FILE: &str = "/opt/sui/replay-output/6055f8046705c428a8cad8d7dd306b09591f98fc/timings.csv";
