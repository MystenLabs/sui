...
mod latest_dual_replay {
    ...
    const OUTPUT_DIR: &str = "/opt/sui/replay-output/56e7a947e67e44b4d8585446251cc65f2b4cd93b";
    const GAS_TOLERANCE_PCT: f64 = 0.0_f64;
    const TIMINGS_FILE: &str = "/opt/sui/replay-output/56e7a947e67e44b4d8585446251cc65f2b4cd93b/timings.csv";
