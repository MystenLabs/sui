...
mod latest_dual_replay {
    ...
    const OUTPUT_DIR: &str = "/opt/sui/replay-output/4876cd531e22f451651932285d77258368a2b420";
    const GAS_TOLERANCE_PCT: f64 = 0.0_f64;
    const TIMINGS_FILE: &str = "/opt/sui/replay-output/4876cd531e22f451651932285d77258368a2b420/timings.csv";
