...
module HeroGame::Hero {
    ...
    public(script) fun slay_boar_test() {
        ...
        {
            let game = TestScenario::take_object<GameInfo>(scenario);
            let coin = Coin::mint_for_testing(500, TestScenario::ctx(scenario));
            acquire_hero(&game, coin, TestScenario::ctx(scenario));
        ...
        TestScenario::next_tx(scenario, &admin);
        {
            ...
            send_boar(&game, &mut admin_cap, 10, 10, player, TestScenario::ctx(scenario));
        ...
        TestScenario::next_tx(scenario, &player);
        {
            ...
            slay(&game, &mut hero, boar, TestScenario::ctx(scenario));
