...
module games::drand_based_scratch_card {
    ...
    /// Buy a ticket for a specific game, costing reward/RewardFactor SUI. Can be called only during the epoch in which
    ...
    public entry fun evaluate(
        ...
        // this attack is not devestating, but for similar games it might be.)
