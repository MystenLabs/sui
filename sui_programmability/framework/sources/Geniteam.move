module Sui::Geniteam {
    ...
    struct Player has key {
        ...
        owned_farms_id: Option<ChildRef<Collection::Collection>>,

        // Inventory of unassigned items: Inventory
        inventory_id: ChildRef<Collection::Collection>,
    }
    ...
    struct Farm has key, store {
        ...
        pet_monsters_id: ChildRef<Collection::Collection>,

        // ID of the applied cosmetic at this slot
        applied_farm_cosmetic_0_id:  Option<ChildRef<FarmCosmetic>>,
        // ID of the applied cosmetic at this slot
        applied_farm_cosmetic_1_id:  Option<ChildRef<FarmCosmetic>>,        
    }
    ...
    struct Monster has key, store {
        ...
        // ID of the applied cosmetic at this slot
        applied_monster_cosmetic_0_id: Option<ChildRef<MonsterCosmetic>>,
        // ID of the applied cosmetic at this slot
        applied_monster_cosmetic_1_id: Option<ChildRef<MonsterCosmetic>>,    
    ...
    public fun create_player_(
        ...
        let child_ref = Transfer::transfer_to_object(inventory, &mut player);
        parent.inventory_id = child_ref;
