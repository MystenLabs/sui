...
export var ALL_PERMISSION_TYPES = [
    'viewAccount',
    'suggestTransactions',
];
// Stored as state somewhere (Probably in a place with generics )
var SuiWalletAdapter = /** @class */ (function () {
    function SuiWalletAdapter() {
        this.name = "Sui Wallet";
        this.connected = false;
        this.connecting = false;
    }
    SuiWalletAdapter.prototype.getAccounts = function () {
        return window.suiWallet.getAccounts();
    };
    SuiWalletAdapter.prototype.executeMoveCall = function (transaction) {
        return window.suiWallet.executeMoveCall(transaction);
    };
    SuiWalletAdapter.prototype.executeSerializedMoveCall = function (transactionBytes) {
        return window.suiWallet.executeSerializedMoveCall(transactionBytes);
    };
    SuiWalletAdapter.prototype.connect = function () {
    ...
    SuiWalletAdapter.prototype.disconnect = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    return SuiWalletAdapter;
}());
export { SuiWalletAdapter };
